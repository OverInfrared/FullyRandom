...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen {
   ...
   private void func_237836_c_(MatrixStack p_237836_1_) {
      ...
      double d2 = 0.5D;
      bufferbuilder.func_225582_a_(d1 - 0.5D, 95.5D, 0.0D).func_225586_a_(217, 210, 210, 255).endVertex();
      bufferbuilder.func_225582_a_(d1 + 200.0D * d0 / 100.0D + 0.5D, 95.5D, 0.0D).func_225586_a_(217, 210, 210, 255).endVertex();
      bufferbuilder.func_225582_a_(d1 + 200.0D * d0 / 100.0D + 0.5D, 79.5D, 0.0D).func_225586_a_(217, 210, 210, 255).endVertex();
      bufferbuilder.func_225582_a_(d1 - 0.5D, 79.5D, 0.0D).func_225586_a_(217, 210, 210, 255).endVertex();
      bufferbuilder.func_225582_a_(d1, 95.0D, 0.0D).func_225586_a_(128, 128, 128, 255).endVertex();
      bufferbuilder.func_225582_a_(d1 + 200.0D * d0 / 100.0D, 95.0D, 0.0D).func_225586_a_(128, 128, 128, 255).endVertex();
      bufferbuilder.func_225582_a_(d1 + 200.0D * d0 / 100.0D, 80.0D, 0.0D).func_225586_a_(128, 128, 128, 255).endVertex();
      bufferbuilder.func_225582_a_(d1, 80.0D, 0.0D).func_225586_a_(128, 128, 128, 255).endVertex();
      tessellator.draw();
