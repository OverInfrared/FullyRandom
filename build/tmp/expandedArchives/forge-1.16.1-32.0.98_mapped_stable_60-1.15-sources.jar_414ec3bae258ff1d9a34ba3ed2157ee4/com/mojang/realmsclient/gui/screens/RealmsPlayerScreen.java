...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      bufferbuilder.func_225582_a_(0.0D, (double)this.field_230709_l_, 0.0D).func_225583_a_(0.0F, (float)(this.field_230709_l_ - i) / 32.0F + 0.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230708_k_, (double)this.field_230709_l_, 0.0D).func_225583_a_((float)this.field_230708_k_ / 32.0F, (float)(this.field_230709_l_ - i) / 32.0F + 0.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230708_k_, (double)i, 0.0D).func_225583_a_((float)this.field_230708_k_ / 32.0F, 0.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_(0.0D, (double)i, 0.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      tessellator.draw();
