...
public class RealmsTermsScreen extends RealmsScreen {
   ...
   public RealmsTermsScreen(Screen p_i232225_1_, RealmsMainScreen p_i232225_2_, RealmsServer p_i232225_3_) {
      ...
      this.field_224725_d = p_i232225_3_;
   }
   ...
   private void func_224721_a() {
      ...
      try {
         ...
         this.field_230706_i_.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(this.field_224723_b, new ConnectingToRealmsAction(this.field_224724_c, this.field_224723_b, this.field_224725_d, new ReentrantLock())));
