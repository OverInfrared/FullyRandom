...
public class VertexLighterFlat extends QuadGatheringTransformer
{
    ...
    private static final int LIGHTMAP_PACKING_FACTOR = ((256 << (8 * (DefaultVertexFormats.field_227848_e_.getType().getSize() - 1))) - 1) >>> 1;
...
//            if(blockInfo.getState().getBlock().isFullCube(blockInfo.getState()))
            ...
            for(int e = 0; e < count; e++)
            {
                ...
                switch(element.getUsage())
                {
                    case POSITION:
                        ...
                        pos.func_229372_a_(pose.func_227870_a_());
                    ...
                    case NORMAL:
                        ...
                        norm.func_229188_a_(pose.func_227872_b_());
    ...
    protected void updateLightmap(float[] normal, float[] lightmap, float x, float y, float z)
    {
        ...
        lightmap[0] = LightTexture.func_228450_a_(brightness) / (float) 0xF;
        lightmap[1] = LightTexture.func_228454_b_(brightness) / (float) 0xF;
    }
