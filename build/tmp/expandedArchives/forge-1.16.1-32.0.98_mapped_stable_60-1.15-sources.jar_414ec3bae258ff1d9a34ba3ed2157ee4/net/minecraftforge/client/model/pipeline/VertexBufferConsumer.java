...
public class VertexBufferConsumer implements IVertexConsumer
{
    ...
    public void put(int e, float... data)
    {
        ...
        {
        case 0: // POSITION_3F
            renderer.func_225582_a_(d0, d1, d2);
            break;
        case 4: // NORMAL_3B
            renderer.func_225584_a_(d0, d1, d2);
            break;
        case 1: // COLOR_4UB
            renderer.func_227885_a_(d0, d1, d2, d3);
            break;
        case 2: // TEX_2F
            renderer.func_225583_a_(d0, d1);
            break;
        case 3: // TEX_2SB
            renderer.func_225587_b_((int) (d0 * 0xF0), (int) (d1 * 0xF0));
            break;
        case 5: // PADDING_1B
            break;
        default:
