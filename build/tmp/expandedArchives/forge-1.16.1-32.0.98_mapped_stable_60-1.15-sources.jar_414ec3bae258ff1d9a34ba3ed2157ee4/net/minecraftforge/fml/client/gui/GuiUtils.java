...
public class GuiUtils
{
                                        ...
                                        int backgroundColor, int borderColorStart, int borderColorEnd, FontRenderer font)
    {
        if (!textLines.isEmpty())
        {
            ...
            mStack.func_227861_a_(0.0D, 0.0D, zLevel);
    ...
    public static void drawGradientRect(Matrix4f mat, int zLevel, int left, int top, int right, int bottom, int startColor, int endColor)
    {
        ...
        buffer.func_227888_a_(mat, right,    top, zLevel).func_227885_a_(startRed, startGreen, startBlue, startAlpha).endVertex();
        buffer.func_227888_a_(mat,  left,    top, zLevel).func_227885_a_(startRed, startGreen, startBlue, startAlpha).endVertex();
        buffer.func_227888_a_(mat,  left, bottom, zLevel).func_227885_a_(  endRed,   endGreen,   endBlue,   endAlpha).endVertex();
        buffer.func_227888_a_(mat, right, bottom, zLevel).func_227885_a_(  endRed,   endGreen,   endBlue,   endAlpha).endVertex();
        tessellator.draw();
