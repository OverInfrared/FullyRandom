...
public class BeehiveDispenseBehavior extends OptionalDispenseBehavior {
   ...
   private static boolean func_239797_a_(ServerWorld p_239797_0_, BlockPos p_239797_1_) {
      ...
      if (blockstate.func_235714_a_(BlockTags.field_226151_aa_)) {
         int i = blockstate.get(BeehiveBlock.field_226873_c_);
         if (i >= 5) {
            p_239797_0_.playSound((PlayerEntity)null, p_239797_1_, SoundEvents.field_226133_ah_, SoundCategory.BLOCKS, 1.0F, 1.0F);
            BeehiveBlock.func_226878_a_(p_239797_0_, p_239797_1_);
            ((BeehiveBlock)blockstate.getBlock()).func_226877_a_(p_239797_0_, blockstate, p_239797_1_, (PlayerEntity)null, BeehiveTileEntity.State.BEE_RELEASED);
            return true;
         }
      }
