...
public class SerializableTickList<T> implements ITickList<T> {
   private final List<SerializableTickList.TickHolder<T>> field_219500_a;
   ...
   public void scheduleTick(BlockPos pos, T itemIn, int scheduledTime, TickPriority priority) {
      this.field_219500_a.add(new SerializableTickList.TickHolder<>(itemIn, pos, scheduledTime, priority));
   }
   ...
   public ListNBT func_234857_b_() {
      ...
      for(SerializableTickList.TickHolder<T> tickholder : this.field_219500_a) {
         CompoundNBT compoundnbt = new CompoundNBT();
         compoundnbt.putString("i", this.field_219501_b.apply(tickholder.field_234861_d_).toString());
   ...
   public void func_234855_a_(ITickList<T> p_234855_1_) {
      this.field_219500_a.forEach((p_234856_1_) -> {
