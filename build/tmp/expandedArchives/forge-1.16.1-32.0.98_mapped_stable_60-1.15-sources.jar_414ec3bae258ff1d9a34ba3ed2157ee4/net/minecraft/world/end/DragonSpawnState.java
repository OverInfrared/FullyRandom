...
public enum DragonSpawnState {
   START {
      public void func_186079_a(ServerWorld worldIn, DragonFightManager manager, List<EnderCrystalEntity> crystals, int ticks, BlockPos pos) {
         ...
         if (flag || flag1) {
            ...
            if (j < list.size()) {
               ...
               if (flag) {
                  ...
                  Feature.END_SPIKE.func_225566_b_(endspikefeatureconfig).func_236265_a_(worldIn, worldIn.func_241112_a_(), worldIn.getChunkProvider().getChunkGenerator(), new Random(), new BlockPos(endspikefeature$endspike.getCenterX(), 45, endspikefeature$endspike.getCenterZ()));
               }
            } else if (flag) {
      ...
      public void func_186079_a(ServerWorld worldIn, DragonFightManager manager, List<EnderCrystalEntity> crystals, int ticks, BlockPos pos) {
         if (ticks >= 100) {
            ...
            for(EnderCrystalEntity endercrystalentity : crystals) {
               ...
               worldIn.createExplosion(endercrystalentity, endercrystalentity.func_226277_ct_(), endercrystalentity.func_226278_cu_(), endercrystalentity.func_226281_cx_(), 6.0F, Explosion.Mode.NONE);
   ...
   public abstract void func_186079_a(ServerWorld worldIn, DragonFightManager manager, List<EnderCrystalEntity> crystals, int ticks, BlockPos pos);
}