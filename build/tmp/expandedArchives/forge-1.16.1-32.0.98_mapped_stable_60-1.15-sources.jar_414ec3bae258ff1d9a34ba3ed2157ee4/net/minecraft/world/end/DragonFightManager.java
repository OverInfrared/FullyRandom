...
public class DragonFightManager {
   ...
   public void tick() {
      ...
      if (!this.bossInfo.getPlayers().isEmpty()) {
         ...
         if (this.respawnState != null) {
            ...
            this.respawnState.func_186079_a(this.world, this, this.crystals, this.respawnStateTicks++, this.exitPortalLocation);
         }
   ...
   private void generateGateway(BlockPos pos) {
      ...
      Feature.END_GATEWAY.func_225566_b_(EndGatewayConfig.func_214698_a()).func_236265_a_(this.world, this.world.func_241112_a_(), this.world.getChunkProvider().getChunkGenerator(), new Random(), pos);
   }

   private void generatePortal(boolean active) {
      EndPodiumFeature endpodiumfeature = new EndPodiumFeature(active);
      if (this.exitPortalLocation == null) {
         for(this.exitPortalLocation = this.world.getHeight(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, EndPodiumFeature.END_PODIUM_LOCATION).func_177977_b(); this.world.getBlockState(this.exitPortalLocation).isIn(Blocks.BEDROCK) && this.exitPortalLocation.getY() > this.world.getSeaLevel(); this.exitPortalLocation = this.exitPortalLocation.func_177977_b()) {
         }
      }

      endpodiumfeature.func_225566_b_(IFeatureConfig.NO_FEATURE_CONFIG).func_236265_a_(this.world, this.world.func_241112_a_(), this.world.getChunkProvider().getChunkGenerator(), new Random(), this.exitPortalLocation);
   }
