   ...
   default boolean canBlockSeeSky(BlockPos pos) {
      if (pos.getY() >= this.getSeaLevel()) {
         ...
         if (!this.func_226660_f_(blockpos)) {
            ...
            for(BlockPos blockpos1 = blockpos.func_177977_b(); blockpos1.getY() > pos.getY(); blockpos1 = blockpos1.func_177977_b()) {
      ...
      for(int k1 = i; k1 < j; ++k1) {
         for(int l1 = k; l1 < l; ++l1) {
            for(int i2 = i1; i2 < j1; ++i2) {
               BlockState blockstate = this.getBlockState(blockpos$mutable.func_181079_c(k1, l1, i2));
