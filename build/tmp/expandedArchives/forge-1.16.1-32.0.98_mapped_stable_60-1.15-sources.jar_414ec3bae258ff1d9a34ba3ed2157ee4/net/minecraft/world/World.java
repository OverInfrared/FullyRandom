...
public abstract class World extends net.minecraftforge.common.capabilities.CapabilityProvider<World> implements IWorld, AutoCloseable, net.minecraftforge.common.extensions.IForgeWorld {
   ...
   protected World(ISpawnWorldInfo p_i231617_1_, RegistryKey<World> p_i231617_2_, RegistryKey<DimensionType> p_i231617_3_, DimensionType p_i231617_4_, Supplier<IProfiler> p_i231617_5_, boolean p_i231617_6_, boolean p_i231617_7_, long p_i231617_8_) {
      ...
      this.field_226689_w_ = new BiomeManager(this, p_i231617_8_, p_i231617_4_.func_227176_e_());
   ...
   public double func_234932_c_(BlockPos p_234932_1_, Predicate<BlockState> p_234932_2_) {
      ...
      if (voxelshape.isEmpty()) {
         BlockPos blockpos = p_234932_1_.func_177977_b();
   ...
   public boolean func_241211_a_(BlockPos p_241211_1_, BlockState p_241211_2_, int p_241211_3_, int p_241211_4_) {
      if (isOutsideBuildHeight(p_241211_1_)) {
         ...
         if (blockstate == null) {
            ...
            if (blockstate1 != blockstate && (blockstate1.getOpacity(this, p_241211_1_) != oldOpacity || blockstate1.getLightValue(this, p_241211_1_) != oldLight || blockstate1.func_215691_g() || blockstate.func_215691_g())) {
               this.getProfiler().startSection("queueCheckLight");
               this.getChunkProvider().func_212863_j_().checkBlock(p_241211_1_);
       ...
       {
           {
            if (blockstate1 == p_241211_2_) {
               ...
               if ((p_241211_3_ & 2) != 0 && (!this.isRemote || (p_241211_3_ & 4) == 0) && (this.isRemote || chunk.func_217321_u() != null && chunk.func_217321_u().func_219065_a(ChunkHolder.LocationType.TICKING))) {
   ...
   public void notifyNeighborsOfStateChange(BlockPos pos, Block blockIn) {
      ...
      this.neighborChanged(pos.func_177977_b(), blockIn, pos);
   ...
   public void notifyNeighborsOfStateExcept(BlockPos pos, Block blockType, Direction skipSide) {
      ...
      if (skipSide != Direction.DOWN) {
         this.neighborChanged(pos.func_177977_b(), blockType, pos);
      }
   ...
   public WorldLightManager func_225524_e_() {
      return this.getChunkProvider().func_212863_j_();
   }
   ...
   public int getStrongPower(BlockPos pos) {
      int i = 0;
      i = Math.max(i, this.getStrongPower(pos.func_177977_b(), Direction.DOWN));
      if (i >= 15) {
         return i;
      } else {
   ...
   public boolean isBlockPowered(BlockPos pos) {
      if (this.getRedstonePower(pos.func_177977_b(), Direction.DOWN) > 0) {
         return true;
   ...
   public boolean isRainingAt(BlockPos position) {
      if (!this.isRaining()) {
         ...
         Biome biome = this.func_226691_t_(position);
         return biome.getPrecipitation() == Biome.RainType.RAIN && biome.func_225486_c(position) >= 0.15F;
      }
   }
   ...
   public CrashReportCategory fillCrashReport(CrashReport report) {
      ...
      crashreportcategory.func_189529_a("Chunk stats", this.getChunkProvider()::makeString);
