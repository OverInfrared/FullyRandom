...
public class NetherBiomeProvider extends BiomeProvider {
   ...
   public Biome func_225526_b_(int p_225526_1_, int p_225526_2_, int p_225526_3_) {
      int i = this.field_235269_l_ ? p_225526_2_ : 0;
      Biome.Attributes biome$attributes = new Biome.Attributes((float)this.field_235264_g_.func_237211_a_((double)p_225526_1_, (double)i, (double)p_225526_3_), (float)this.field_235265_h_.func_237211_a_((double)p_225526_1_, (double)i, (double)p_225526_3_), (float)this.field_235266_i_.func_237211_a_((double)p_225526_1_, (double)i, (double)p_225526_3_), (float)this.field_235267_j_.func_237211_a_((double)p_225526_1_, (double)i, (double)p_225526_3_), 0.0F);
