...
public final class FlowerForestBiome extends Biome {
   public FlowerForestBiome() {
      ...
      this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.func_225566_b_(new MultipleRandomFeatureConfig(ImmutableList.of(Feature.field_236291_c_.func_225566_b_(DefaultBiomeFeatures.field_230135_r_).func_227227_a_(0.2F), Feature.field_236291_c_.func_225566_b_(DefaultBiomeFeatures.field_230134_q_).func_227227_a_(0.1F)), Feature.field_236291_c_.func_225566_b_(DefaultBiomeFeatures.field_230133_p_))).func_227228_a_(Placement.COUNT_EXTRA_HEIGHTMAP.func_227446_a_(new AtSurfaceWithExtraConfig(6, 0.1F, 1))));
