...
public abstract class BiomeProvider implements BiomeManager.IBiomeReader {
   ...
   protected BiomeProvider(List<Biome> p_i231634_1_) {
      this.field_226837_c_ = p_i231634_1_;
   }
   ...
   public BlockPos func_225531_a_(int p_225531_1_, int p_225531_2_, int p_225531_3_, int p_225531_4_, List<Biome> p_225531_5_, Random p_225531_6_) {
      return this.func_230321_a_(p_225531_1_, p_225531_2_, p_225531_3_, p_225531_4_, 1, p_225531_5_, p_225531_6_, false);
   }
      ...
      for(int k1 = j1; k1 <= k; k1 += p_230321_5_) {
         for(int l1 = -k1; l1 <= k1; l1 += p_230321_5_) {
            ...
            for(int i2 = -k1; i2 <= k1; i2 += p_230321_5_) {
               ...
               int k2 = i + i2;
               int j2 = j + l1;
               if (p_230321_6_.contains(this.func_225526_b_(k2, l, j2))) {
