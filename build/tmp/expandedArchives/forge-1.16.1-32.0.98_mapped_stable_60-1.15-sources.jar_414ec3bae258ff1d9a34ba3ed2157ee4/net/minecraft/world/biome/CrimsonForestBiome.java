...
public class CrimsonForestBiome extends Biome {
   protected CrimsonForestBiome() {
      ...
      this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_236283_N_.func_225566_b_(IFeatureConfig.NO_FEATURE_CONFIG).func_227228_a_(Placement.COUNT_RANGE.func_227446_a_(new CountRangeConfig(10, 0, 0, 128))));
