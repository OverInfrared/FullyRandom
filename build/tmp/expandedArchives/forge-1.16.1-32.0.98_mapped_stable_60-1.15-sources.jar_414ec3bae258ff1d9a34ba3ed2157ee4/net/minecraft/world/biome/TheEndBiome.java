...
public final class TheEndBiome extends Biome {
   public TheEndBiome() {
      ...
      this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Feature.END_SPIKE.func_225566_b_(new EndSpikeFeatureConfig(false, ImmutableList.of(), (BlockPos)null)));
