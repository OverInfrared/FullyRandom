...
public class EndBiomeProvider extends BiomeProvider {
   ...
   private static final List<Biome> field_226853_f_ = ImmutableList.of(Biomes.THE_END, Biomes.END_HIGHLANDS, Biomes.END_MIDLANDS, Biomes.SMALL_END_ISLANDS, Biomes.END_BARRENS);
