               ...
               if (random.nextInt(5) != 0) {
                  ...
                  if (j < 1) {
                     ...
                     if (playerentity.isSpectator()) {
                        ...
                        BlockPos.Mutable blockpos$mutable = playerentity.func_233580_cy_().func_239590_i_().func_196234_d(k, 0, l);
                        if (!p_230253_1_.isAreaLoaded(blockpos$mutable.getX() - 10, blockpos$mutable.getY() - 10, blockpos$mutable.getZ() - 10, blockpos$mutable.getX() + 10, blockpos$mutable.getY() + 10, blockpos$mutable.getZ() + 10)) {
                           ...
                           Biome biome = p_230253_1_.func_226691_t_(blockpos$mutable);
                           ...
                           if (biome$category == Biome.Category.MUSHROOM) {
                              ...
                              for(int k1 = 0; k1 < j1; ++k1) {
                                 ...
                                 if (k1 == 0) {
                                    if (!this.func_222695_a(p_230253_1_, blockpos$mutable, random, true)) {
                                       break;
                                    }
                                 } else {
                                    this.func_222695_a(p_230253_1_, blockpos$mutable, random, false);
                                 }
