...
public class PhantomSpawner implements ISpecialSpawner {
   ...
   public int func_230253_a_(ServerWorld p_230253_1_, boolean p_230253_2_, boolean p_230253_3_) {
      if (!p_230253_2_) {
         return 0;
      } else if (!p_230253_1_.getGameRules().getBoolean(GameRules.field_226682_y_)) {
         return 0;
      } else {
            ...
            if (p_230253_1_.getSkylightSubtracted() < 5 && p_230253_1_.func_230315_m_().hasSkyLight()) {
               ...
               for(PlayerEntity playerentity : p_230253_1_.getPlayers()) {
                  if (!playerentity.isSpectator()) {
                     ...
                     if (!p_230253_1_.func_230315_m_().hasSkyLight() || blockpos.getY() >= p_230253_1_.getSeaLevel() && p_230253_1_.func_226660_f_(blockpos)) {
