...
public final class NoiseChunkGenerator extends ChunkGenerator {
   ...
   public void func_225551_a_(WorldGenRegion p_225551_1_, IChunk p_225551_2_) {
      ...
      for(int i1 = 0; i1 < 16; ++i1) {
         for(int j1 = 0; j1 < 16; ++j1) {
            ...
            p_225551_1_.func_226691_t_(blockpos$mutable.func_181079_c(k + i1, i2, l + j1)).buildSurface(sharedseedrandom, p_225551_2_, k1, l1, i2, d1, this.defaultBlock, this.defaultFluid, this.func_230356_f_(), p_225551_1_.getSeed());
         }
      }
            ...
            if (flag) {
               for(int j1 = 0; j1 < 5; ++j1) {
                  if (j1 <= rand.nextInt(5)) {
                     chunkIn.setBlockState(blockpos$mutable.func_181079_c(blockpos.getX(), l - j1, blockpos.getZ()), Blocks.BEDROCK.getDefaultState(), false);
                  }
               }
            }
            ...
            if (flag1) {
               for(int k1 = 4; k1 >= 0; --k1) {
                  if (k1 <= rand.nextInt(5)) {
                     chunkIn.setBlockState(blockpos$mutable.func_181079_c(blockpos.getX(), k + k1, blockpos.getZ()), Blocks.BEDROCK.getDefaultState(), false);
                  }
               }
            }
         }
   ...
   public void func_230354_a_(WorldGenRegion p_230354_1_) {
      if (!this.field_236080_h_.func_236120_h_()) {
         ...
         Biome biome = p_230354_1_.func_226691_t_((new ChunkPos(i, j)).asBlockPos());
         SharedSeedRandom sharedseedrandom = new SharedSeedRandom();
