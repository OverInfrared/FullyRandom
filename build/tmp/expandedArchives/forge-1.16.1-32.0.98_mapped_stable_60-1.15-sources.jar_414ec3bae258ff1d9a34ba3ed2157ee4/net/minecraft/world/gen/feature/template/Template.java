...
public class Template {
   ...
   private void takeEntitiesFromWorld(World worldIn, BlockPos startPos, BlockPos endPos) {
      ...
      for(Entity entity : list) {
         Vector3d vector3d = new Vector3d(entity.func_226277_ct_() - (double)startPos.getX(), entity.func_226278_cu_() - (double)startPos.getY(), entity.func_226281_cx_() - (double)startPos.getZ());
