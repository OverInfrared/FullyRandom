...
public class NetherVegetationFeature extends Feature<BlockStateProvidingFeatureConfig> {
   ...
   public static boolean func_236325_a_(IWorld p_236325_0_, Random p_236325_1_, BlockPos p_236325_2_, BlockStateProvidingFeatureConfig p_236325_3_, int p_236325_4_, int p_236325_5_) {
      for(Block block = p_236325_0_.getBlockState(p_236325_2_.func_177977_b()).getBlock(); !block.isIn(BlockTags.field_232873_an_) && p_236325_2_.getY() > 0; block = p_236325_0_.getBlockState(p_236325_2_).getBlock()) {
         p_236325_2_ = p_236325_2_.func_177977_b();
      }
      ...
      if (i >= 1 && i + 1 < 256) {
         ...
         for(int k = 0; k < p_236325_4_ * p_236325_4_; ++k) {
            ...
            BlockState blockstate = p_236325_3_.field_227268_a_.func_225574_a_(p_236325_1_, blockpos);
