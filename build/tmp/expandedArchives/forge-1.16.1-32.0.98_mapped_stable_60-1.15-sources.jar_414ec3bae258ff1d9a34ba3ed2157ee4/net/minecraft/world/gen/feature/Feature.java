...
public abstract class Feature<FC extends IFeatureConfig> extends net.minecraftforge.registries.ForgeRegistryEntry<Feature<?>> {
   public static final Feature<NoFeatureConfig> field_227245_q_ = register("no_op", new NoOpFeature(NoFeatureConfig.field_236558_a_));
   ...
   public static final FlowersFeature<BlockClusterFeatureConfig> field_227247_y_ = register("flower", new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_));
   public static final Feature<BlockClusterFeatureConfig> field_227248_z_ = register("random_patch", new RandomPatchFeature(BlockClusterFeatureConfig.field_236587_a_));
   public static final Feature<BlockStateProvidingFeatureConfig> field_227244_A_ = register("block_pile", new BlockPileFeature(BlockStateProvidingFeatureConfig.field_236453_a_));
   ...
   public static boolean func_236293_a_(IWorldGenerationBaseReader p_236293_0_, BlockPos p_236293_1_) {
      return p_236293_0_.hasBlockState(p_236293_1_, (p_236294_0_) -> {
         return func_227250_b_(p_236294_0_.getBlock());
      });
   }
