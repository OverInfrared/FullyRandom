...
public class JigsawManager {
   ...
   public static void func_236823_a_(ResourceLocation p_236823_0_, int p_236823_1_, JigsawManager.IPieceFactory p_236823_2_, ChunkGenerator p_236823_3_, TemplateManager p_236823_4_, BlockPos p_236823_5_, List<? super AbstractVillagePiece> p_236823_6_, Random p_236823_7_, boolean p_236823_8_, boolean p_236823_9_) {
      ...
      AbstractVillagePiece abstractvillagepiece = p_236823_2_.create(p_236823_4_, jigsawpiece, p_236823_5_, jigsawpiece.func_214850_d(), rotation, jigsawpiece.getBoundingBox(p_236823_4_, p_236823_5_, rotation));
      ...
      if (p_236823_1_ > 0) {
         ...
         jigsawmanager$assembler.availablePieces.addLast(new JigsawManager.Entry(abstractvillagepiece, new MutableObject<>(VoxelShapes.combineAndSimplify(VoxelShapes.create(axisalignedbb), VoxelShapes.create(AxisAlignedBB.func_216363_a(mutableboundingbox)), IBooleanFunction.ONLY_FIRST)), k + 80, 0));
         ...
         while(!jigsawmanager$assembler.availablePieces.isEmpty()) {
            ...
            jigsawmanager$assembler.func_236831_a_(jigsawmanager$entry.villagePiece, jigsawmanager$entry.field_214877_b, jigsawmanager$entry.field_214878_c, jigsawmanager$entry.field_214879_d, p_236823_8_);
         }
   ...
   public static void func_236822_a_(AbstractVillagePiece p_236822_0_, int p_236822_1_, JigsawManager.IPieceFactory p_236822_2_, ChunkGenerator p_236822_3_, TemplateManager p_236822_4_, List<? super AbstractVillagePiece> p_236822_5_, Random p_236822_6_) {
      ...
      while(!jigsawmanager$assembler.availablePieces.isEmpty()) {
         JigsawManager.Entry jigsawmanager$entry = jigsawmanager$assembler.availablePieces.removeFirst();
         jigsawmanager$assembler.func_236831_a_(jigsawmanager$entry.villagePiece, jigsawmanager$entry.field_214877_b, jigsawmanager$entry.field_214878_c, jigsawmanager$entry.field_214879_d, false);
      }
   ...
   static final class Assembler {
      ...
      private Assembler(int p_i232044_1_, JigsawManager.IPieceFactory p_i232044_2_, ChunkGenerator p_i232044_3_, TemplateManager p_i232044_4_, List<? super AbstractVillagePiece> p_i232044_5_, Random p_i232044_6_) {
         this.field_214882_a = p_i232044_1_;
            ...
            if (jigsawpattern != JigsawPattern.INVALID && (jigsawpattern.getNumberOfPieces() != 0 || jigsawpattern == JigsawPattern.EMPTY)) {
               ...
               if (flag1) {
                  ...
                  if (mutableobject.getValue() == null) {
                     mutableobject.setValue(VoxelShapes.create(AxisAlignedBB.func_216363_a(mutableboundingbox)));
                  }
               } else {
                  ...
                  for(Rotation rotation1 : Rotation.shuffledRotations(this.rand)) {
                     ...
                     for(Template.BlockInfo template$blockinfo1 : list1) {
                        if (JigsawBlock.func_220171_a(template$blockinfo, template$blockinfo1)) {
                           ...
                           if (!VoxelShapes.compare(mutableobject1.getValue(), VoxelShapes.create(AxisAlignedBB.func_216363_a(mutableboundingbox3).shrink(0.25D)), IBooleanFunction.ONLY_SECOND)) {
                              mutableobject1.setValue(VoxelShapes.combine(mutableobject1.getValue(), VoxelShapes.create(AxisAlignedBB.func_216363_a(mutableboundingbox3)), IBooleanFunction.ONLY_FIRST));
                              ...
                              if (p_236831_4_ + 1 <= this.field_214882_a) {
