...
public abstract class ChunkGenerator {
   ...
   public void func_230350_a_(long p_230350_1_, BiomeManager p_230350_3_, IChunk p_230350_4_, GenerationStage.Carving p_230350_5_) {
      BiomeManager biomemanager = p_230350_3_.func_226835_a_(this.biomeProvider);
      SharedSeedRandom sharedseedrandom = new SharedSeedRandom();
      int i = 8;
      ChunkPos chunkpos = p_230350_4_.getPos();
      int j = chunkpos.x;
      int k = chunkpos.z;
      Biome biome = this.biomeProvider.func_225526_b_(chunkpos.x << 2, 0, chunkpos.z << 2);
         ...
         for(int i1 = k - 8; i1 <= k + 8; ++i1) {
            ...
            while(listiterator.hasNext()) {
               ...
               if (configuredcarver.shouldCarve(sharedseedrandom, l, i1)) {
                  configuredcarver.func_227207_a_(p_230350_4_, biomemanager::func_226836_a_, sharedseedrandom, this.func_230356_f_(), l, i1, j, k, bitset);
               }
            }
         }
      }
   ...
   public BlockPos func_235956_a_(ServerWorld p_235956_1_, Structure<?> p_235956_2_, BlockPos p_235956_3_, int p_235956_4_, boolean p_235956_5_) {
      if (!this.biomeProvider.hasStructure(p_235956_2_)) {
         ...
         for(ChunkPos chunkpos : this.field_235951_f_) {
            blockpos$mutable.func_181079_c((chunkpos.x << 4) + 8, 32, (chunkpos.z << 4) + 8);
   ...
   public void func_230351_a_(WorldGenRegion p_230351_1_, StructureManager p_230351_2_) {
      ...
      Biome biome = this.biomeProvider.func_225526_b_((i << 2) + 2, 2, (j << 2) + 2);
      SharedSeedRandom sharedseedrandom = new SharedSeedRandom();
      ...
      for(GenerationStage.Decoration generationstage$decoration : GenerationStage.Decoration.values()) {
         try {
            ...
            crashreport.makeCategory("Generation").func_71507_a("CenterX", i).func_71507_a("CenterZ", j).func_71507_a("Step", generationstage$decoration).func_71507_a("Seed", i1).func_71507_a("Biome", Registry.BIOME.getKey(biome));
   ...
   public void func_235954_a_(StructureManager p_235954_1_, IChunk p_235954_2_, TemplateManager p_235954_3_, long p_235954_4_) {
      ...
      Biome biome = this.biomeProvider.func_225526_b_((chunkpos.x << 2) + 2, 0, (chunkpos.z << 2) + 2);
         ...
         for(int k1 = k - 8; k1 <= k + 8; ++k1) {
            ...
            for(StructureStart<?> structurestart : p_235953_1_.getChunk(j1, k1).getStructureStarts().values()) {
               try {
                  ...
                  crashreportcategory.func_189529_a("Id", () -> {
                  ...
                  crashreportcategory.func_189529_a("Class", () -> {
