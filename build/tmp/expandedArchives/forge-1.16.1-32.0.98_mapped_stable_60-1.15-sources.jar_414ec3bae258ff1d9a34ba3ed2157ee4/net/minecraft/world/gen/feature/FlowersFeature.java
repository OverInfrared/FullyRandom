...
public abstract class FlowersFeature<U extends IFeatureConfig> extends Feature<U> {
   ...
   public boolean func_230362_a_(ISeedReader p_230362_1_, StructureManager p_230362_2_, ChunkGenerator p_230362_3_, Random p_230362_4_, BlockPos p_230362_5_, U p_230362_6_) {
      BlockState blockstate = this.func_225562_b_(p_230362_4_, p_230362_5_, p_230362_6_);
      int i = 0;

      for(int j = 0; j < this.func_225560_a_(p_230362_6_); ++j) {
         BlockPos blockpos = this.func_225561_a_(p_230362_4_, p_230362_5_, p_230362_6_);
   ...
   public abstract BlockPos func_225561_a_(Random p_225561_1_, BlockPos p_225561_2_, U p_225561_3_);

   public abstract BlockState func_225562_b_(Random p_225562_1_, BlockPos p_225562_2_, U p_225562_3_);
}