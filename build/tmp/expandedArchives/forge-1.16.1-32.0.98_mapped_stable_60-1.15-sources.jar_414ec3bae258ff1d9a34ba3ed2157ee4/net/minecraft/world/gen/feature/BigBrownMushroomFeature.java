         ...
         for(int k = -i; k <= i; ++k) {
            ...
            if (!flag4 || !flag5) {
               ...
               if (p_225564_1_.getBlockState(p_225564_5_).canBeReplacedByLeaves(p_225564_1_, p_225564_5_)) {
                  ...
                  this.func_230367_a_(p_225564_1_, p_225564_5_, p_225564_6_.field_227272_a_.func_225574_a_(p_225564_2_, p_225564_3_).with(HugeMushroomBlock.WEST, Boolean.valueOf(flag6)).with(HugeMushroomBlock.EAST, Boolean.valueOf(flag7)).with(HugeMushroomBlock.NORTH, Boolean.valueOf(flag8)).with(HugeMushroomBlock.SOUTH, Boolean.valueOf(flag9)));
               }
            }
         }
      }
