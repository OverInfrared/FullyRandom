...
public class JigsawPattern {
   ...
   public static final Codec<JigsawPattern> field_236852_a_ = RecordCodecBuilder.create((p_236854_0_) -> {
      return p_236854_0_.group(ResourceLocation.field_240908_a_.fieldOf("name").forGetter(JigsawPattern::func_214947_b), ResourceLocation.field_240908_a_.fieldOf("fallback").forGetter(JigsawPattern::func_214948_a), Codec.mapPair(JigsawPiece.field_236847_e_.fieldOf("element"), Codec.INT.fieldOf("weight")).codec().listOf().promotePartial(Util.func_240982_a_("Pool element: ", field_236853_d_::error)).fieldOf("elements").forGetter((p_236857_0_) -> {
         return p_236857_0_.field_214952_d;
   ...
   public int func_214945_a(TemplateManager templateManagerIn) {
      if (this.field_214956_h == Integer.MIN_VALUE) {
         this.field_214956_h = this.jigsawPieces.stream().mapToInt((p_236856_1_) -> {
