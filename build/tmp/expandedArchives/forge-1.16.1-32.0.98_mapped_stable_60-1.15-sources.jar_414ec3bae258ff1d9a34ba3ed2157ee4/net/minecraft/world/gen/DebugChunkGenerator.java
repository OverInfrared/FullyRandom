   ...
   public void func_230351_a_(WorldGenRegion p_230351_1_, StructureManager p_230351_2_) {
      ...
      for(int k = 0; k < 16; ++k) {
         for(int l = 0; l < 16; ++l) {
            int i1 = (i << 4) + k;
            int j1 = (j << 4) + l;
            p_230351_1_.setBlockState(blockpos$mutable.func_181079_c(i1, 60, j1), BARRIER, 2);
            BlockState blockstate = getBlockStateFor(i1, j1);
            if (blockstate != null) {
               p_230351_1_.setBlockState(blockpos$mutable.func_181079_c(i1, 70, j1), blockstate, 2);
            }
         }
      }
