...
public abstract class FoliagePlacer {
   public static final Codec<FoliagePlacer> field_236749_d_ = Registry.field_229389_v_.dispatch(FoliagePlacer::func_230371_a_, FoliagePlacerType::func_236772_a_);
         ...
         for(int k = -p_236753_5_; k <= p_236753_5_ + i; ++k) {
            if (!this.func_230375_b_(p_236753_2_, j, p_236753_7_, k, p_236753_5_, p_236753_8_)) {
               ...
               if (TreeFeature.func_236404_a_(p_236753_1_, blockpos$mutable)) {
                  p_236753_1_.setBlockState(blockpos$mutable, p_236753_3_.field_227369_n_.func_225574_a_(p_236753_2_, blockpos$mutable), 19);
