            ...
            for(int i1 = -l; i1 <= l; ++i1) {
               ...
               for(int j1 = -l; j1 <= l; ++j1) {
                  ...
                  if ((i1 == 0 && j1 == 0 || !(f1 * f1 + f2 * f2 > f * f)) && (i1 != -l && i1 != l && j1 != -l && j1 != l || !(p_230362_4_.nextFloat() > 0.75F))) {
                     ...
                     if (blockstate.isAir(p_230362_1_, p_230362_5_.add(i1, k, j1)) || func_227250_b_(block) || block == Blocks.SNOW_BLOCK || block == Blocks.ICE) {
         ...
         for(int l1 = -k1; l1 <= k1; ++l1) {
            for(int i2 = -k1; i2 <= k1; ++i2) {
               ...
               while(blockpos.getY() > 50) {
                  ...
                  if (!blockstate1.isAir(p_230362_1_, blockpos) && !func_227250_b_(block1) && block1 != Blocks.SNOW_BLOCK && block1 != Blocks.ICE && block1 != Blocks.PACKED_ICE) {
                     break;
                  }
                  ...
                  --j2;
                  if (j2 <= 0) {
                     blockpos = blockpos.func_177979_c(p_230362_4_.nextInt(5) + 1);
                     j2 = p_230362_4_.nextInt(5);
                  }
               }
            }
