...
public class Teleporter implements net.minecraftforge.common.util.ITeleporter {
   ...
   public boolean placeInPortal(Entity p_222268_1_, float p_222268_2_) {
      ...
      if (blockpattern$portalinfo == null) {
         ...
         p_222268_1_.func_225653_b_(vector3d1.x, vector3d1.y, vector3d1.z);
         return true;
      }
   }
      ...
      for(int j2 = j - 16; j2 <= j + 16; ++j2) {
         ...
         for(int l2 = l - 16; l2 <= l + 16; ++l2) {
            ...
            for(int j3 = this.world.func_234938_ad_() - 1; j3 >= 0; --j3) {
               if (this.world.isAirBlock(blockpos$mutable.func_181079_c(j2, j3, l2))) {
                  while(j3 > 0 && this.world.isAirBlock(blockpos$mutable.func_181079_c(j2, j3 - 1, l2))) {
                     --j3;
                  }
         ...
         for(int l5 = j - 16; l5 <= j + 16; ++l5) {
            ...
            for(int j6 = l - 16; j6 <= l + 16; ++j6) {
               ...
               for(int i7 = this.world.func_234938_ad_() - 1; i7 >= 0; --i7) {
                  if (this.world.isAirBlock(blockpos$mutable.func_181079_c(l5, i7, j6))) {
                     while(i7 > 0 && this.world.isAirBlock(blockpos$mutable.func_181079_c(l5, i7 - 1, j6))) {
                        --i7;
                     }
