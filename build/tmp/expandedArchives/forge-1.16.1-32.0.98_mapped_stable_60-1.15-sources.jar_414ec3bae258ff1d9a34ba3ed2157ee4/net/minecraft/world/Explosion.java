      ...
      for(int k2 = 0; k2 < list.size(); ++k2) {
         ...
         if (!entity.isImmuneToExplosions()) {
            ...
            if (d12 <= 1.0D) {
               ...
               double d7 = (entity instanceof TNTEntity ? entity.func_226278_cu_() : entity.func_226280_cw_()) - this.y;
   ...
   public void doExplosionB(boolean spawnParticles) {
      ...
      if (this.causesFire) {
         for(BlockPos blockpos2 : this.affectedBlockPositions) {
            if (this.random.nextInt(3) == 0 && this.world.getBlockState(blockpos2).isAir() && this.world.getBlockState(blockpos2.func_177977_b()).isOpaqueCube(this.world, blockpos2.func_177977_b())) {
