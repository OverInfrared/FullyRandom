...
public class ChunkHolder {
   ...
   public void updateAccessible() {
      this.accessible = func_219286_c(this.field_219317_l).func_219065_a(ChunkHolder.LocationType.BORDER);
   }
   ...
   public static enum LocationType {
      ...
      public boolean func_219065_a(ChunkHolder.LocationType type) {
