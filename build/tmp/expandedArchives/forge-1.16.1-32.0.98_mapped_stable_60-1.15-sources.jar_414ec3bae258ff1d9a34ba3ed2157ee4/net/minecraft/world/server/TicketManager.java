...
public abstract class TicketManager {
         ...
         if (!this.field_219387_o.isEmpty()) {
            ...
            while(longiterator.hasNext()) {
               ...
               if (this.func_229848_e_(j).stream().anyMatch((p_219369_0_) -> {
                  return p_219369_0_.func_219479_a() == TicketType.PLAYER;
               })) {
   ...
   public <T> void func_219356_a(TicketType<T> type, ChunkPos pos, int level, T value) {
      this.func_219347_a(pos.asLong(), new Ticket<>(type, level, value));
   }
   ...
   public <T> void func_219331_c(TicketType<T> type, ChunkPos pos, int distance, T value) {
      this.func_219347_a(pos.asLong(), new Ticket<>(type, 33 - distance, value));
   }
   ...
   protected void forceChunk(ChunkPos pos, boolean add) {
      ...
      if (add) {
         this.func_219347_a(pos.asLong(), ticket);
      } else {
         this.func_219349_b(pos.asLong(), ticket);
      }
      ...
      private void func_215504_a(long chunkPosIn, int p_215504_3_, boolean p_215504_4_, boolean p_215504_5_) {
         if (p_215504_4_ != p_215504_5_) {
            ...
            if (p_215504_5_) {
               ...
               TicketManager.this.field_219386_n.enqueue(ChunkTaskPriorityQueueSorter.func_219073_a(() -> {
                  TicketManager.this.field_219388_p.execute(() -> {
                     TicketManager.this.func_219349_b(chunkPosIn, ticket);
                  });
               }, chunkPosIn, true));
            }
         }
