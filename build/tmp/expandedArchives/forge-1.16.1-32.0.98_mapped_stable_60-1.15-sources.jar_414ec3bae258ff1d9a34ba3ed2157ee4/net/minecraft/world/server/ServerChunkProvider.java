...
public class ServerChunkProvider extends AbstractChunkProvider {
   ...
   private void tickChunks() {
      ...
      if (!flag) {
         ...
         list.forEach((p_241099_7_) -> {
            Optional<Chunk> optional = p_241099_7_.func_219296_a().getNow(ChunkHolder.UNLOADED_CHUNK).left();
            if (optional.isPresent()) {
               this.world.getProfiler().startSection("broadcast");
               p_241099_7_.sendChanges(optional.get());
               this.world.getProfiler().endSection();
               Optional<Chunk> optional1 = p_241099_7_.func_219297_b().getNow(ChunkHolder.UNLOADED_CHUNK).left();
   ...
   private void func_241098_a_(long p_241098_1_, Consumer<Chunk> p_241098_3_) {
      ...
      if (chunkholder != null) {
         chunkholder.func_223492_c().getNow(ChunkHolder.UNLOADED_CHUNK).left().ifPresent(p_241098_3_);
      }
   ...
   public <T> void func_217228_a(TicketType<T> type, ChunkPos pos, int distance, T value) {
      this.ticketManager.func_219331_c(type, pos, distance, value);
   }

   public <T> void func_217222_b(TicketType<T> type, ChunkPos pos, int distance, T value) {
      this.ticketManager.func_219362_d(type, pos, distance, value);
   }
