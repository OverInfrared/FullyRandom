...
public interface IEntityReader {
   ...
   default PlayerEntity getClosestPlayer(Entity entityIn, double distance) {
      return this.getClosestPlayer(entityIn.func_226277_ct_(), entityIn.func_226278_cu_(), entityIn.func_226281_cx_(), distance, false);
   }
   ...
   default PlayerEntity getClosestPlayer(EntityPredicate predicate, LivingEntity target) {
      return this.getClosestEntity(this.getPlayers(), predicate, target, target.func_226277_ct_(), target.func_226278_cu_(), target.func_226281_cx_());
   }
   ...
   default <T extends LivingEntity> T func_225318_b(Class<? extends T> p_225318_1_, EntityPredicate p_225318_2_, @Nullable LivingEntity p_225318_3_, double p_225318_4_, double p_225318_6_, double p_225318_8_, AxisAlignedBB p_225318_10_) {
      return this.getClosestEntity(this.func_225316_b(p_225318_1_, p_225318_10_, (Predicate<? super T>)null), p_225318_2_, p_225318_3_, p_225318_4_, p_225318_6_, p_225318_8_);
   }
   ...
   default List<PlayerEntity> getTargettablePlayersWithinAABB(EntityPredicate predicate, LivingEntity target, AxisAlignedBB box) {
      ...
      for(PlayerEntity playerentity : this.getPlayers()) {
         if (box.contains(playerentity.func_226277_ct_(), playerentity.func_226278_cu_(), playerentity.func_226281_cx_()) && predicate.canTarget(target, playerentity)) {
