   ...
   public BlockState setBlockState(BlockPos pos, BlockState state, boolean isMoving) {
      ...
      if (j >= 0 && j < 256) {
         if (this.sections[j >> 4] == Chunk.EMPTY_SECTION && state.isIn(Blocks.AIR)) {
            ...
            if (this.status.isAtLeast(ChunkStatus.FEATURES) && state != blockstate && (state.getOpacity(this, pos) != blockstate.getOpacity(this, pos) || state.getLightValue(this, pos) != blockstate.getLightValue(this, pos) || state.func_215691_g() || blockstate.func_215691_g())) {
