...
public class ChunkSerializer {
   ...
   public static ChunkPrimer func_222656_a(ServerWorld worldIn, TemplateManager p_222656_1_, PointOfInterestManager p_222656_2_, ChunkPos pos, CompoundNBT compound) {
      ...
      for(int j = 0; j < listnbt.size(); ++j) {
         ...
         if (compoundnbt1.contains("Palette", 9) && compoundnbt1.contains("BlockStates", 12)) {
            ...
            chunksection.func_186049_g().readChunkPalette(compoundnbt1.getList("Palette", 10), compoundnbt1.getLongArray("BlockStates"));
      ...
      ichunk.setStructureStarts(func_235967_a_(p_222656_1_, compoundnbt4, worldIn.getSeed()));
   ...
   public static CompoundNBT func_222645_a(ServerWorld worldIn, IChunk chunkIn) {
      ...
      WorldLightManager worldlightmanager = worldIn.getChunkProvider().func_212863_j_();
      ...
      for(int i = -1; i < 17; ++i) {
         ...
         if (chunksection != Chunk.EMPTY_SECTION || nibblearray != null || nibblearray1 != null) {
            ...
            if (chunksection != Chunk.EMPTY_SECTION) {
               chunksection.func_186049_g().writeChunkPalette(compoundnbt2, "Palette", "BlockStates");
            }
