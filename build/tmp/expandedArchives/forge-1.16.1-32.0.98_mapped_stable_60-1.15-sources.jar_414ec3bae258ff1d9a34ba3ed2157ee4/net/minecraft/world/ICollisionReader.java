...
public interface ICollisionReader extends IBlockReader {
   ...
   default Stream<VoxelShape> func_234867_d_(@Nullable Entity p_234867_1_, AxisAlignedBB p_234867_2_, Predicate<Entity> p_234867_3_) {
      return Stream.concat(this.func_226666_b_(p_234867_1_, p_234867_2_), this.func_230318_c_(p_234867_1_, p_234867_2_, p_234867_3_));
   }

   default Stream<VoxelShape> func_226666_b_(@Nullable Entity p_226666_1_, AxisAlignedBB p_226666_2_) {
