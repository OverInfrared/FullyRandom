...
public final class NBTUtil {
   ...
   public static UUID readUniqueId(INBT tag) {
      if (tag.func_225647_b_() != IntArrayNBT.field_229690_a_) {
         throw new IllegalArgumentException("Expected UUID-Tag to be of type " + IntArrayNBT.field_229690_a_.func_225648_a_() + ", but found " + tag.func_225647_b_().func_225648_a_() + ".");
      } else {
