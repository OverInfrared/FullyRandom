...
public class PointOfInterestType extends net.minecraftforge.registries.ForgeRegistryEntry<PointOfInterestType> {
   ...
   public static final Predicate<PointOfInterestType> field_221053_a = (p_234172_0_) -> {
      return true;
   };
   ...
   public static final PointOfInterestType field_234166_w_ = func_226359_a_("lodestone", getAllStates(Blocks.field_235405_no_), 0, 1);
   ...
   public static Set<BlockState> getAllStates(Block p_221042_0_) {
   ...
   public PointOfInterestType(String p_i225712_1_, Set<BlockState> p_i225712_2_, int p_i225712_3_, int p_i225712_4_) {
      ...
      this.field_221078_z = (p_234170_1_) -> {
   ...
   private static PointOfInterestType func_226359_a_(String p_226359_0_, Set<BlockState> p_226359_1_, int p_226359_2_, int p_226359_3_) {
      return func_221052_a(Registry.register(Registry.POINT_OF_INTEREST_TYPE, new ResourceLocation(p_226359_0_), new PointOfInterestType(p_226359_0_, p_226359_1_, p_226359_2_, p_226359_3_)));
   }
   ...
   private static PointOfInterestType func_226360_a_(String p_226360_0_, Set<BlockState> p_226360_1_, int p_226360_2_, Predicate<PointOfInterestType> p_226360_3_, int p_226360_4_) {
      return func_221052_a(Registry.register(Registry.POINT_OF_INTEREST_TYPE, new ResourceLocation(p_226360_0_), new PointOfInterestType(p_226360_0_, p_226360_1_, p_226360_2_, p_226360_3_, p_226360_4_)));
   }
