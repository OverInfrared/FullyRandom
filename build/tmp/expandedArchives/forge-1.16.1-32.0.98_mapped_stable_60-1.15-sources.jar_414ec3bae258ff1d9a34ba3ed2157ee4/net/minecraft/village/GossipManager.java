...
public class GossipManager {
   ...
   public void func_234057_a_(Dynamic<?> p_234057_1_) {
      p_234057_1_.asStream().map(GossipManager.GossipEntry::func_234060_a_).flatMap((p_234056_0_) -> {
         ...
         this.func_220926_a(p_234055_1_.target).gossipTypeMap.put(p_234055_1_.type, p_234055_1_.value);
      });
   }
   ...
   static class GossipEntry {
      ...
      public <T> Dynamic<T> func_234061_a_(DynamicOps<T> p_234061_1_) {
         return new Dynamic<>(p_234061_1_, p_234061_1_.createMap(ImmutableMap.of(p_234061_1_.createString("Target"), UUIDCodec.field_239775_a_.encodeStart(p_234061_1_, this.target).result().orElseThrow(RuntimeException::new), p_234061_1_.createString("Type"), p_234061_1_.createString(this.type.field_220931_g), p_234061_1_.createString("Value"), p_234061_1_.createInt(this.value))));
      }

      public static DataResult<GossipManager.GossipEntry> func_234060_a_(Dynamic<?> p_234060_0_) {
         return DataResult.unbox(DataResult.instance().group(p_234060_0_.get("Target").read(UUIDCodec.field_239775_a_), p_234060_0_.get("Type").asString().map(GossipType::func_220929_a), p_234060_0_.get("Value").asNumber().map(Number::intValue)).apply(DataResult.instance(), GossipManager.GossipEntry::new));
      }
   }
