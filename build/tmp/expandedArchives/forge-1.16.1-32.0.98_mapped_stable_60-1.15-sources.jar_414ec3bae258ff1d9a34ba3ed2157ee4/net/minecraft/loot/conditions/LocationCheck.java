...
public class LocationCheck implements ILootCondition {
   ...
   public boolean test(LootContext p_test_1_) {
      ...
      return blockpos != null && this.predicate.func_193453_a(p_test_1_.func_202879_g(), (float)(blockpos.getX() + this.field_227564_b_.getX()), (float)(blockpos.getY() + this.field_227564_b_.getY()), (float)(blockpos.getZ() + this.field_227564_b_.getZ()));
   }
