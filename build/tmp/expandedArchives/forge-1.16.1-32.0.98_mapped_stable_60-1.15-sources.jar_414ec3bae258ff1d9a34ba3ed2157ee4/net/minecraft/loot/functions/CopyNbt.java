...
public class CopyNbt extends LootFunction {
   ...
   public static class Builder extends LootFunction.Builder<CopyNbt.Builder> {
      ...
      public CopyNbt.Builder func_216055_a(String p_216055_1_, String p_216055_2_, CopyNbt.Action p_216055_3_) {
         this.operations.add(new CopyNbt.Operation(p_216055_1_, p_216055_2_, p_216055_3_));
         return this;
      }
   ...
   public static class Serializer extends LootFunction.Serializer<CopyNbt> {
      public void func_230424_a_(JsonObject p_230424_1_, CopyNbt p_230424_2_, JsonSerializationContext p_230424_3_) {
         ...
         p_230424_1_.addProperty("source", p_230424_2_.field_215887_a.field_216224_e);
         JsonArray jsonarray = new JsonArray();
         p_230424_2_.field_215888_c.stream().map(CopyNbt.Operation::func_216214_a).forEach(jsonarray::add);
