      ...
      if (!World.func_234935_k_(blockpos)) {
         ...
         if (entity == null) {
            ...
            if (randomizeProperties && entity instanceof MobEntity) {
               ((MobEntity)entity).onInitialSpawn(source.func_197023_e(), source.func_197023_e().getDifficultyForLocation(entity.func_233580_cy_()), SpawnReason.COMMAND, (ILivingEntityData)null, (CompoundNBT)null);
            }
