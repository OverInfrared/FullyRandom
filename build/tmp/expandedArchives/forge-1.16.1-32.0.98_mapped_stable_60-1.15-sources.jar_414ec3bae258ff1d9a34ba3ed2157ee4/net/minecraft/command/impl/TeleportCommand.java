...
public class TeleportCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      LiteralCommandNode<CommandSource> literalcommandnode = dispatcher.register(Commands.literal("teleport").requires((p_198816_0_) -> {
         ...
         return func_200559_a(p_198807_0_.getSource(), EntityArgument.getEntities(p_198807_0_, "targets"), p_198807_0_.getSource().func_197023_e(), Vec3Argument.getLocation(p_198807_0_, "location"), (ILocationArgument)null, (TeleportCommand.Facing)null);
      }).then(Commands.argument("rotation", RotationArgument.rotation()).executes((p_198811_0_) -> {
         return func_200559_a(p_198811_0_.getSource(), EntityArgument.getEntities(p_198811_0_, "targets"), p_198811_0_.getSource().func_197023_e(), Vec3Argument.getLocation(p_198811_0_, "location"), RotationArgument.getRotation(p_198811_0_, "rotation"), (TeleportCommand.Facing)null);
         ...
         return func_200559_a(p_200560_0_.getSource(), Collections.singleton(p_200560_0_.getSource().assertIsEntity()), p_200560_0_.getSource().func_197023_e(), Vec3Argument.getLocation(p_200560_0_, "location"), LocationInput.current(), (TeleportCommand.Facing)null);
   ...
   private static int teleportToEntity(CommandSource source, Collection<? extends Entity> targets, Entity destination) throws CommandSyntaxException {
      for(Entity entity : targets) {
         func_201127_a(source, entity, (ServerWorld)destination.world, destination.func_226277_ct_(), destination.func_226278_cu_(), destination.func_226281_cx_(), EnumSet.noneOf(SPlayerPositionLookPacket.Flags.class), destination.rotationYaw, destination.rotationPitch, (TeleportCommand.Facing)null);
      }
   ...
   private static int func_200559_a(CommandSource source, Collection<? extends Entity> targets, ServerWorld worldIn, ILocationArgument position, @Nullable ILocationArgument rotationIn, @Nullable TeleportCommand.Facing facing) throws CommandSyntaxException {
      ...
      for(Entity entity : targets) {
         if (rotationIn == null) {
            func_201127_a(source, entity, worldIn, vector3d.x, vector3d.y, vector3d.z, set, entity.rotationYaw, entity.rotationPitch, facing);
         } else {
            func_201127_a(source, entity, worldIn, vector3d.x, vector3d.y, vector3d.z, set, vector2f.y, vector2f.x, facing);
         }
      }
   ...
   private static void func_201127_a(CommandSource source, Entity entityIn, ServerWorld worldIn, double x, double y, double z, Set<SPlayerPositionLookPacket.Flags> relativeList, float yaw, float pitch, @Nullable TeleportCommand.Facing facing) throws CommandSyntaxException {
