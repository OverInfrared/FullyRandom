...
public class ExecuteCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      ...
      dispatcher.register(Commands.literal("execute").requires((p_229766_0_) -> {
         ...
         for(Entity entity : EntityArgument.getEntitiesAllowingNone(p_229809_0_, "targets")) {
            list.add(p_229809_0_.getSource().func_201003_a((ServerWorld)entity.world).withPos(entity.getPositionVec()).withRotation(entity.getPitchYaw()));
         }
         ...
         return p_229804_0_.getSource().func_201003_a(DimensionArgument.getDimensionArgument(p_229804_0_, "dimension"));
      }))));
   }
   ...
   private static ArgumentBuilder<CommandSource, ?> makeIfCommand(CommandNode<CommandSource> parent, LiteralArgumentBuilder<CommandSource> literal, boolean isIf) {
      literal.then(Commands.literal("block").then(Commands.argument("pos", BlockPosArgument.blockPos()).then(buildIfResult(parent, Commands.argument("block", BlockPredicateArgument.blockPredicate()), isIf, (p_210438_0_) -> {
         return BlockPredicateArgument.getBlockPredicate(p_210438_0_, "block").test(new CachedBlockInfo(p_210438_0_.getSource().func_197023_e(), BlockPosArgument.getLoadedBlockPos(p_210438_0_, "pos"), true));
   ...
   private static boolean func_229767_a_(CommandSource p_229767_0_, ILootCondition p_229767_1_) {
      ServerWorld serverworld = p_229767_0_.func_197023_e();
   ...
   private static OptionalInt countMatchingBlocks(CommandContext<CommandSource> context, boolean isMasked) throws CommandSyntaxException {
      return func_198395_a(context.getSource().func_197023_e(), BlockPosArgument.getLoadedBlockPos(context, "start"), BlockPosArgument.getLoadedBlockPos(context, "end"), BlockPosArgument.getLoadedBlockPos(context, "destination"), isMasked);
   }

   private static OptionalInt func_198395_a(ServerWorld worldIn, BlockPos begin, BlockPos end, BlockPos destination, boolean isMasked) throws CommandSyntaxException {
