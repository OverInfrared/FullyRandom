...
public class TimeCommand {
   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register(Commands.literal("time").requires((p_198828_0_) -> {
         ...
         return sendQueryResults(p_198827_0_.getSource(), func_198833_a(p_198827_0_.getSource().func_197023_e()));
      })).then(Commands.literal("gametime").executes((p_198821_0_) -> {
         return sendQueryResults(p_198821_0_.getSource(), (int)(p_198821_0_.getSource().func_197023_e().getGameTime() % 2147483647L));
      })).then(Commands.literal("day").executes((p_198831_0_) -> {
         return sendQueryResults(p_198831_0_.getSource(), (int)(p_198831_0_.getSource().func_197023_e().getDayTime() / 24000L % 2147483647L));
      }))));
   }

   private static int func_198833_a(ServerWorld worldIn) {
   ...
   public static int setTime(CommandSource source, int time) {
      ...
      return func_198833_a(source.func_197023_e());
   }
   ...
   public static int addTime(CommandSource source, int amount) {
      ...
      int i = func_198833_a(source.func_197023_e());
