...
public class EntitySelector {
      ...
      if (!this.includeNonPlayers) {
         ...
         if (this.self) {
            ...
            if (this.isWorldLimited()) {
               this.func_197348_a(list, source.func_197023_e(), vector3d, predicate);
            } else {
   ...
   private void func_197348_a(List<Entity> result, ServerWorld worldIn, Vector3d pos, Predicate<Entity> predicate) {
      if (this.aabb != null) {
   ...
   public List<ServerPlayerEntity> selectPlayers(CommandSource source) throws CommandSyntaxException {
      ...
      if (this.username != null) {
         ...
         if (this.self) {
            ...
            if (this.isWorldLimited()) {
               list = source.func_197023_e().getPlayers(predicate::test);
            } else {
