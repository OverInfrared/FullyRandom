...
public abstract class Container {
   ...
   public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, PlayerEntity player) {
      try {
         ...
         crashreportcategory.func_189529_a("Menu Type", () -> {
            return this.containerType != null ? Registry.MENU.getKey(this.containerType).toString() : "<no type>";
         });
         crashreportcategory.func_189529_a("Menu Class", () -> {
            return this.getClass().getCanonicalName();
         });
         crashreportcategory.func_71507_a("Slot Count", this.inventorySlots.size());
         crashreportcategory.func_71507_a("Slot", slotId);
         crashreportcategory.func_71507_a("Button", dragType);
         crashreportcategory.func_71507_a("Type", clickTypeIn);
