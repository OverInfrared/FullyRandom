...
public abstract class PathNavigator {
   ...
   public void updatePath() {
      if (this.world.getGameTime() - this.lastTimeUpdated > 20L) {
         if (this.targetPos != null) {
            ...
            this.currentPath = this.func_179680_a(this.targetPos, this.field_225468_r);
   ...
   public void tick() {
      ...
      if (!this.noPath()) {
         ...
         if (!this.noPath()) {
            ...
            this.entity.getMoveHelper().setMoveTo(vector3d2.x, this.world.getBlockState(blockpos.func_177977_b()).isAir() ? vector3d2.y : WalkNodeProcessor.getGroundY(this.world, blockpos), vector3d2.z, this.speed);
         }
      }
   }
   ...
   protected void pathFollow() {
      ...
      double d0 = Math.abs(this.entity.func_226277_ct_() - ((double)vector3i.getX() + 0.5D));
      double d1 = Math.abs(this.entity.func_226278_cu_() - (double)vector3i.getY());
      double d2 = Math.abs(this.entity.func_226281_cx_() - ((double)vector3i.getZ() + 0.5D));
   ...
   public void func_220970_c(BlockPos p_220970_1_) {
      if (this.currentPath != null && !this.currentPath.isFinished() && this.currentPath.getCurrentPathLength() != 0) {
         ...
         Vector3d vector3d = new Vector3d(((double)pathpoint.x + this.entity.func_226277_ct_()) / 2.0D, ((double)pathpoint.y + this.entity.func_226278_cu_()) / 2.0D, ((double)pathpoint.z + this.entity.func_226281_cx_()) / 2.0D);
