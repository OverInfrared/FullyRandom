...
public class WalkNodeProcessor extends NodeProcessor {
   ...
   public PathPoint getStart() {
      ...
      int i = MathHelper.floor(this.entity.func_226278_cu_());
      BlockState blockstate = this.blockaccess.getBlockState(blockpos$mutable.func_189532_c(this.entity.func_226277_ct_(), (double)i, this.entity.func_226281_cx_()));
      if (!this.entity.func_230285_a_(blockstate.getFluidState().getFluid())) {
         if (this.getCanSwim() && this.entity.isInWater()) {
            while(true) {
               ...
               ++i;
               blockstate = this.blockaccess.getBlockState(blockpos$mutable.func_189532_c(this.entity.func_226277_ct_(), (double)i, this.entity.func_226281_cx_()));
            }
         } else if (this.entity.func_233570_aj_()) {
            i = MathHelper.floor(this.entity.func_226278_cu_() + 0.5D);
         } else {
            BlockPos blockpos;
            for(blockpos = this.entity.func_233580_cy_(); (this.blockaccess.getBlockState(blockpos).isAir() || this.blockaccess.getBlockState(blockpos).allowsMovement(this.blockaccess, blockpos, PathType.LAND)) && blockpos.getY() > 0; blockpos = blockpos.func_177977_b()) {
            }
      ...
      if (this.entity.getPathPriority(pathnodetype) < 0.0F) {
         ...
         if (this.func_237239_b_(blockpos$mutable.func_189532_c(axisalignedbb.minX, (double)i, axisalignedbb.minZ)) || this.func_237239_b_(blockpos$mutable.func_189532_c(axisalignedbb.minX, (double)i, axisalignedbb.maxZ)) || this.func_237239_b_(blockpos$mutable.func_189532_c(axisalignedbb.maxX, (double)i, axisalignedbb.minZ)) || this.func_237239_b_(blockpos$mutable.func_189532_c(axisalignedbb.maxX, (double)i, axisalignedbb.maxZ))) {
   ...
   private boolean func_237234_a_(PathPoint p_237234_1_) {
      Vector3d vector3d = new Vector3d((double)p_237234_1_.x - this.entity.func_226277_ct_(), (double)p_237234_1_.y - this.entity.func_226278_cu_(), (double)p_237234_1_.z - this.entity.func_226281_cx_());
      AxisAlignedBB axisalignedbb = this.entity.getBoundingBox();
   ...
   private PathPoint getSafePoint(int x, int y, int z, int stepHeight, double groundYIn, Direction facing, PathNodeType p_186332_8_) {
      ...
      BlockPos.Mutable blockpos$mutable = new BlockPos.Mutable();
      double d0 = getGroundY(this.blockaccess, blockpos$mutable.func_181079_c(x, y, z));
         ...
         if (pathnodetype == PathNodeType.WALKABLE) {
            ...
            if ((pathpoint == null || pathpoint.costMalus < 0.0F) && stepHeight > 0 && pathnodetype != PathNodeType.FENCE && pathnodetype != PathNodeType.UNPASSABLE_RAIL && pathnodetype != PathNodeType.TRAPDOOR) {
               ...
               if (pathpoint != null && (pathpoint.nodeType == PathNodeType.OPEN || pathpoint.nodeType == PathNodeType.WALKABLE) && this.entity.getWidth() < 1.0F) {
                  ...
                  AxisAlignedBB axisalignedbb = new AxisAlignedBB(d2 - d1, getGroundY(this.blockaccess, blockpos$mutable.func_189532_c(d2, (double)(y + 1), d3)) + 0.001D, d3 - d1, d2 + d1, (double)this.entity.getHeight() + getGroundY(this.blockaccess, blockpos$mutable.func_189532_c((double)pathpoint.x, (double)pathpoint.y, (double)pathpoint.z)) - 0.002D, d3 + d1);
                  if (this.func_237236_a_(axisalignedbb)) {
                     pathpoint = null;
                  }
               }
   ...
   private boolean func_237236_a_(AxisAlignedBB p_237236_1_) {
      return this.field_237227_l_.computeIfAbsent(p_237236_1_, (p_237237_2_) -> {
         return !this.blockaccess.func_226665_a__(this.entity, p_237236_1_);
      });
   }
   ...
   protected PathNodeType func_215744_a(IBlockReader p_215744_1_, boolean p_215744_2_, boolean p_215744_3_, BlockPos p_215744_4_, PathNodeType p_215744_5_) {
      ...
      if (p_215744_5_ == PathNodeType.RAIL && !(p_215744_1_.getBlockState(p_215744_4_).getBlock() instanceof AbstractRailBlock) && !(p_215744_1_.getBlockState(p_215744_4_.func_177977_b()).getBlock() instanceof AbstractRailBlock)) {
   ...
   public static PathNodeType func_237231_a_(IBlockReader p_237231_0_, BlockPos.Mutable p_237231_1_) {
      ...
      if (pathnodetype == PathNodeType.WALKABLE) {
         pathnodetype = func_237232_a_(p_237231_0_, p_237231_1_.func_181079_c(i, j, k), pathnodetype);
      }
   ...
   protected static PathNodeType func_237238_b_(IBlockReader p_237238_0_, BlockPos p_237238_1_) {
      ...
      if (blockstate.isAir(p_237238_0_, p_237238_1_)) {
         ...
         } else if (blockstate.isIn(Blocks.field_226907_mc_)) {
