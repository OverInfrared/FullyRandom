...
public class SwimmerPathNavigator extends PathNavigator {
   ...
   protected Vector3d getEntityPosition() {
      return new Vector3d(this.entity.func_226277_ct_(), this.entity.func_226283_e_(0.5D), this.entity.func_226281_cx_());
   }
   ...
   public void tick() {
      ...
      if (!this.noPath()) {
         if (this.canNavigate()) {
            ...
            if (MathHelper.floor(this.entity.func_226277_ct_()) == MathHelper.floor(vector3d.x) && MathHelper.floor(this.entity.func_226278_cu_()) == MathHelper.floor(vector3d.y) && MathHelper.floor(this.entity.func_226281_cx_()) == MathHelper.floor(vector3d.z)) {
   ...
   protected void pathFollow() {
      if (this.currentPath != null) {
         ...
         if (Math.abs(this.entity.func_226277_ct_() - vector3d2.x) < (double)f1 && Math.abs(this.entity.func_226281_cx_() - vector3d2.z) < (double)f1 && Math.abs(this.entity.func_226278_cu_() - vector3d2.y) < (double)(f1 * 2.0F)) {
