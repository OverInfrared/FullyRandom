...
public class GroundPathNavigator extends PathNavigator {
   ...
   protected Vector3d getEntityPosition() {
      return new Vector3d(this.entity.func_226277_ct_(), (double)this.getPathablePosY(), this.entity.func_226281_cx_());
   }

   public Path func_179680_a(BlockPos pos, int p_179680_2_) {
      if (this.world.getBlockState(pos).isAir()) {
         BlockPos blockpos;
         for(blockpos = pos.func_177977_b(); blockpos.getY() > 0 && this.world.getBlockState(blockpos).isAir(); blockpos = blockpos.func_177977_b()) {
         }
   ...
   public Path func_75494_a(Entity entityIn, int p_75494_2_) {
      return this.func_179680_a(entityIn.func_233580_cy_(), p_75494_2_);
   }

   private int getPathablePosY() {
      if (this.entity.isInWater() && this.getCanSwim()) {
         int i = MathHelper.floor(this.entity.func_226278_cu_());
         Block block = this.world.getBlockState(new BlockPos(this.entity.func_226277_ct_(), (double)i, this.entity.func_226281_cx_())).getBlock();
         int j = 0;

         while(block == Blocks.WATER) {
            ++i;
            block = this.world.getBlockState(new BlockPos(this.entity.func_226277_ct_(), (double)i, this.entity.func_226281_cx_())).getBlock();
            ++j;
            if (j > 16) {
