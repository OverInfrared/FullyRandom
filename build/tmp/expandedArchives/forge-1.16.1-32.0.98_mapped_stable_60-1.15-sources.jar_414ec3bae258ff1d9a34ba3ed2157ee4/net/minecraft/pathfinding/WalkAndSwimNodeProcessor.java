...
public class WalkAndSwimNodeProcessor extends WalkNodeProcessor {
   ...
   private double func_203246_a(BlockPos p_203246_1_) {
      if (!this.entity.isInWater()) {
         BlockPos blockpos = p_203246_1_.func_177977_b();
      ...
      if (d0 - p_203245_5_ > 1.125D) {
         ...
         if (pathnodetype != PathNodeType.WATER && pathnodetype != PathNodeType.WALKABLE) {
            ...
            if (pathnodetype == PathNodeType.OPEN) {
               ...
               if (!this.entity.world.func_226665_a__(this.entity, axisalignedbb)) {
                  return null;
               }
   ...
   public PathNodeType getPathNodeType(IBlockReader blockaccessIn, int x, int y, int z) {
      ...
      PathNodeType pathnodetype = func_237238_b_(blockaccessIn, blockpos$mutable.func_181079_c(x, y, z));
      if (pathnodetype == PathNodeType.WATER) {
         for(Direction direction : Direction.values()) {
            PathNodeType pathnodetype2 = func_237238_b_(blockaccessIn, blockpos$mutable.func_181079_c(x, y, z).func_189536_c(direction));
         ...
         if (pathnodetype == PathNodeType.OPEN && y >= 1) {
            ...
            PathNodeType pathnodetype1 = func_237238_b_(blockaccessIn, blockpos$mutable.func_181079_c(x, y - 1, z));
         ...
         if (pathnodetype == PathNodeType.WALKABLE) {
            pathnodetype = func_237232_a_(blockaccessIn, blockpos$mutable.func_181079_c(x, y, z), pathnodetype);
         }
