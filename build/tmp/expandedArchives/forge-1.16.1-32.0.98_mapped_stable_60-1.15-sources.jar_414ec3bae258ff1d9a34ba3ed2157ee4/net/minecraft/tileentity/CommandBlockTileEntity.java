...
public class CommandBlockTileEntity extends TileEntity {
   ...
   private final CommandBlockLogic commandBlockLogic = new CommandBlockLogic() {
      ...
      public CommandSource getCommandSource() {
         return new CommandSource(this, Vector3d.func_237489_a_(CommandBlockTileEntity.this.pos), Vector2f.ZERO, this.func_195043_d(), 2, this.getName().getString(), this.getName(), this.func_195043_d().getServer(), (Entity)null);
      }
   };
