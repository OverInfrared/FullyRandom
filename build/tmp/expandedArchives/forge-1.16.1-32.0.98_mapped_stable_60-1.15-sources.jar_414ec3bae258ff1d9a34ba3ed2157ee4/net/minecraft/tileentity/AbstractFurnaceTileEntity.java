   ...
   private static void addItemBurnTime(Map<Item, Integer> map, IItemProvider itemProvider, int burnTimeIn) {
      ...
      if (func_235644_b_(item)) {
         if (SharedConstants.developmentMode) {
            throw (IllegalStateException)Util.func_229757_c_(new IllegalStateException("A developer tried to explicitly make fire resistant item " + item.getDisplayName((ItemStack)null).getString() + " a furnace fuel. That will not work!"));
         }
      } else {
