...
public abstract class CommandBlockLogic implements ICommandSource {
   ...
   public boolean trigger(World worldIn) {
      if (!worldIn.isRemote && worldIn.getGameTime() != this.lastExecution) {
         if ("Searge".equalsIgnoreCase(this.commandStored)) {
            ...
            this.successCount = 0;
            MinecraftServer minecraftserver = this.func_195043_d().getServer();
   ...
   public boolean shouldReceiveFeedback() {
      return this.func_195043_d().getGameRules().getBoolean(GameRules.SEND_COMMAND_FEEDBACK) && this.trackOutput;
   }
   ...
   public boolean allowLogging() {
      return this.func_195043_d().getGameRules().getBoolean(GameRules.COMMAND_BLOCK_OUTPUT);
   }
}