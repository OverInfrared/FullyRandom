...
public class EndGatewayTileEntity extends EndPortalTileEntity implements ITickableTileEntity {
   ...
   private void func_227015_a_(ServerWorld p_227015_1_) {
      ...
      if (this.exitPortal == null) {
         ...
         Feature.END_ISLAND.func_225566_b_(IFeatureConfig.NO_FEATURE_CONFIG).func_236265_a_(p_227015_1_, p_227015_1_.func_241112_a_(), p_227015_1_.getChunkProvider().getChunkGenerator(), new Random(this.exitPortal.toLong()), this.exitPortal);
      } else {
   ...
   private void func_227016_a_(ServerWorld p_227016_1_, BlockPos p_227016_2_) {
      Feature.END_GATEWAY.func_225566_b_(EndGatewayConfig.func_214702_a(this.getPos(), false)).func_236265_a_(p_227016_1_, p_227016_1_.func_241112_a_(), p_227016_1_.getChunkProvider().getChunkGenerator(), new Random(), p_227016_2_);
   }
