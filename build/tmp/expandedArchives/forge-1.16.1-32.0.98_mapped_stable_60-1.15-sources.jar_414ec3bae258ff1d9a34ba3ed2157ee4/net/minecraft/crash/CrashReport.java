...
public class CrashReport {
   ...
   private void populateEnvironment() {
      this.systemDetailsCategory.func_189529_a("Minecraft Version", () -> {
         return SharedConstants.getVersion().getName();
      });
      this.systemDetailsCategory.func_189529_a("Minecraft Version ID", () -> {
         return SharedConstants.getVersion().getId();
      });
      this.systemDetailsCategory.func_189529_a("Operating System", () -> {
         return System.getProperty("os.name") + " (" + System.getProperty("os.arch") + ") version " + System.getProperty("os.version");
      });
      this.systemDetailsCategory.func_189529_a("Java Version", () -> {
         return System.getProperty("java.version") + ", " + System.getProperty("java.vendor");
      });
      this.systemDetailsCategory.func_189529_a("Java VM Version", () -> {
         return System.getProperty("java.vm.name") + " (" + System.getProperty("java.vm.info") + "), " + System.getProperty("java.vm.vendor");
      });
      this.systemDetailsCategory.func_189529_a("Memory", () -> {
      ...
      this.systemDetailsCategory.func_71507_a("CPUs", Runtime.getRuntime().availableProcessors());
      this.systemDetailsCategory.func_189529_a("JVM Flags", () -> {
