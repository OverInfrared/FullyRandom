...
public class StrafePlayerPhase extends Phase {
   ...
   public void serverTick() {
      if (this.attackTarget == null) {
         ...
         double d12 = this.targetLocation == null ? 0.0D : this.targetLocation.squareDistanceTo(this.dragon.func_226277_ct_(), this.dragon.func_226278_cu_(), this.dragon.func_226281_cx_());
         ...
         if (this.attackTarget.getDistanceSq(this.dragon) < 4096.0D) {
            if (this.dragon.canEntityBeSeen(this.attackTarget)) {
               ++this.fireballCharge;
               Vector3d vector3d1 = (new Vector3d(this.attackTarget.func_226277_ct_() - this.dragon.func_226277_ct_(), 0.0D, this.attackTarget.func_226281_cx_() - this.dragon.func_226281_cx_())).normalize();
               ...
               if (this.fireballCharge >= 5 && f >= 0.0F && f < 10.0F) {
                  ...
                  double d6 = this.dragon.dragonPartHead.func_226277_ct_() - vector3d2.x * 1.0D;
                  double d7 = this.dragon.dragonPartHead.func_226283_e_(0.5D) + 0.5D;
                  double d8 = this.dragon.dragonPartHead.func_226281_cx_() - vector3d2.z * 1.0D;
   ...
   public void setTarget(LivingEntity p_188686_1_) {
      ...
      int i = this.dragon.initPathPoints();
      int j = this.dragon.getNearestPpIdx(this.attackTarget.func_226277_ct_(), this.attackTarget.func_226278_cu_(), this.attackTarget.func_226281_cx_());
      int k = MathHelper.floor(this.attackTarget.func_226277_ct_());
      int l = MathHelper.floor(this.attackTarget.func_226281_cx_());
      ...
      int i1 = MathHelper.floor(this.attackTarget.func_226278_cu_() + d3);
