   ...
   public void livingTick() {
      ...
      if (!this.world.isRemote && this.getWatchedTargetId(0) > 0) {
         ...
         if (entity != null) {
            ...
            Vector3d vector3d1 = new Vector3d(entity.func_226277_ct_() - this.func_226277_ct_(), 0.0D, entity.func_226281_cx_() - this.func_226281_cx_());
      ...
      if (this.getInvulTime() > 0) {
         for(int i1 = 0; i1 < 3; ++i1) {
            this.world.addParticle(ParticleTypes.ENTITY_EFFECT, this.func_226277_ct_() + this.rand.nextGaussian(), this.func_226278_cu_() + (double)(this.rand.nextFloat() * 3.3F), this.func_226281_cx_() + this.rand.nextGaussian(), (double)0.7F, (double)0.7F, (double)0.9F);
         }
      }
      ...
      if (this.getInvulTime() > 0) {
         ...
         if (this.blockBreakCounter > 0) {
            ...
            if (this.blockBreakCounter == 0 && net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.world, this)) {
               int i1 = MathHelper.floor(this.func_226278_cu_());
               int l1 = MathHelper.floor(this.func_226277_ct_());
               int i2 = MathHelper.floor(this.func_226281_cx_());
               boolean flag = false;
