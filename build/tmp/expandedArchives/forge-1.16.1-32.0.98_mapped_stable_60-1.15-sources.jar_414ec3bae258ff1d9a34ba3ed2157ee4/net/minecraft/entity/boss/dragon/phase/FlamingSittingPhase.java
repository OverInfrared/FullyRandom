...
public class FlamingSittingPhase extends SittingPhase {
   ...
   public void clientTick() {
      ...
      if (this.flameTicks % 2 == 0 && this.flameTicks < 10) {
         ...
         double d0 = this.dragon.dragonPartHead.func_226277_ct_();
         double d1 = this.dragon.dragonPartHead.func_226283_e_(0.5D);
         double d2 = this.dragon.dragonPartHead.func_226281_cx_();
   ...
   public void serverTick() {
      ...
      if (this.flameTicks >= 200) {
         ...
         Vector3d vector3d = (new Vector3d(this.dragon.dragonPartHead.func_226277_ct_() - this.dragon.func_226277_ct_(), 0.0D, this.dragon.dragonPartHead.func_226281_cx_() - this.dragon.func_226281_cx_())).normalize();
         float f = 5.0F;
         double d0 = this.dragon.dragonPartHead.func_226277_ct_() + vector3d.x * 5.0D / 2.0D;
         double d1 = this.dragon.dragonPartHead.func_226281_cx_() + vector3d.z * 5.0D / 2.0D;
         double d2 = this.dragon.dragonPartHead.func_226283_e_(0.5D);
         double d3 = d2;
         ...
         while(this.dragon.world.isAirBlock(blockpos$mutable)) {
            ...
            blockpos$mutable.func_189532_c(d0, d3, d1);
         }
