...
public class EnderDragonEntity extends MobEntity implements IMob {
   ...
   public void livingTick() {
      ...
      if (this.func_233643_dh_()) {
         ...
         this.world.addParticle(ParticleTypes.EXPLOSION, this.func_226277_ct_() + (double)f11, this.func_226278_cu_() + 2.0D + (double)f13, this.func_226281_cx_() + (double)f14, 0.0D, 0.0D, 0.0D);
      } else {
         ...
         if (this.isAIDisabled()) {
            ...
            if (this.world.isRemote) {
               if (this.newPosRotationIncrements > 0) {
                  ...
                  double d0 = this.func_226278_cu_() + (this.interpTargetY - this.func_226278_cu_()) / (double)this.newPosRotationIncrements;
                  double d1 = this.func_226281_cx_() + (this.interpTargetZ - this.func_226281_cx_()) / (double)this.newPosRotationIncrements;
               ...
               if (vector3d != null) {
                  double d8 = vector3d.x - this.func_226277_ct_();
                  double d9 = vector3d.y - this.func_226278_cu_();
                  double d10 = vector3d.z - this.func_226281_cx_();
                  ...
                  Vector3d vector3d1 = vector3d.subtract(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_()).normalize();
