...
public class LandingApproachPhase extends Phase {
   ...
   public void serverTick() {
      double d0 = this.targetLocation == null ? 0.0D : this.targetLocation.squareDistanceTo(this.dragon.func_226277_ct_(), this.dragon.func_226278_cu_(), this.dragon.func_226281_cx_());
   ...
   private void findNewTarget() {
      if (this.currentPath == null || this.currentPath.isFinished()) {
         ...
         if (playerentity != null) {
            Vector3d vector3d = (new Vector3d(playerentity.func_226277_ct_(), 0.0D, playerentity.func_226281_cx_())).normalize();
