   ...
   public void serverTick() {
      ...
      if (livingentity != null) {
         if (this.scanningTime > 25) {
            ...
            Vector3d vector3d = (new Vector3d(livingentity.func_226277_ct_() - this.dragon.func_226277_ct_(), 0.0D, livingentity.func_226281_cx_() - this.dragon.func_226281_cx_())).normalize();
            ...
            if (f1 < 0.0F || f1 > 10.0F) {
               double d0 = livingentity.func_226277_ct_() - this.dragon.dragonPartHead.func_226277_ct_();
               double d1 = livingentity.func_226281_cx_() - this.dragon.dragonPartHead.func_226281_cx_();
         ...
         if (livingentity != null) {
            ...
            this.dragon.getPhaseManager().getPhase(PhaseType.CHARGING_PLAYER).setTarget(new Vector3d(livingentity.func_226277_ct_(), livingentity.func_226278_cu_(), livingentity.func_226281_cx_()));
         }
      }
