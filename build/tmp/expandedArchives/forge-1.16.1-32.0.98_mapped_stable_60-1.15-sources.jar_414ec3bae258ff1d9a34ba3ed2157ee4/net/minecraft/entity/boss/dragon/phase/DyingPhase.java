...
public class DyingPhase extends Phase {
   ...
   public void clientTick() {
      if (this.time++ % 10 == 0) {
         ...
         this.dragon.world.addParticle(ParticleTypes.EXPLOSION_EMITTER, this.dragon.func_226277_ct_() + (double)f, this.dragon.func_226278_cu_() + 2.0D + (double)f1, this.dragon.func_226281_cx_() + (double)f2, 0.0D, 0.0D, 0.0D);
      }
   ...
   public void serverTick() {
      ...
      double d0 = this.targetLocation.squareDistanceTo(this.dragon.func_226277_ct_(), this.dragon.func_226278_cu_(), this.dragon.func_226281_cx_());
