...
public class IronGolemEntity extends GolemEntity implements IAngerable {
   ...
   public boolean isNotColliding(IWorldReader worldIn) {
      ...
      if (!blockstate.func_235719_a_(worldIn, blockpos1, this)) {
         ...
         return WorldEntitySpawner.func_234968_a_(worldIn, blockpos, worldIn.getBlockState(blockpos), Fluids.EMPTY.getDefaultState(), EntityType.IRON_GOLEM) && worldIn.func_226668_i_(this);
      }
   }
