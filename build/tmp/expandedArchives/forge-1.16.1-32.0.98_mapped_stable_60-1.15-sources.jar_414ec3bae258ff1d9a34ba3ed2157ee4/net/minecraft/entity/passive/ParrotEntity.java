...
public class ParrotEntity extends ShoulderRidingEntity implements IFlyingAnimal {
      ...
      if (parrotIn.isAlive() && !parrotIn.isSilent() && worldIn.rand.nextInt(2) == 0) {
         ...
         if (!list.isEmpty()) {
            ...
            if (!mobentity.isSilent()) {
               ...
               worldIn.playSound((PlayerEntity)null, parrotIn.func_226277_ct_(), parrotIn.func_226278_cu_(), parrotIn.func_226281_cx_(), soundevent, parrotIn.getSoundCategory(), 0.7F, getPitch(worldIn.rand));
               return true;
            }
         }
   ...
   public static boolean func_223317_c(EntityType<ParrotEntity> p_223317_0_, IWorld p_223317_1_, SpawnReason reason, BlockPos p_223317_3_, Random p_223317_4_) {
      BlockState blockstate = p_223317_1_.getBlockState(p_223317_3_.func_177977_b());
      return (blockstate.func_235714_a_(BlockTags.LEAVES) || blockstate.isIn(Blocks.GRASS_BLOCK) || blockstate.func_235714_a_(BlockTags.LOGS) || blockstate.isIn(Blocks.AIR)) && p_223317_1_.func_226659_b_(p_223317_3_, 0) > 8;
   }
