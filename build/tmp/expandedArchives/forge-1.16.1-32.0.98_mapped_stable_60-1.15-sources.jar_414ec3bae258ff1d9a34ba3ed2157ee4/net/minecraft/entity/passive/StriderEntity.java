...
public class StriderEntity extends AnimalEntity implements IRideable, IEquipable {
   ...
   public Vector3d func_230268_c_(LivingEntity p_230268_1_) {
      ...
      for(Vector3d vector3d : avector3d) {
         blockpos$mutable.func_189532_c(this.func_226277_ct_() + vector3d.x, d0, this.func_226281_cx_() + vector3d.z);
      ...
      if (!flag && this.isHorseSaddled() && !this.isBeingRidden()) {
         ...
         if (!actionresulttype.func_226246_a_()) {
            ...
            if (flag && !this.isSilent()) {
               this.world.playSound((PlayerEntity)null, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), SoundEvents.field_232840_oa_, this.getSoundCategory(), 1.0F, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F);
            }
   ...
   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      ...
      if (mobentity != null) {
         mobentity.setLocationAndAngles(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), this.rotationYaw, 0.0F);
