...
public class OcelotEntity extends AnimalEntity {
   ...
   public ActionResultType func_230254_b_(PlayerEntity p_230254_1_, Hand p_230254_2_) {
      ...
      if ((this.field_70914_e == null || this.field_70914_e.isRunning()) && !this.isTrusting() && this.isBreedingItem(itemstack) && p_230254_1_.getDistanceSq(this) < 9.0D) {
   ...
   public boolean isNotColliding(IWorldReader worldIn) {
      if (worldIn.func_226668_i_(this) && !worldIn.containsAnyLiquid(this.getBoundingBox())) {
         ...
         BlockState blockstate = worldIn.getBlockState(blockpos.func_177977_b());
