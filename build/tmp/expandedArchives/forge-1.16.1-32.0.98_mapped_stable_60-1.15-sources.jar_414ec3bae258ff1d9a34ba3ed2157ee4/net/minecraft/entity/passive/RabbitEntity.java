...
public class RabbitEntity extends AnimalEntity {
   ...
   protected float getJumpUpwardsMotion() {
      if (!this.collidedHorizontally && (!this.moveController.isUpdating() || !(this.moveController.getY() > this.func_226278_cu_() + 0.5D))) {
         ...
         if (path != null && path.getCurrentPathIndex() < path.getCurrentPathLength()) {
            ...
            if (vector3d.y > this.func_226278_cu_() + 0.5D) {
               return 0.5F;
            }
         }
   ...
   private void calculateRotationYaw(double x, double z) {
      this.rotationYaw = (float)(MathHelper.atan2(z - this.func_226281_cx_(), x - this.func_226277_ct_()) * (double)(180F / (float)Math.PI)) - 90.0F;
   }
   ...
   public static boolean func_223321_c(EntityType<RabbitEntity> p_223321_0_, IWorld p_223321_1_, SpawnReason reason, BlockPos p_223321_3_, Random p_223321_4_) {
      BlockState blockstate = p_223321_1_.getBlockState(p_223321_3_.func_177977_b());
      return (blockstate.isIn(Blocks.GRASS_BLOCK) || blockstate.isIn(Blocks.SNOW) || blockstate.isIn(Blocks.SAND)) && p_223321_1_.func_226659_b_(p_223321_3_, 0) > 8;
   }
