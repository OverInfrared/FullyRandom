...
public abstract class AnimalEntity extends AgeableEntity {
   ...
   public float getBlockPathWeight(BlockPos pos, IWorldReader worldIn) {
      return worldIn.getBlockState(pos.func_177977_b()).isIn(Blocks.GRASS_BLOCK) ? 10.0F : worldIn.getBrightness(pos) - 0.5F;
   }
   ...
   public static boolean func_223316_b(EntityType<? extends AnimalEntity> p_223316_0_, IWorld p_223316_1_, SpawnReason reason, BlockPos p_223316_3_, Random p_223316_4_) {
      return p_223316_1_.getBlockState(p_223316_3_.func_177977_b()).isIn(Blocks.GRASS_BLOCK) && p_223316_1_.func_226659_b_(p_223316_3_, 0) > 8;
   }
   ...
   public void func_234177_a_(World p_234177_1_, AnimalEntity p_234177_2_) {
      ...
      if (ageableentity != null) {
         ...
         ageableentity.setLocationAndAngles(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), 0.0F, 0.0F);
         ...
         if (p_234177_1_.getGameRules().getBoolean(GameRules.DO_MOB_LOOT)) {
            p_234177_1_.addEntity(new ExperienceOrbEntity(p_234177_1_, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), this.getRNG().nextInt(7) + 1));
         }
