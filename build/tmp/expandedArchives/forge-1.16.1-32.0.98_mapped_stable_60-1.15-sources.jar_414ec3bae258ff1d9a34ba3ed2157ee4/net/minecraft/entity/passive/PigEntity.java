...
public class PigEntity extends AnimalEntity implements IRideable, IEquipable {
   ...
   public Vector3d func_230268_c_(LivingEntity p_230268_1_) {
      ...
      if (direction.getAxis() == Direction.Axis.Y) {
         ...
         for(Pose pose : p_230268_1_.func_230297_ef_()) {
            ...
            for(int[] aint1 : aint) {
               blockpos$mutable.func_181079_c(blockpos.getX() + aint1[0], blockpos.getY(), blockpos.getZ() + aint1[1]);
   ...
   public void onStruckByLightning(LightningBoltEntity lightningBolt) {
      if (this.world.getDifficulty() != Difficulty.PEACEFUL) {
         ...
         zombifiedpiglinentity.setLocationAndAngles(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), this.rotationYaw, this.rotationPitch);
