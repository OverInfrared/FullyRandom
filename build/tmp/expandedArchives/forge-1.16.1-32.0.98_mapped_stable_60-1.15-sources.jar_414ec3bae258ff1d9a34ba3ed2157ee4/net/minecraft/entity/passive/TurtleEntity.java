...
public class TurtleEntity extends AnimalEntity {
   ...
   public static boolean func_223322_c(EntityType<TurtleEntity> p_223322_0_, IWorld p_223322_1_, SpawnReason reason, BlockPos p_223322_3_, Random p_223322_4_) {
      return p_223322_3_.getY() < p_223322_1_.getSeaLevel() + 4 && TurtleEggBlock.hasProperHabitat(p_223322_1_, p_223322_3_) && p_223322_1_.func_226659_b_(p_223322_3_, 0) > 8;
   }
   ...
   static class MateGoal extends BreedGoal {
      ...
      protected void spawnBaby() {
         ...
         if (this.world.getGameRules().getBoolean(GameRules.DO_MOB_LOOT)) {
            this.world.addEntity(new ExperienceOrbEntity(this.world, this.animal.func_226277_ct_(), this.animal.func_226278_cu_(), this.animal.func_226281_cx_(), random.nextInt(7) + 1));
         }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         if (this.action == MovementController.Action.MOVE_TO && !this.turtle.getNavigator().noPath()) {
            double d0 = this.posX - this.turtle.func_226277_ct_();
            double d1 = this.posY - this.turtle.func_226278_cu_();
            double d2 = this.posZ - this.turtle.func_226281_cx_();
   ...
   static class TravelGoal extends Goal {
      ...
      public void startExecuting() {
         ...
         if ((double)l + this.turtle.func_226278_cu_() > (double)(this.turtle.world.getSeaLevel() - 1)) {
            l = 0;
         }
      ...
      public void tick() {
         if (this.turtle.getNavigator().noPath()) {
            ...
            this.turtle.getNavigator().tryMoveToXYZ(vector3d1.x, vector3d1.y, vector3d1.z, this.field_203138_b);
         }
