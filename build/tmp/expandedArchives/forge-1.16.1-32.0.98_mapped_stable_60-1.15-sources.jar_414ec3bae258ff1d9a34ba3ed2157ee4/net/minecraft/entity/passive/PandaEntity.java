...
public class PandaEntity extends AnimalEntity {
   ...
   public void setMainGene(PandaEntity.Gene p_213589_1_) {
      if (p_213589_1_.getIndex() > 6) {
         p_213589_1_ = PandaEntity.Gene.getRandomType(this.rand);
      }
   ...
   public void setHiddenGene(PandaEntity.Gene p_213541_1_) {
      if (p_213541_1_.getIndex() > 6) {
         p_213541_1_ = PandaEntity.Gene.getRandomType(this.rand);
      }
   ...
   private void func_213533_eu() {
      if (this.func_213559_es() % 5 == 0) {
         ...
         for(int i = 0; i < 6; ++i) {
            ...
            vector3d1 = vector3d1.add(this.func_226277_ct_(), this.func_226280_cw_() + 1.0D, this.func_226281_cx_());
      ...
      if (this.field_213608_bz > 32) {
         ...
         if (!this.world.isRemote) {
            ...
            if (this.field_213608_bz == 1) {
               ...
               this.field_213600_bJ = new Vector3d(vector3d.x + (double)(-MathHelper.sin(f) * f1), 0.0D, vector3d.z + (double)(MathHelper.cos(f) * f1));
               ...
               this.setMotion(this.field_213600_bJ.x, vector3d.y, this.field_213600_bJ.z);
            } else {
   ...
   private void func_213577_ez() {
      Vector3d vector3d = this.getMotion();
      this.world.addParticle(ParticleTypes.SNEEZE, this.func_226277_ct_() - (double)(this.getWidth() + 1.0F) * 0.5D * (double)MathHelper.sin(this.renderYawOffset * ((float)Math.PI / 180F)), this.func_226280_cw_() - (double)0.1F, this.func_226281_cx_() + (double)(this.getWidth() + 1.0F) * 0.5D * (double)MathHelper.cos(this.renderYawOffset * ((float)Math.PI / 180F)), vector3d.x, 0.0D, vector3d.z);
   ...
   private PandaEntity.Gene func_213568_eA() {
