...
public class BatEntity extends AmbientEntity {
   ...
   protected void updateAITasks() {
      ...
      if (this.getIsBatHanging()) {
         ...
         double d2 = (double)this.spawnPosition.getX() + 0.5D - this.func_226277_ct_();
         double d0 = (double)this.spawnPosition.getY() + 0.1D - this.func_226278_cu_();
         double d1 = (double)this.spawnPosition.getZ() + 0.5D - this.func_226281_cx_();
