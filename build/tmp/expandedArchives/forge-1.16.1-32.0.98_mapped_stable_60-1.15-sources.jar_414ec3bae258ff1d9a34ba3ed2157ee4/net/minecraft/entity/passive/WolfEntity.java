...
public class WolfEntity extends TameableEntity implements IAngerable {
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(5, new NonTamedTargetGoal<>(this, AnimalEntity.class, false, field_213441_bD));
         ...
         if (this.isInWaterRainOrBubbleColumn()) {
            ...
            if (this.timeWolfIsShaking > 0.4F) {
               ...
               for(int j = 0; j < i; ++j) {
                  ...
                  this.world.addParticle(ParticleTypes.SPLASH, this.func_226277_ct_() + (double)f1, (double)(f + 0.8F), this.func_226281_cx_() + (double)f2, vector3d.x, vector3d.y, vector3d.z);
               }
            }
         }
      ...
      if (this.world.isRemote) {
         ...
         if (this.isTamed()) {
            ...
            if (!(item instanceof DyeItem)) {
               ...
               if ((!actionresulttype.func_226246_a_() || this.isChild()) && this.isOwner(p_230254_1_)) {
