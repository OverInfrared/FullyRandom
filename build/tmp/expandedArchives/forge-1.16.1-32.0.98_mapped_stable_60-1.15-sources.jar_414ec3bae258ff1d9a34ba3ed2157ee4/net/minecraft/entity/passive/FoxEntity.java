...
public class FoxEntity extends AnimalEntity {
   ...
   private static final Predicate<Entity> SHOULD_AVOID = (p_213463_0_) -> {
      return !p_213463_0_.func_226273_bm_() && EntityPredicates.CAN_AI_TARGET.test(p_213463_0_);
   };
      ...
      if (id == 45) {
         ...
         if (!itemstack.isEmpty()) {
            for(int i = 0; i < 8; ++i) {
               ...
               this.world.addParticle(new ItemParticleData(ParticleTypes.ITEM, itemstack), this.func_226277_ct_() + this.getLookVec().x / 2.0D, this.func_226278_cu_(), this.func_226281_cx_() + this.getLookVec().z / 2.0D, vector3d.x, vector3d.y + 0.05D, vector3d.z);
            }
         }
      } else {
   ...
   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      Biome biome = worldIn.func_226691_t_(this.func_233580_cy_());
   ...
   private void spitOutItem(ItemStack stackIn) {
      if (!stackIn.isEmpty() && !this.world.isRemote) {
         ItemEntity itementity = new ItemEntity(this.world, this.func_226277_ct_() + this.getLookVec().x, this.func_226278_cu_() + 1.0D, this.func_226281_cx_() + this.getLookVec().z, stackIn);
   ...
   private void spawnItem(ItemStack stackIn) {
      ItemEntity itementity = new ItemEntity(this.world, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), stackIn);
      this.world.addEntity(itementity);
   }
   ...
   abstract class BaseGoal extends Goal {
      ...
      protected boolean func_220813_g() {
         BlockPos blockpos = new BlockPos(FoxEntity.this.func_226277_ct_(), FoxEntity.this.getBoundingBox().maxY, FoxEntity.this.func_226281_cx_());
   ...
   class MateGoal extends BreedGoal {
      ...
      protected void spawnBaby() {
         FoxEntity foxentity = (FoxEntity)this.animal.createChild(this.field_75391_e);
          final net.minecraftforge.event.entity.living.BabyEntitySpawnEvent event = new net.minecraftforge.event.entity.living.BabyEntitySpawnEvent(animal, field_75391_e, foxentity);
   ...
   public class PounceGoal extends net.minecraft.entity.ai.goal.JumpGoal {
         ...
         if (!FoxEntity.this.func_213490_ee()) {
            ...
            if (livingentity != null && livingentity.isAlive()) {
               if (livingentity.getAdjustedHorizontalFacing() != livingentity.getHorizontalFacing()) {
                  ...
                  if (!flag) {
                     FoxEntity.this.getNavigator().func_75494_a(livingentity, 0);
                     FoxEntity.this.setCrouching(false);
                     FoxEntity.this.func_213502_u(false);
                  }
      ...
      public void startExecuting() {
         ...
         Vector3d vector3d = (new Vector3d(livingentity.func_226277_ct_() - FoxEntity.this.func_226277_ct_(), livingentity.func_226278_cu_() - FoxEntity.this.func_226278_cu_(), livingentity.func_226281_cx_() - FoxEntity.this.func_226281_cx_())).normalize();
