...
public class SquidEntity extends WaterMobEntity {
   ...
   private void squirtInk() {
      ...
      Vector3d vector3d = this.func_207400_b(new Vector3d(0.0D, -1.0D, 0.0D)).add(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_());
   ...
   class FleeGoal extends Goal {
      ...
      public void tick() {
         ...
         if (livingentity != null) {
            ...
            BlockState blockstate = SquidEntity.this.world.getBlockState(new BlockPos(SquidEntity.this.func_226277_ct_() + vector3d.x, SquidEntity.this.func_226278_cu_() + vector3d.y, SquidEntity.this.func_226281_cx_() + vector3d.z));
            FluidState fluidstate = SquidEntity.this.world.getFluidState(new BlockPos(SquidEntity.this.func_226277_ct_() + vector3d.x, SquidEntity.this.func_226278_cu_() + vector3d.y, SquidEntity.this.func_226281_cx_() + vector3d.z));
