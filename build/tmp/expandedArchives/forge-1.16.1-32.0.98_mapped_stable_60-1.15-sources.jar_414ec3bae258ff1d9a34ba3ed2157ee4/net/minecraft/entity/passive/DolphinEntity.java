...
public class DolphinEntity extends WaterMobEntity {
   ...
   public void tick() {
      ...
      if (this.isAIDisabled()) {
         ...
         if (this.world.isRemote && this.isInWater() && this.getMotion().lengthSquared() > 0.03D) {
            ...
            for(int i = 0; i < 2; ++i) {
               this.world.addParticle(ParticleTypes.DOLPHIN, this.func_226277_ct_() - vector3d.x * (double)f2 + (double)f, this.func_226278_cu_() - vector3d.y, this.func_226281_cx_() - vector3d.z * (double)f2 + (double)f1, 0.0D, 0.0D, 0.0D);
               this.world.addParticle(ParticleTypes.DOLPHIN, this.func_226277_ct_() - vector3d.x * (double)f2 - (double)f, this.func_226278_cu_() - vector3d.y, this.func_226281_cx_() - vector3d.z * (double)f2 - (double)f1, 0.0D, 0.0D, 0.0D);
            }
         }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         if (this.action == MovementController.Action.MOVE_TO && !this.dolphin.getNavigator().noPath()) {
            double d0 = this.posX - this.dolphin.func_226277_ct_();
            double d1 = this.posY - this.dolphin.func_226278_cu_();
            double d2 = this.posZ - this.dolphin.func_226281_cx_();
   ...
   class PlayWithItemsGoal extends Goal {
      ...
      private void func_220810_a(ItemStack p_220810_1_) {
         if (!p_220810_1_.isEmpty()) {
            ...
            ItemEntity itementity = new ItemEntity(DolphinEntity.this.world, DolphinEntity.this.func_226277_ct_(), d0, DolphinEntity.this.func_226281_cx_(), p_220810_1_);
   ...
   static class SwimToTreasureGoal extends Goal {
      ...
      public boolean shouldContinueExecuting() {
         ...
         return !(new BlockPos((double)blockpos.getX(), this.dolphin.func_226278_cu_(), (double)blockpos.getZ())).withinDistance(this.dolphin.getPositionVec(), 4.0D) && !this.field_208058_b && this.dolphin.getAir() >= 100;
      }
      ...
      public void resetTask() {
         BlockPos blockpos = this.dolphin.getTreasurePos();
         if ((new BlockPos((double)blockpos.getX(), this.dolphin.func_226278_cu_(), (double)blockpos.getZ())).withinDistance(this.dolphin.getPositionVec(), 4.0D) || this.field_208058_b) {
