...
public class BeeEntity extends AnimalEntity implements IAngerable, IFlyingAnimal {
   ...
   private void func_226433_h_(BlockPos p_226433_1_) {
      Vector3d vector3d = Vector3d.func_237492_c_(p_226433_1_);
      int i = 0;
   ...
   private boolean func_226415_eI_() {
      if (this.field_226364_bD_ <= 0 && !this.field_226370_bJ_.func_226503_k_() && !this.func_226412_eE_() && this.getAttackTarget() == null) {
   ...
   public void func_230260_a__(int p_230260_1_) {
      this.dataManager.set(field_226375_bx_, p_230260_1_);
   }
   ...
   public void func_230259_a_(@Nullable UUID p_230259_1_) {
      this.field_226376_by_ = p_230259_1_;
   }
   ...
   public void livingTick() {
      ...
      if (!this.world.isRemote) {
         ...
         boolean flag = this.func_233678_J__() && !this.func_226412_eE_() && this.getAttackTarget() != null && this.getAttackTarget().getDistanceSq(this) < 4.0D;
   ...
   private boolean func_226437_j_(BlockPos p_226437_1_) {
      return !this.func_226401_b_(p_226437_1_, 32);
   }
   ...
   private boolean func_226401_b_(BlockPos p_226401_1_, int p_226401_2_) {
      return p_226401_1_.withinDistance(this.func_233580_cy_(), (double)p_226401_2_);
   }
   ...
   static class AttackPlayerGoal extends NearestAttackableTargetGoal<PlayerEntity> {
      AttackPlayerGoal(BeeEntity p_i225719_1_) {
         super(p_i225719_1_, PlayerEntity.class, 10, true, false, p_i225719_1_::func_233680_b_);
      }
   ...
   public class FindBeehiveGoal extends BeeEntity.PassiveGoal {
      ...
      public boolean func_225506_g_() {
         return BeeEntity.this.field_226369_bI_ != null && !BeeEntity.this.detachHome() && BeeEntity.this.func_226415_eI_() && !this.func_226476_d_(BeeEntity.this.field_226369_bI_) && BeeEntity.this.world.getBlockState(BeeEntity.this.field_226369_bI_).func_235714_a_(BlockTags.field_226151_aa_);
      }
   ...
   class PollinateGoal extends BeeEntity.PassiveGoal {
      ...
      public void tick() {
         ...
         if (this.field_226497_h_ > 600) {
            ...
            Vector3d vector3d = Vector3d.func_237492_c_(BeeEntity.this.field_226368_bH_).add(0.0D, (double)0.6F, 0.0D);
            if (vector3d.distanceTo(BeeEntity.this.getPositionVec()) > 1.0D) {
               ...
               if (!flag && this.field_226497_h_ > 600) {
                  ...
                  if (flag) {
                     ...
                     if (flag2) {
                        this.field_226496_g_ = new Vector3d(vector3d.getX() + (double)this.func_226506_n_(), vector3d.getY(), vector3d.getZ() + (double)this.func_226506_n_());
                        BeeEntity.this.navigator.clearPath();
                     } else {
                        flag1 = false;
                     }
   ...
   class StingGoal extends MeleeAttackGoal {
      ...
      public boolean shouldExecute() {
         return super.shouldExecute() && BeeEntity.this.func_233678_J__() && !BeeEntity.this.func_226412_eE_();
      }

      public boolean shouldContinueExecuting() {
         return super.shouldContinueExecuting() && BeeEntity.this.func_233678_J__() && !BeeEntity.this.func_226412_eE_();
      }
   }
   ...
   class WanderGoal extends Goal {
      ...
      public void startExecuting() {
         ...
         if (vector3d != null) {
            BeeEntity.this.navigator.setPath(BeeEntity.this.navigator.func_179680_a(new BlockPos(vector3d), 1), 1.0D);
         }
      ...
      private Vector3d func_226509_g_() {
         ...
         if (BeeEntity.this.func_226422_eP_() && !BeeEntity.this.func_226401_b_(BeeEntity.this.field_226369_bI_, 22)) {
            Vector3d vector3d1 = Vector3d.func_237489_a_(BeeEntity.this.field_226369_bI_);
         ...
         int i = 8;
         Vector3d vector3d2 = RandomPositionGenerator.func_226340_a_(BeeEntity.this, 8, 7, vector3d, ((float)Math.PI / 2F), 2, 1);
         return vector3d2 != null ? vector3d2 : RandomPositionGenerator.func_226338_a_(BeeEntity.this, 8, 4, -2, vector3d, (double)((float)Math.PI / 2F));
      }
   }
}