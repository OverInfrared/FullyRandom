...
public class MooshroomEntity extends CowEntity implements IShearable, net.minecraftforge.common.IForgeShearable {
   ...
   public float getBlockPathWeight(BlockPos pos, IWorldReader worldIn) {
      return worldIn.getBlockState(pos.func_177977_b()).isIn(Blocks.MYCELIUM) ? 10.0F : worldIn.getBrightness(pos) - 0.5F;
   }
   ...
   public static boolean func_223318_c(EntityType<MooshroomEntity> p_223318_0_, IWorld p_223318_1_, SpawnReason p_223318_2_, BlockPos p_223318_3_, Random p_223318_4_) {
      return p_223318_1_.getBlockState(p_223318_3_.func_177977_b()).isIn(Blocks.MYCELIUM) && p_223318_1_.func_226659_b_(p_223318_3_, 0) > 8;
   }
   ...
   public ActionResultType func_230254_b_(PlayerEntity p_230254_1_, Hand p_230254_2_) {
      ...
      if (itemstack.getItem() == Items.BOWL && !this.isChild()) {
         ...
         if (this.hasStewEffect != null) {
            for(int i = 0; i < 2; ++i) {
               this.world.addParticle(ParticleTypes.SMOKE, this.func_226277_ct_() + this.rand.nextDouble() / 2.0D, this.func_226283_e_(0.5D), this.func_226281_cx_() + this.rand.nextDouble() / 2.0D, 0.0D, this.rand.nextDouble() / 5.0D, 0.0D);
            }
         } else {
            ...
            for(int j = 0; j < 4; ++j) {
               this.world.addParticle(ParticleTypes.EFFECT, this.func_226277_ct_() + this.rand.nextDouble() / 2.0D, this.func_226283_e_(0.5D), this.func_226281_cx_() + this.rand.nextDouble() / 2.0D, 0.0D, this.rand.nextDouble() / 5.0D, 0.0D);
            }
   ...
   public void func_230263_a_(SoundCategory p_230263_1_) {
      ...
      if (!this.world.isRemote()) {
         ((ServerWorld)this.world).spawnParticle(ParticleTypes.EXPLOSION, this.func_226277_ct_(), this.func_226283_e_(0.5D), this.func_226281_cx_(), 1, 0.0D, 0.0D, 0.0D, 0.0D);
         this.remove();
         ...
         for(int i = 0; i < 5; ++i) {
            this.world.addEntity(new ItemEntity(this.world, this.func_226277_ct_(), this.func_226283_e_(1.0D), this.func_226281_cx_(), new ItemStack(this.getMooshroomType().renderState.getBlock())));
         }
      }
