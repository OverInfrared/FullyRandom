...
public class LlamaEntity extends AbstractChestedHorseEntity implements IRangedAttackMob {
   ...
   public void updatePassenger(Entity passenger) {
      if (this.isPassenger(passenger)) {
         ...
         float f2 = 0.3F;
         passenger.setPosition(this.func_226277_ct_() + (double)(0.3F * f1), this.func_226278_cu_() + this.getMountedYOffset() + passenger.getYOffset(), this.func_226281_cx_() - (double)(0.3F * f));
      }
   }
   ...
   protected boolean handleEating(PlayerEntity player, ItemStack stack) {
      ...
      if (flag && !this.isSilent()) {
         ...
         if (soundevent != null) {
            this.world.playSound((PlayerEntity)null, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), this.func_230274_fe_(), this.getSoundCategory(), 1.0F, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F);
         }
      }
   ...
   private void spit(LivingEntity target) {
      ...
      double d1 = target.func_226283_e_(0.3333333333333333D) - llamaspitentity.func_226278_cu_();
