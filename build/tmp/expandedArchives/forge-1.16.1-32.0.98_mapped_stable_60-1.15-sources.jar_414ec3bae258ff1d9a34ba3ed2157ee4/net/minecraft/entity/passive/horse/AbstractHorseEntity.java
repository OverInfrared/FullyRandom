...
public abstract class AbstractHorseEntity extends AnimalEntity implements IInventoryChangedListener, IJumpingMount, IEquipable {
   ...
   private void eatingHorse() {
      ...
      if (!this.isSilent()) {
         ...
         if (soundevent != null) {
            this.world.playSound((PlayerEntity)null, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), soundevent, this.getSoundCategory(), 1.0F, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F);
         }
      }
   ...
   public void livingTick() {
      ...
      if (!this.world.isRemote && this.isAlive()) {
         ...
         if (this.canEatGrass()) {
            if (!this.isEatingHaystack() && !this.isBeingRidden() && this.rand.nextInt(300) == 0 && this.world.getBlockState(this.func_233580_cy_().func_177977_b()).isIn(Blocks.GRASS_BLOCK)) {
   ...
   protected void followMother() {
      if (this.isBreeding() && this.isChild() && !this.isEatingHaystack()) {
         LivingEntity livingentity = this.world.getClosestEntityWithinAABB(AbstractHorseEntity.class, MOMMY_TARGETING, this, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), this.getBoundingBox().grow(16.0D));
         if (livingentity != null && this.getDistanceSq(livingentity) > 4.0D) {
            this.navigator.func_75494_a(livingentity, 0);
         }
      }
   ...
   public void updatePassenger(Entity passenger) {
      ...
      if (this.prevRearingAmount > 0.0F) {
         ...
         passenger.setPosition(this.func_226277_ct_() + (double)(f1 * f3), this.func_226278_cu_() + this.getMountedYOffset() + passenger.getYOffset() + (double)f2, this.func_226281_cx_() - (double)(f1 * f));
   ...
   private Vector3d func_234236_a_(Vector3d p_234236_1_, LivingEntity p_234236_2_) {
      double d0 = this.func_226277_ct_() + p_234236_1_.x;
      double d1 = this.getBoundingBox().minY;
      double d2 = this.func_226281_cx_() + p_234236_1_.z;
