...
public abstract class MobEntity extends LivingEntity {
   ...
   public void faceEntity(Entity entityIn, float maxYawIncrease, float maxPitchIncrease) {
      ...
      if (entityIn instanceof LivingEntity) {
         ...
         d1 = (entityIn.getBoundingBox().minY + entityIn.getBoundingBox().maxY) / 2.0D - this.func_226280_cw_();
      }
   ...
   public final ActionResultType processInitialInteract(PlayerEntity player, Hand hand) {
      if (!this.isAlive()) {
         ...
         if (actionresulttype.func_226246_a_()) {
            ...
            return actionresulttype.func_226246_a_() ? actionresulttype : super.processInitialInteract(player, hand);
         }
      }
   }
