...
public class TNTMinecartEntity extends AbstractMinecartEntity {
   ...
   protected void explodeCart(double p_94103_1_) {
      if (!this.world.isRemote) {
         ...
         this.world.createExplosion(this, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), (float)(4.0D + this.rand.nextDouble() * 1.5D * d0), Explosion.Mode.BREAK);
         this.remove();
      }
