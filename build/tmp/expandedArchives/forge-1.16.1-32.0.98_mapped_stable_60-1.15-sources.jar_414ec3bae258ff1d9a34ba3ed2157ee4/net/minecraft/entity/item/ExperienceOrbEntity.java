...
public class ExperienceOrbEntity extends Entity {
   ...
   public void tick() {
      ...
      if (this.closestPlayer != null) {
         Vector3d vector3d = new Vector3d(this.closestPlayer.func_226277_ct_() - this.func_226277_ct_(), this.closestPlayer.func_226278_cu_() + (double)this.closestPlayer.getEyeHeight() / 2.0D - this.func_226278_cu_(), this.closestPlayer.func_226281_cx_() - this.func_226281_cx_());
