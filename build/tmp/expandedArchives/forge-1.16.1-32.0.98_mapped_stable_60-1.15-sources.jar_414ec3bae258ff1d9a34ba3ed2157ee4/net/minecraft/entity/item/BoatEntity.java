...
public class BoatEntity extends Entity {
   ...
   public void updatePassenger(Entity passenger) {
      if (this.isPassenger(passenger)) {
         ...
         passenger.setPosition(this.func_226277_ct_() + vector3d.x, this.func_226278_cu_() + (double)f1, this.func_226281_cx_() + vector3d.z);
   ...
   public Vector3d func_230268_c_(LivingEntity p_230268_1_) {
      ...
      double d1 = this.func_226281_cx_() + vector3d.z;
   ...
   protected void updateFallState(double y, boolean onGroundIn, BlockState state, BlockPos pos) {
      ...
      if (!this.isPassenger()) {
         if (onGroundIn) {
            ...
            this.fallDistance = 0.0F;
         } else if (!this.world.getFluidState(this.func_233580_cy_().func_177977_b()).isTagged(FluidTags.WATER) && y < 0.0D) {
