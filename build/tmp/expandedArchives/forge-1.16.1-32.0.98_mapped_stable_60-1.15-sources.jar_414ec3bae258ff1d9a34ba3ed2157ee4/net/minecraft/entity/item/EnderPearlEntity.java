         ...
         if (entity instanceof ServerPlayerEntity) {
            ...
            if (serverplayerentity.connection.getNetworkManager().isChannelOpen() && serverplayerentity.world == this.world && !serverplayerentity.isSleeping()) {
               ...
               if (this.rand.nextFloat() < 0.05F && this.world.getGameRules().getBoolean(GameRules.DO_MOB_SPAWNING)) {
                  ...
                  endermiteentity.setLocationAndAngles(entity.func_226277_ct_(), entity.func_226278_cu_(), entity.func_226281_cx_(), entity.rotationYaw, entity.rotationPitch);
            ...
            entity.setPositionAndUpdate(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_());
            entity.fallDistance = 0.0F;
         }
