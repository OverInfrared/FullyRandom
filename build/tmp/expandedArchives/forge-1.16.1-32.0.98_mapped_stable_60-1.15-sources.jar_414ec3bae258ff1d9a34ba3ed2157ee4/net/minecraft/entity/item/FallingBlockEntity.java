...
public class FallingBlockEntity extends Entity {
            ...
            if (!this.onGround && !flag1) {
               ...
               if (!blockstate.isIn(Blocks.MOVING_PISTON)) {
                  ...
                  if (!this.dontSetBlock) {
                     ...
                     boolean flag3 = FallingBlock.canFallThrough(this.world.getBlockState(blockpos1.func_177977_b())) && (!flag || !flag1);
   ...
   public void fillCrashReport(CrashReportCategory category) {
      ...
      category.func_71507_a("Immitating BlockState", this.fallTile.toString());
   }
