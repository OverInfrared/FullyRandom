...
public class CommandBlockMinecartEntity extends AbstractMinecartEntity {
   ...
   public class MinecartCommandLogic extends CommandBlockLogic {
      ...
      public CommandSource getCommandSource() {
         return new CommandSource(this, CommandBlockMinecartEntity.this.getPositionVec(), CommandBlockMinecartEntity.this.getPitchYaw(), this.func_195043_d(), 2, this.getName().getString(), CommandBlockMinecartEntity.this.getDisplayName(), this.func_195043_d().getServer(), CommandBlockMinecartEntity.this);
      }
   }
}