...
public abstract class AbstractMinecartEntity extends Entity implements net.minecraftforge.common.extensions.IForgeEntityMinecart {
   ...
   private static final Map<RailShape, Pair<Vector3i, Vector3i>> MATRIX = Util.make(Maps.newEnumMap(RailShape.class), (p_226574_0_) -> {
      ...
      Vector3i vector3i4 = vector3i.func_177977_b();
      Vector3i vector3i5 = vector3i1.func_177977_b();
      Vector3i vector3i6 = vector3i2.func_177977_b();
      Vector3i vector3i7 = vector3i3.func_177977_b();
      ...
      if (direction.getAxis() == Direction.Axis.Y) {
         ...
         for(Pose pose : immutablelist) {
            ...
            for(int i : field_234627_am_.get(pose)) {
               for(int[] aint1 : aint) {
                  blockpos$mutable.func_181079_c(blockpos.getX() + aint1[0], blockpos.getY() + i, blockpos.getZ() + aint1[1]);
         ...
         blockpos$mutable.func_189532_c((double)blockpos.getX(), d1, (double)blockpos.getZ());
   ...
   protected float func_225515_ai_() {
      ...
      return blockstate.func_235714_a_(BlockTags.RAILS) ? 1.0F : super.func_225515_ai_();
   }
   ...
   protected void moveAlongTrack(BlockPos pos, BlockState state) {
      ...
      if (vector3i.getY() != 0 && MathHelper.floor(this.func_226277_ct_()) - pos.getX() == vector3i.getX() && MathHelper.floor(this.func_226281_cx_()) - pos.getZ() == vector3i.getZ()) {
         this.setPosition(this.func_226277_ct_(), this.func_226278_cu_() + (double)vector3i.getY(), this.func_226281_cx_());
      } else if (vector3i1.getY() != 0 && MathHelper.floor(this.func_226277_ct_()) - pos.getX() == vector3i1.getX() && MathHelper.floor(this.func_226281_cx_()) - pos.getZ() == vector3i1.getZ()) {
         this.setPosition(this.func_226277_ct_(), this.func_226278_cu_() + (double)vector3i1.getY(), this.func_226281_cx_());
      }

      this.applyDrag();
      Vector3d vector3d3 = this.getPos(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_());
      if (vector3d3 != null && vector3d != null) {
         ...
         this.setPosition(this.func_226277_ct_(), vector3d3.y, this.func_226281_cx_());
      }
