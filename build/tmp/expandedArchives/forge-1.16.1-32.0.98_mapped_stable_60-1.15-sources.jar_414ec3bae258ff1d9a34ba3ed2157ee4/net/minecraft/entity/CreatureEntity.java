   ...
   protected void updateLeashedState() {
      ...
      if (entity != null && entity.world == this.world) {
         ...
         if (f > 10.0F) {
            ...
            float f1 = 2.0F;
            Vector3d vector3d = (new Vector3d(entity.func_226277_ct_() - this.func_226277_ct_(), entity.func_226278_cu_() - this.func_226278_cu_(), entity.func_226281_cx_() - this.func_226281_cx_())).normalize().scale((double)Math.max(f - 2.0F, 0.0F));
            this.getNavigator().tryMoveToXYZ(this.func_226277_ct_() + vector3d.x, this.func_226278_cu_() + vector3d.y, this.func_226281_cx_() + vector3d.z, this.followLeashSpeed());
         }
      }
