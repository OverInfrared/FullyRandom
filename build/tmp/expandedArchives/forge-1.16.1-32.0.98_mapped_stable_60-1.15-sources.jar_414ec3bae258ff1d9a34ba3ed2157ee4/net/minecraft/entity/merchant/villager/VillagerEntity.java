...
public class VillagerEntity extends AbstractVillagerEntity implements IReputationTracking, IVillagerDataHolder {
   ...
   public void func_213770_a(ServerWorld serverWorldIn) {
      ...
      brain.func_218227_b(serverWorldIn, this);
   ...
   protected void updateAITasks() {
      ...
      this.getBrain().func_218210_a((ServerWorld)this.world, this);
   ...
   public ActionResultType func_230254_b_(PlayerEntity p_230254_1_, Hand p_230254_2_) {
      ...
      if (itemstack.getItem() != Items.VILLAGER_SPAWN_EGG && this.isAlive() && !this.hasCustomer() && !this.isSleeping() && !p_230254_1_.func_226563_dT_()) {
         if (this.isChild()) {
            this.shakeHead();
   ...
   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      ...
      if (reason == SpawnReason.COMMAND || reason == SpawnReason.SPAWN_EGG || reason == SpawnReason.SPAWNER || reason == SpawnReason.DISPENSER) {
         this.setVillagerData(this.getVillagerData().withType(IVillagerType.byBiome(worldIn.func_226691_t_(this.func_233580_cy_()))));
      }
   ...
   public VillagerEntity createChild(AgeableEntity ageable) {
      ...
      if (d0 < 0.5D) {
         ivillagertype = IVillagerType.byBiome(this.world.func_226691_t_(this.func_233580_cy_()));
      } else if (d0 < 0.75D) {
