...
public abstract class LivingEntity extends Entity {
   ...
   public void baseTick() {
      ...
      if (this.isAlive()) {
         if (this.areEyesInFluid(FluidTags.WATER) && !this.world.getBlockState(new BlockPos(this.func_226277_ct_(), this.func_226280_cw_(), this.func_226281_cx_())).isIn(Blocks.BUBBLE_COLUMN)) {
            if (!this.canBreatheUnderwater() && !EffectUtils.canBreatheUnderwater(this) && !flag1) {
               ...
               if (this.getAir() == -20) {
                  ...
                  for(int i = 0; i < 8; ++i) {
                     ...
                     this.world.addParticle(ParticleTypes.BUBBLE, this.func_226277_ct_() + d2, this.func_226278_cu_() + d3, this.func_226281_cx_() + d4, vector3d.x, vector3d.y, vector3d.z);
                  }
   ...
   protected void func_233640_cL_() {
      Vector3d vector3d = this.getMotion();
      this.world.addParticle(ParticleTypes.field_239812_C_, this.func_226277_ct_() + (this.rand.nextDouble() - 0.5D) * (double)this.getWidth(), this.func_226278_cu_() + 0.1D, this.func_226281_cx_() + (this.rand.nextDouble() - 0.5D) * (double)this.getWidth(), vector3d.x * -0.2D, 0.1D, vector3d.z * -0.2D);
   ...
   protected float func_225515_ai_() {
      return this.func_230296_cM_() && EnchantmentHelper.getMaxEnchantmentLevel(Enchantments.field_234847_l_, this) > 0 ? 1.0F : super.func_225515_ai_();
   }
   ...
   private void func_233628_a_(Entity p_233628_1_) {
      Vector3d vector3d;
      if (!p_233628_1_.removed && !this.world.getBlockState(p_233628_1_.func_233580_cy_()).getBlock().isIn(BlockTags.field_226154_ad_)) {
         vector3d = p_233628_1_.func_230268_c_(this);
      } else {
         vector3d = new Vector3d(p_233628_1_.func_226277_ct_(), p_233628_1_.func_226278_cu_() + (double)p_233628_1_.getHeight(), p_233628_1_.func_226281_cx_());
      }
   ...
   public void travel(Vector3d p_213352_1_) {
      if (this.isServerWorld() || this.canPassengerSteer()) {
         ...
         if (this.isInWater() && this.func_241208_cS_() && !this.func_230285_a_(fluidstate.getFluid())) {
            ...
            if (this.collidedHorizontally && this.isOffsetPositionInLiquid(vector3d2.x, vector3d2.y + (double)0.6F - this.func_226278_cu_() + d8, vector3d2.z)) {
            ...
            if (this.collidedHorizontally && this.isOffsetPositionInLiquid(vector3d4.x, vector3d4.y + (double)0.6F - this.func_226278_cu_() + d7, vector3d4.z)) {
            ...
            float f3 = this.world.getBlockState(this.func_226270_aj_()).getSlipperiness(world, this.func_226270_aj_(), this);
   ...
   public void func_233629_a_(LivingEntity p_233629_1_, boolean p_233629_2_) {
      ...
      double d0 = p_233629_1_.func_226277_ct_() - p_233629_1_.prevPosX;
      double d1 = p_233629_2_ ? p_233629_1_.func_226278_cu_() - p_233629_1_.prevPosY : 0.0D;
      double d2 = p_233629_1_.func_226281_cx_() - p_233629_1_.prevPosZ;
   ...
   public Vector3d func_233633_a_(Vector3d p_233633_1_, float p_233633_2_) {
      this.moveRelative(this.func_213335_r(p_233633_2_), p_233633_1_);
   ...
   private void addItemParticles(ItemStack stack, int count) {
      for(int i = 0; i < count; ++i) {
         ...
         vector3d1 = vector3d1.add(this.func_226277_ct_(), this.func_226280_cw_(), this.func_226281_cx_());
   ...
   public void startSleeping(BlockPos p_213342_1_) {
      ...
      if (blockstate.isBed(world, p_213342_1_, this)) {
         blockstate.setBedOccupied(world, p_213342_1_, this, true);
      }
