...
public class WaterAvoidingRandomFlyingGoal extends WaterAvoidingRandomWalkingGoal {
   ...
   private Vector3d getTreePos() {
      ...
      Iterable<BlockPos> iterable = BlockPos.getAllInBoxMutable(MathHelper.floor(this.creature.func_226277_ct_() - 3.0D), MathHelper.floor(this.creature.func_226278_cu_() - 6.0D), MathHelper.floor(this.creature.func_226281_cx_() - 3.0D), MathHelper.floor(this.creature.func_226277_ct_() + 3.0D), MathHelper.floor(this.creature.func_226278_cu_() + 6.0D), MathHelper.floor(this.creature.func_226281_cx_() + 3.0D));
