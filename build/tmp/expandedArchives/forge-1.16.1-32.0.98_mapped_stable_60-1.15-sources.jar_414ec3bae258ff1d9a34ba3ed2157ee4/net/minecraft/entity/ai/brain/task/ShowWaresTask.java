...
public class ShowWaresTask extends Task<VillagerEntity> {
   ...
   public boolean func_212832_a_(ServerWorld worldIn, VillagerEntity owner) {
   ...
   public boolean func_212834_g_(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
      return this.func_212832_a_(worldIn, entityIn) && this.field_220563_e > 0 && entityIn.getBrain().getMemory(MemoryModuleType.INTERACTION_TARGET).isPresent();
   }

   public void func_212831_a_(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
      super.func_212831_a_(worldIn, entityIn, gameTimeIn);
   ...
   public void func_212833_d_(ServerWorld worldIn, VillagerEntity owner, long gameTime) {
   ...
   public void func_212835_f_(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
      super.func_212835_f_(worldIn, entityIn, gameTimeIn);
