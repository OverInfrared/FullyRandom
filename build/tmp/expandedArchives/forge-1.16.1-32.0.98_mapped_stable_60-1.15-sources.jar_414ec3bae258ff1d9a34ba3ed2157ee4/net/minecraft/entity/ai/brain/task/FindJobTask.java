...
public class FindJobTask extends Task<VillagerEntity> {
   ...
   protected void func_212831_a_(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
      ...
      Optional<PointOfInterestType> optional = worldIn.getPointOfInterestManager().func_219148_c(blockpos);
   ...
   private boolean func_234018_a_(PointOfInterestType p_234018_1_, VillagerEntity p_234018_2_, BlockPos p_234018_3_) {
      ...
      if (flag) {
         ...
         if (p_234018_2_.getVillagerData().getProfession() != VillagerProfession.NONE && villagerprofession.getPointOfInterest().func_221045_c().test(p_234018_1_)) {
   ...
   private boolean func_234020_a_(VillagerEntity p_234020_1_, BlockPos p_234020_2_, PointOfInterestType p_234020_3_) {
      Path path = p_234020_1_.getNavigator().func_179680_a(p_234020_2_, p_234020_3_.func_225478_d());
