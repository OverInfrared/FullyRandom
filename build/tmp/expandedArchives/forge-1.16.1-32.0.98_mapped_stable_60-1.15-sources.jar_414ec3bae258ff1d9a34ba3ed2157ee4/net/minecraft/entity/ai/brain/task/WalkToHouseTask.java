...
public class WalkToHouseTask extends Task<LivingEntity> {
   ...
   protected boolean func_212832_a_(ServerWorld worldIn, LivingEntity owner) {
      if (worldIn.getGameTime() - this.field_220525_b < 20L) {
         ...
         Optional<BlockPos> optional = pointofinterestmanager.func_234148_d_(PointOfInterestType.HOME.func_221045_c(), owner.func_233580_cy_(), 48, PointOfInterestManager.Status.ANY);
   ...
   protected void func_212831_a_(ServerWorld worldIn, LivingEntity entityIn, long gameTimeIn) {
      ...
      Stream<BlockPos> stream = pointofinterestmanager.func_225399_a(PointOfInterestType.HOME.func_221045_c(), predicate, entityIn.func_233580_cy_(), 48, PointOfInterestManager.Status.ANY);
