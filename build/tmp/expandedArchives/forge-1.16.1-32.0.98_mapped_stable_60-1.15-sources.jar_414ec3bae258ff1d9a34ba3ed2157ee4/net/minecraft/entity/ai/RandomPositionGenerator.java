...
public class RandomPositionGenerator {
   ...
   @Nullable
   public static Vector3d func_226338_a_(CreatureEntity p_226338_0_, int p_226338_1_, int p_226338_2_, int p_226338_3_, @Nullable Vector3d p_226338_4_, double p_226338_5_) {
   ...
   @Nullable
   public static Vector3d func_226340_a_(CreatureEntity p_226340_0_, int p_226340_1_, int p_226340_2_, Vector3d p_226340_3_, float p_226340_4_, int p_226340_5_, int p_226340_6_) {
   ...
   public static Vector3d func_234133_a_(CreatureEntity p_234133_0_, int p_234133_1_, int p_234133_2_, Vector3d p_234133_3_) {
      Vector3d vector3d = p_234133_3_.subtract(p_234133_0_.func_226277_ct_(), p_234133_0_.func_226278_cu_(), p_234133_0_.func_226281_cx_());
   ...
   public static Vector3d findRandomTargetBlockTowards(CreatureEntity entitycreatureIn, int xz, int y, Vector3d targetVec3) {
      Vector3d vector3d = targetVec3.subtract(entitycreatureIn.func_226277_ct_(), entitycreatureIn.func_226278_cu_(), entitycreatureIn.func_226281_cx_());
   ...
   public static Vector3d findRandomTargetTowardsScaled(CreatureEntity p_203155_0_, int xz, int p_203155_2_, Vector3d p_203155_3_, double p_203155_4_) {
      Vector3d vector3d = p_203155_3_.subtract(p_203155_0_.func_226277_ct_(), p_203155_0_.func_226278_cu_(), p_203155_0_.func_226281_cx_());
   ...
   public static Vector3d func_226344_b_(CreatureEntity p_226344_0_, int p_226344_1_, int p_226344_2_, int p_226344_3_, Vector3d p_226344_4_, double p_226344_5_) {
      Vector3d vector3d = p_226344_4_.subtract(p_226344_0_.func_226277_ct_(), p_226344_0_.func_226278_cu_(), p_226344_0_.func_226281_cx_());
      ...
      for(int i = 0; i < 10; ++i) {
         ...
         if (blockpos1 != null) {
            ...
            if (p_226339_0_.detachHome() && p_226339_1_ > 1) {
               ...
               if (p_226339_0_.func_226277_ct_() > (double)blockpos2.getX()) {
                  j -= random.nextInt(p_226339_1_ / 2);
               } else {
                  j += random.nextInt(p_226339_1_ / 2);
               }

               if (p_226339_0_.func_226281_cx_() > (double)blockpos2.getZ()) {
