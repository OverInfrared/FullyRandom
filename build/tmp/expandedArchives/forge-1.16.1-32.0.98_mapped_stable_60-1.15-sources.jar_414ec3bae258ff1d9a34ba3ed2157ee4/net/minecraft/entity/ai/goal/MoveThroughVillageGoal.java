         ...
         if (this.isNocturnal && this.entity.world.isDaytime()) {
            ...
            if (!serverworld.func_241119_a_(blockpos, 6)) {
               ...
               if (vector3d == null) {
                  ...
                  Optional<BlockPos> optional = serverworld.getPointOfInterestManager().func_219127_a(PointOfInterestType.field_221053_a, this::func_220733_a, new BlockPos(vector3d), 10, PointOfInterestManager.Status.IS_OCCUPIED);
                  if (!optional.isPresent()) {
                     ...
                     this.path = groundpathnavigator.func_179680_a(this.field_220735_d, 0);
                     ...
                     if (this.path == null) {
                        ...
                        groundpathnavigator.setBreakDoors(this.booleanSupplier.getAsBoolean());
                        this.path = this.entity.getNavigator().func_225466_a(vector3d1.x, vector3d1.y, vector3d1.z, 0);
                        groundpathnavigator.setBreakDoors(flag);
                        if (this.path == null) {
                           return false;
                        }
