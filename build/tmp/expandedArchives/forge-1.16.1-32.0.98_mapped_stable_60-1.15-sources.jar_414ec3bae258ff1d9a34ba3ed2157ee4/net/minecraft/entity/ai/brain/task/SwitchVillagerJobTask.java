...
public class SwitchVillagerJobTask extends Task<VillagerEntity> {
   ...
   protected void func_212831_a_(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
      ...
      worldIn.getPointOfInterestManager().func_219148_c(globalpos.getPos()).ifPresent((p_233933_3_) -> {
   ...
   private boolean func_233930_a_(PointOfInterestType p_233930_1_, VillagerProfession p_233930_2_) {
      return p_233930_2_.getPointOfInterest().func_221045_c().test(p_233930_1_);
   }
