...
public class AvoidEntityGoal<T extends LivingEntity> extends Goal {
   ...
   public boolean shouldExecute() {
      this.avoidTarget = this.entity.world.func_225318_b(this.classToAvoid, this.builtTargetSelector, this.entity, this.entity.func_226277_ct_(), this.entity.func_226278_cu_(), this.entity.func_226281_cx_(), this.entity.getBoundingBox().grow((double)this.avoidDistance, 3.0D, (double)this.avoidDistance));
      if (this.avoidTarget == null) {
         ...
         if (vector3d == null) {
            ...
            this.path = this.navigation.func_225466_a(vector3d.x, vector3d.y, vector3d.z, 0);
