...
public class LlamaFollowCaravanGoal extends Goal {
   ...
   public void tick() {
      if (this.llama.inCaravan()) {
         ...
         float f = 2.0F;
         Vector3d vector3d = (new Vector3d(llamaentity.func_226277_ct_() - this.llama.func_226277_ct_(), llamaentity.func_226278_cu_() - this.llama.func_226278_cu_(), llamaentity.func_226281_cx_() - this.llama.func_226281_cx_())).normalize().scale(Math.max(d0 - 2.0D, 0.0D));
         this.llama.getNavigator().tryMoveToXYZ(this.llama.func_226277_ct_() + vector3d.x, this.llama.func_226278_cu_() + vector3d.y, this.llama.func_226281_cx_() + vector3d.z, this.speedModifier);
      }
   }
