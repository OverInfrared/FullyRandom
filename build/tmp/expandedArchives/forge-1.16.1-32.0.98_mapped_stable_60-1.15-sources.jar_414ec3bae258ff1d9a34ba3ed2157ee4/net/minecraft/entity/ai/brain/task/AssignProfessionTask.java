...
public class AssignProfessionTask extends Task<VillagerEntity> {
   ...
   protected void func_212831_a_(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
      ...
      if (entityIn.getVillagerData().getProfession() == VillagerProfession.NONE) {
         ...
         Optional.ofNullable(minecraftserver.func_71218_a(globalpos.func_239646_a_())).flatMap((p_241376_1_) -> {
            return p_241376_1_.getPointOfInterestManager().func_219148_c(globalpos.getPos());
         }).flatMap((p_220390_0_) -> {
            ...
            entityIn.func_213770_a(worldIn);
         });
      }
   }
}