...
public class TriggerSkeletonTrapGoal extends Goal {
   ...
   public void tick() {
      ...
      lightningboltentity.func_225653_b_(this.horse.func_226277_ct_(), this.horse.func_226278_cu_(), this.horse.func_226281_cx_());
   ...
   private AbstractHorseEntity createHorse(DifficultyInstance p_188515_1_) {
      ...
      skeletonhorseentity.setPosition(this.horse.func_226277_ct_(), this.horse.func_226278_cu_(), this.horse.func_226281_cx_());
   ...
   private SkeletonEntity createSkeleton(DifficultyInstance p_188514_1_, AbstractHorseEntity p_188514_2_) {
      ...
      skeletonentity.setPosition(p_188514_2_.func_226277_ct_(), p_188514_2_.func_226278_cu_(), p_188514_2_.func_226281_cx_());
