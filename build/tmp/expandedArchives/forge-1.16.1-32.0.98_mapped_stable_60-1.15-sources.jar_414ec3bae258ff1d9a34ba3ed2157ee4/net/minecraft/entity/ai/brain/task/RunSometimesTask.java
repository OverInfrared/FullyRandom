...
public class RunSometimesTask<E extends LivingEntity> extends Task<E> {
   ...
   protected boolean func_212832_a_(ServerWorld worldIn, E owner) {
      if (!this.field_233947_e_.func_212832_a_(worldIn, owner)) {
         return false;
      } else {
   ...
   protected void func_212831_a_(ServerWorld worldIn, E entityIn, long gameTimeIn) {
      this.field_233947_e_.func_212831_a_(worldIn, entityIn, gameTimeIn);
   }

   protected boolean func_212834_g_(ServerWorld worldIn, E entityIn, long gameTimeIn) {
      return this.field_233947_e_.func_212834_g_(worldIn, entityIn, gameTimeIn);
   }

   protected void func_212833_d_(ServerWorld worldIn, E owner, long gameTime) {
      this.field_233947_e_.func_212833_d_(worldIn, owner, gameTime);
   ...
   protected void func_212835_f_(ServerWorld worldIn, E entityIn, long gameTimeIn) {
      this.func_233949_a_(worldIn);
      this.field_233947_e_.func_212835_f_(worldIn, entityIn, gameTimeIn);
   }
