...
public class WalkToPOITask extends Task<VillagerEntity> {
   ...
   protected boolean func_212832_a_(ServerWorld worldIn, VillagerEntity owner) {
      return !worldIn.func_217483_b_(owner.func_233580_cy_());
   }
   ...
   protected void func_212831_a_(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
      ...
      int i = pointofinterestmanager.func_219150_a(SectionPos.from(entityIn.func_233580_cy_()));
      ...
      for(int j = 0; j < 5; ++j) {
         ...
         if (vector3d1 != null) {
            int k = pointofinterestmanager.func_219150_a(SectionPos.from(new BlockPos(vector3d1)));
            if (k < i) {
               vector3d = vector3d1;
               break;
            }
