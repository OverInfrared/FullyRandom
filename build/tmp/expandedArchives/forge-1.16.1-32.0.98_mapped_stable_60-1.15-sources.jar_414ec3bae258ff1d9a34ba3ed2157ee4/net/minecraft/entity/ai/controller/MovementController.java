...
public class MovementController {
   ...
   private boolean func_234024_b_(float p_234024_1_, float p_234024_2_) {
      ...
      if (pathnavigator != null) {
         ...
         if (nodeprocessor != null && nodeprocessor.getPathNodeType(this.mob.world, MathHelper.floor(this.mob.func_226277_ct_() + (double)p_234024_1_), MathHelper.floor(this.mob.func_226278_cu_()), MathHelper.floor(this.mob.func_226281_cx_() + (double)p_234024_2_)) != PathNodeType.WALKABLE) {
            return false;
         }
      }
