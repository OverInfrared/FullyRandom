...
public abstract class TargetGoal extends Goal {
   ...
   private boolean canEasilyReach(LivingEntity target) {
      ...
      Path path = this.goalOwner.getNavigator().func_75494_a(target, 0);
      if (path == null) {
         return false;
      } else {
         ...
         if (pathpoint == null) {
            ...
            int i = pathpoint.x - MathHelper.floor(target.func_226277_ct_());
            int j = pathpoint.z - MathHelper.floor(target.func_226281_cx_());
