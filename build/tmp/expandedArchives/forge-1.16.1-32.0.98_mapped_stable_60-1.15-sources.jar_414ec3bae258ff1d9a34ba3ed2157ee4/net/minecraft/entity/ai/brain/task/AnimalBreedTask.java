...
public class AnimalBreedTask extends Task<AnimalEntity> {
   ...
   protected boolean func_212832_a_(ServerWorld worldIn, AnimalEntity owner) {
      return owner.isInLove() && this.func_233849_c_(owner).isPresent();
   }

   protected void func_212831_a_(ServerWorld worldIn, AnimalEntity entityIn, long gameTimeIn) {
   ...
   protected boolean func_212834_g_(ServerWorld worldIn, AnimalEntity entityIn, long gameTimeIn) {
   ...
   protected void func_212833_d_(ServerWorld worldIn, AnimalEntity owner, long gameTime) {
   ...
   protected void func_212835_f_(ServerWorld worldIn, AnimalEntity entityIn, long gameTimeIn) {
