...
public class FindPotentialJobTask extends Task<VillagerEntity> {
   ...
   protected void func_212835_f_(ServerWorld worldIn, VillagerEntity entityIn, long gameTimeIn) {
      ...
      optional.ifPresent((p_233905_1_) -> {
         ...
         ServerWorld serverworld = worldIn.getServer().func_71218_a(p_233905_1_.func_239646_a_());
         if (serverworld != null) {
            PointOfInterestManager pointofinterestmanager = serverworld.getPointOfInterestManager();
            if (pointofinterestmanager.func_219138_a(blockpos, (p_241377_0_) -> {
               return true;
            })) {
               pointofinterestmanager.func_219142_b(blockpos);
            }
