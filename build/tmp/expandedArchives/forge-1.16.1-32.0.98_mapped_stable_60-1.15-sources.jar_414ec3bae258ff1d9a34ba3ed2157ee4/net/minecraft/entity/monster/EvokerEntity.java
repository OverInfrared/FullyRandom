      ...
      protected void castSpell() {
         ...
         if (EvokerEntity.this.getDistanceSq(livingentity) < 9.0D) {
            for(int i = 0; i < 5; ++i) {
               ...
               this.spawnFangs(EvokerEntity.this.func_226277_ct_() + (double)MathHelper.cos(f1) * 1.5D, EvokerEntity.this.func_226281_cx_() + (double)MathHelper.sin(f1) * 1.5D, d0, d1, f1, 0);
            }
