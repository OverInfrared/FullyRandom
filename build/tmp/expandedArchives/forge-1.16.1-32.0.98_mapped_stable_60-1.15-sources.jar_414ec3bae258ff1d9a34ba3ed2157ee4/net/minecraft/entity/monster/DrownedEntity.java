...
public class DrownedEntity extends ZombieEntity implements IRangedAttackMob {
   ...
   public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
      ...
      double d1 = target.func_226283_e_(0.3333333333333333D) - tridententity.func_226278_cu_();
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         if (this.drowned.func_204715_dF() && this.drowned.isInWater()) {
            if (livingentity != null && livingentity.func_226278_cu_() > this.drowned.func_226278_cu_() || this.drowned.swimmingUp) {
            ...
            double d0 = this.posX - this.drowned.func_226277_ct_();
            double d1 = this.posY - this.drowned.func_226278_cu_();
            double d2 = this.posZ - this.drowned.func_226281_cx_();
   ...
   static class SwimUpGoal extends Goal {
      ...
      public void tick() {
         if (this.field_204736_a.func_226278_cu_() < (double)(this.targetY - 1) && (this.field_204736_a.getNavigator().noPath() || this.field_204736_a.isCloseToPathTarget())) {
            Vector3d vector3d = RandomPositionGenerator.findRandomTargetBlockTowards(this.field_204736_a, 4, 8, new Vector3d(this.field_204736_a.func_226277_ct_(), (double)(this.targetY - 1), this.field_204736_a.func_226281_cx_()));
            if (vector3d == null) {
