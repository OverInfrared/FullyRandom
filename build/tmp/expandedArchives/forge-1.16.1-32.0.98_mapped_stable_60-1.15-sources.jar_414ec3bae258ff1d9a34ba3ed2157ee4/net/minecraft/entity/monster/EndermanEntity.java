...
public class EndermanEntity extends MonsterEntity implements IAngerable {
   ...
   protected void updateAITasks() {
      if (this.world.isDaytime() && this.ticksExisted >= this.targetChangeTime + 600) {
         ...
         if (f > 0.5F && this.world.func_226660_f_(this.func_233580_cy_()) && this.rand.nextFloat() * 30.0F < (f - 0.4F) * 2.0F) {
   ...
   private boolean teleportToEntity(Entity p_70816_1_) {
      Vector3d vector3d = new Vector3d(this.func_226277_ct_() - p_70816_1_.func_226277_ct_(), this.func_226283_e_(0.5D) - p_70816_1_.func_226280_cw_(), this.func_226281_cx_() - p_70816_1_.func_226281_cx_());
      vector3d = vector3d.normalize();
      double d0 = 16.0D;
      double d1 = this.func_226277_ct_() + (this.rand.nextDouble() - 0.5D) * 8.0D - vector3d.x * 16.0D;
      double d2 = this.func_226278_cu_() + (double)(this.rand.nextInt(16) - 8) - vector3d.y * 16.0D;
      double d3 = this.func_226281_cx_() + (this.rand.nextDouble() - 0.5D) * 8.0D - vector3d.z * 16.0D;
   ...
   static class StareGoal extends Goal {
      ...
      public void tick() {
         this.field_220835_a.getLookController().setLookPosition(this.field_226540_b_.func_226277_ct_(), this.field_226540_b_.func_226280_cw_(), this.field_226540_b_.func_226281_cx_());
      }
   }
   ...
   static class TakeBlockGoal extends Goal {
      ...
      public void tick() {
         ...
         Vector3d vector3d = new Vector3d((double)MathHelper.floor(this.enderman.func_226277_ct_()) + 0.5D, (double)j + 0.5D, (double)MathHelper.floor(this.enderman.func_226281_cx_()) + 0.5D);
