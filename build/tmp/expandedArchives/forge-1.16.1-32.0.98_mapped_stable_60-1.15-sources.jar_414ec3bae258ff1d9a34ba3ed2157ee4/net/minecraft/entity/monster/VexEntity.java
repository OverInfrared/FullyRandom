   ...
   class MoveHelperController extends MovementController {
      ...
      public void tick() {
         if (this.action == MovementController.Action.MOVE_TO) {
            Vector3d vector3d = new Vector3d(this.posX - VexEntity.this.func_226277_ct_(), this.posY - VexEntity.this.func_226278_cu_(), this.posZ - VexEntity.this.func_226281_cx_());
            ...
            if (d0 < VexEntity.this.getBoundingBox().getAverageEdgeLength()) {
               ...
               if (VexEntity.this.getAttackTarget() == null) {
                  ...
                  double d2 = VexEntity.this.getAttackTarget().func_226277_ct_() - VexEntity.this.func_226277_ct_();
                  double d1 = VexEntity.this.getAttackTarget().func_226281_cx_() - VexEntity.this.func_226281_cx_();
