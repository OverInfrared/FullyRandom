...
public class ZombieVillagerEntity extends ZombieEntity implements IVillagerDataHolder {
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("VillagerData", 10)) {
         ...
         dataresult.resultOrPartial(LOGGER::error).ifPresent(this::func_213792_a);
      }
   ...
   public boolean canDespawn(double distanceToClosestPlayer) {
      return !this.isConverting() && this.field_213794_bC == 0;
   }
   ...
   private int getConversionProgress() {
      ...
      if (this.rand.nextFloat() < 0.01F) {
         ...
         for(int k = (int)this.func_226277_ct_() - 4; k < (int)this.func_226277_ct_() + 4 && j < 14; ++k) {
            for(int l = (int)this.func_226278_cu_() - 4; l < (int)this.func_226278_cu_() + 4 && j < 14; ++l) {
               for(int i1 = (int)this.func_226281_cx_() - 4; i1 < (int)this.func_226281_cx_() + 4 && j < 14; ++i1) {
                  Block block = this.world.getBlockState(blockpos$mutable.func_181079_c(k, l, i1)).getBlock();
   ...
   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      this.func_213792_a(this.getVillagerData().withType(IVillagerType.byBiome(worldIn.func_226691_t_(this.func_233580_cy_()))));
