...
public class RavagerEntity extends AbstractRaiderEntity {
   ...
   private void func_213682_eh() {
      if (this.rand.nextInt(6) == 0) {
         double d0 = this.func_226277_ct_() - (double)this.getWidth() * Math.sin((double)(this.renderYawOffset * ((float)Math.PI / 180F))) + (this.rand.nextDouble() * 0.6D - 0.3D);
         double d1 = this.func_226278_cu_() + (double)this.getHeight() - 0.3D;
         double d2 = this.func_226281_cx_() + (double)this.getWidth() * Math.cos((double)(this.renderYawOffset * ((float)Math.PI / 180F))) + (this.rand.nextDouble() * 0.6D - 0.3D);
