      ...
      if (this.isAlive()) {
         if (this.world.isRemote) {
            ...
            if (!this.isInWater()) {
               ...
               this.clientSideTouchedGround = vector3d.y < 0.0D && this.world.isTopSolid(this.func_233580_cy_().func_177977_b(), this);
            ...
            if (this.isMoving() && this.isInWater()) {
               ...
               for(int i = 0; i < 2; ++i) {
                  this.world.addParticle(ParticleTypes.BUBBLE, this.func_226282_d_(0.5D) - vector3d1.x * 1.5D, this.func_226279_cv_() - vector3d1.y * 1.5D, this.func_226287_g_(0.5D) - vector3d1.z * 1.5D, 0.0D, 0.0D, 0.0D);
               }
            }
            ...
            if (this.hasTargetedEntity()) {
               ...
               if (livingentity != null) {
                  ...
                  double d1 = livingentity.func_226283_e_(0.5D) - this.func_226280_cw_();
                  ...
                  while(d4 < d3) {
                     ...
                     this.world.addParticle(ParticleTypes.BUBBLE, this.func_226277_ct_() + d0 * d4, this.func_226280_cw_() + d1 * d4, this.func_226281_cx_() + d2 * d4, 0.0D, 0.0D, 0.0D);
                  }
               }
            }
         }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         if (this.action == MovementController.Action.MOVE_TO && !this.entityGuardian.getNavigator().noPath()) {
            Vector3d vector3d = new Vector3d(this.posX - this.entityGuardian.func_226277_ct_(), this.posY - this.entityGuardian.func_226278_cu_(), this.posZ - this.entityGuardian.func_226281_cx_());
            ...
            double d8 = this.entityGuardian.func_226277_ct_() + d1 * 2.0D;
            double d9 = this.entityGuardian.func_226280_cw_() + d2 / d0;
            double d10 = this.entityGuardian.func_226281_cx_() + d3 * 2.0D;
