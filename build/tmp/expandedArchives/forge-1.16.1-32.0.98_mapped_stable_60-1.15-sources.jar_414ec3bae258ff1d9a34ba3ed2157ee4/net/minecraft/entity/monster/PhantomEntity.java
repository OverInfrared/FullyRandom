...
public class PhantomEntity extends FlyingEntity implements IMob {
   ...
   public void tick() {
      ...
      if (this.world.isRemote) {
         ...
         this.world.addParticle(ParticleTypes.MYCELIUM, this.func_226277_ct_() + (double)f2, this.func_226278_cu_() + (double)f4, this.func_226281_cx_() + (double)f3, 0.0D, 0.0D, 0.0D);
         this.world.addParticle(ParticleTypes.MYCELIUM, this.func_226277_ct_() - (double)f2, this.func_226278_cu_() + (double)f4, this.func_226281_cx_() - (double)f3, 0.0D, 0.0D, 0.0D);
      }
   ...
   class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         float f = (float)(PhantomEntity.this.orbitOffset.x - PhantomEntity.this.func_226277_ct_());
         float f1 = (float)(PhantomEntity.this.orbitOffset.y - PhantomEntity.this.func_226278_cu_());
         float f2 = (float)(PhantomEntity.this.orbitOffset.z - PhantomEntity.this.func_226281_cx_());
   ...
   class OrbitPointGoal extends PhantomEntity.MoveGoal {
      ...
      public void tick() {
         ...
         if (PhantomEntity.this.orbitOffset.y < PhantomEntity.this.func_226278_cu_() && !PhantomEntity.this.world.isAirBlock(PhantomEntity.this.func_233580_cy_().func_177979_c(1))) {
            this.field_203152_e = Math.max(1.0F, this.field_203152_e);
            this.func_203148_i();
         }

         if (PhantomEntity.this.orbitOffset.y > PhantomEntity.this.func_226278_cu_() && !PhantomEntity.this.world.isAirBlock(PhantomEntity.this.func_233580_cy_().up(1))) {
   ...
   class SweepAttackGoal extends PhantomEntity.MoveGoal {
      ...
      public void tick() {
         LivingEntity livingentity = PhantomEntity.this.getAttackTarget();
         PhantomEntity.this.orbitOffset = new Vector3d(livingentity.func_226277_ct_(), livingentity.func_226283_e_(0.5D), livingentity.func_226281_cx_());
