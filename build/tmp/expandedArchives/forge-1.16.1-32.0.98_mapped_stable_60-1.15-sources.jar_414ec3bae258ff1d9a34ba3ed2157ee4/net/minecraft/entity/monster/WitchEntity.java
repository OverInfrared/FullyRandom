...
public class WitchEntity extends AbstractRaiderEntity implements IRangedAttackMob {
   ...
   public void handleStatusUpdate(byte id) {
      if (id == 15) {
         for(int i = 0; i < this.rand.nextInt(35) + 10; ++i) {
            this.world.addParticle(ParticleTypes.WITCH, this.func_226277_ct_() + this.rand.nextGaussian() * (double)0.13F, this.getBoundingBox().maxY + 0.5D + this.rand.nextGaussian() * (double)0.13F, this.func_226281_cx_() + this.rand.nextGaussian() * (double)0.13F, 0.0D, 0.0D, 0.0D);
         }
      } else {
   ...
   public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
      if (!this.isDrinkingPotion()) {
         ...
         double d0 = target.func_226277_ct_() + vector3d.x - this.func_226277_ct_();
         double d1 = target.func_226280_cw_() - (double)1.1F - this.func_226278_cu_();
         double d2 = target.func_226281_cx_() + vector3d.z - this.func_226281_cx_();
