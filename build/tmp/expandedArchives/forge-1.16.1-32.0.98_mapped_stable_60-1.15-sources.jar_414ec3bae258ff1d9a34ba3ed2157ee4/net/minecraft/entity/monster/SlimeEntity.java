...
public class SlimeEntity extends MobEntity implements IMob {
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, PlayerEntity.class, 10, true, false, (p_213811_1_) -> {
         return Math.abs(p_213811_1_.func_226278_cu_() - this.func_226278_cu_()) <= 4.0D;
      }));
   ...
   public void remove(boolean keepData) {
      ...
      if (!this.world.isRemote && i > 1 && this.func_233643_dh_() && !this.removed) {
         ...
         for(int l = 0; l < k; ++l) {
            ...
            slimeentity.setLocationAndAngles(this.func_226277_ct_() + (double)f1, this.func_226278_cu_() + 0.5D, this.func_226281_cx_() + (double)f2, this.rand.nextFloat() * 360.0F, 0.0F);
