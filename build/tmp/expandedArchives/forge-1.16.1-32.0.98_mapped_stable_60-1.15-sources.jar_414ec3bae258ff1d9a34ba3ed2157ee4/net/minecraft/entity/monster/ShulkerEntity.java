...
public class ShulkerEntity extends GolemEntity implements IMob {
   ...
   public void tick() {
      ...
      if (blockpos != null) {
         ...
         this.setBoundingBox((new AxisAlignedBB(this.func_226277_ct_() - 0.5D, this.func_226278_cu_(), this.func_226281_cx_() - 0.5D, this.func_226277_ct_() + 0.5D, this.func_226278_cu_() + 1.0D, this.func_226281_cx_() + 0.5D)).expand((double)direction2.getXOffset() * d2, (double)direction2.getYOffset() * d2, (double)direction2.getZOffset() * d2));
         double d1 = d2 - d0;
         if (d1 > 0.0D) {
   ...
   private boolean func_234298_a_(BlockPos p_234298_1_, Direction p_234298_2_) {
      return this.world.func_234929_a_(p_234298_1_.offset(p_234298_2_), this, p_234298_2_.getOpposite()) && this.world.func_226665_a__(this, ShulkerAABBHelper.func_233539_a_(p_234298_1_, p_234298_2_.getOpposite()));
   }
