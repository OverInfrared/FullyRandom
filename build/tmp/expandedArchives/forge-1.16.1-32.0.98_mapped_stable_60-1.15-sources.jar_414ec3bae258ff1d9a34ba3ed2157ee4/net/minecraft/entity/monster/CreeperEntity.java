...
public class CreeperEntity extends MonsterEntity implements IChargeableMob {
   ...
   protected ActionResultType func_230254_b_(PlayerEntity p_230254_1_, Hand p_230254_2_) {
      ...
      if (itemstack.getItem() == Items.FLINT_AND_STEEL) {
         this.world.playSound(p_230254_1_, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), SoundEvents.ITEM_FLINTANDSTEEL_USE, this.getSoundCategory(), 1.0F, this.rand.nextFloat() * 0.4F + 0.8F);
