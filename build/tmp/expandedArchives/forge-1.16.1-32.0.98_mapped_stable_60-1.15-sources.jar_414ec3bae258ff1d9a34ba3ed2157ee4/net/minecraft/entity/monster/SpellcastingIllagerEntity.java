...
public abstract class SpellcastingIllagerEntity extends AbstractIllagerEntity {
   ...
   public void tick() {
      ...
      if (this.world.isRemote && this.isSpellcasting()) {
         ...
         this.world.addParticle(ParticleTypes.ENTITY_EFFECT, this.func_226277_ct_() + (double)f1 * 0.6D, this.func_226278_cu_() + 1.8D, this.func_226281_cx_() + (double)f2 * 0.6D, d0, d1, d2);
         this.world.addParticle(ParticleTypes.ENTITY_EFFECT, this.func_226277_ct_() - (double)f1 * 0.6D, this.func_226278_cu_() + 1.8D, this.func_226281_cx_() - (double)f2 * 0.6D, d0, d1, d2);
      }
