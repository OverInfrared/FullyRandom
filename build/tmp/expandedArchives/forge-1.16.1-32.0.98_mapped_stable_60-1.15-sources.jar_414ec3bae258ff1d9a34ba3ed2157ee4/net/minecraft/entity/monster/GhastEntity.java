      ...
      public void tick() {
         ...
         if (livingentity.getDistanceSq(this.parentEntity) < 4096.0D && this.parentEntity.canEntityBeSeen(livingentity)) {
            ...
            if (this.attackTimer == 20) {
               ...
               double d2 = livingentity.func_226277_ct_() - (this.parentEntity.func_226277_ct_() + vector3d.x * 4.0D);
               double d3 = livingentity.func_226283_e_(0.5D) - (0.5D + this.parentEntity.func_226283_e_(0.5D));
               double d4 = livingentity.func_226281_cx_() - (this.parentEntity.func_226281_cx_() + vector3d.z * 4.0D);
               ...
               fireballentity.setPosition(this.parentEntity.func_226277_ct_() + vector3d.x * 4.0D, this.parentEntity.func_226283_e_(0.5D) + 0.5D, fireballentity.func_226281_cx_() + vector3d.z * 4.0D);
      ...
      public void tick() {
         if (this.action == MovementController.Action.MOVE_TO) {
            if (this.courseChangeCooldown-- <= 0) {
               ...
               Vector3d vector3d = new Vector3d(this.posX - this.parentEntity.func_226277_ct_(), this.posY - this.parentEntity.func_226278_cu_(), this.posZ - this.parentEntity.func_226281_cx_());
   ...
   static class RandomFlyGoal extends Goal {
      ...
      public boolean shouldExecute() {
         ...
         if (!movementcontroller.isUpdating()) {
            ...
            double d0 = movementcontroller.getX() - this.parentEntity.func_226277_ct_();
            double d1 = movementcontroller.getY() - this.parentEntity.func_226278_cu_();
            double d2 = movementcontroller.getZ() - this.parentEntity.func_226281_cx_();
