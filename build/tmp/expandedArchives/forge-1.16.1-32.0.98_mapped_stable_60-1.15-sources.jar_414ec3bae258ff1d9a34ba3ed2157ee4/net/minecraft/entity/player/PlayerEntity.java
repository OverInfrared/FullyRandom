...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public void updateRidden() {
      if (this.func_226564_dU_() && this.isPassenger()) {
         this.stopRiding();
      ...
      if (p_192028_1_ != null && (!p_192028_1_.contains("Silent") || !p_192028_1_.getBoolean("Silent")) && this.world.rand.nextInt(200) == 0) {
         ...
         EntityType.byKey(s).filter((p_213830_0_) -> {
            ...
            if (!ParrotEntity.playMimicSound(this.world, this)) {
               this.world.playSound((PlayerEntity)null, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), ParrotEntity.func_234212_a_(this.world, this.world.rand), this.getSoundCategory(), 1.0F, ParrotEntity.getPitch(this.world.rand));
            }
