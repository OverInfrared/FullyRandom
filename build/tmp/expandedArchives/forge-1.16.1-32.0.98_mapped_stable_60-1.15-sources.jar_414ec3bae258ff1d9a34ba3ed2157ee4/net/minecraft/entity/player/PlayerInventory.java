   ...
   public boolean add(int slotIn, ItemStack stack) {
      if (stack.isEmpty()) {
         ...
         try {
            ...
            crashreportcategory.func_189529_a("Item Class", () -> stack.getItem().getClass().getName());
            crashreportcategory.func_71507_a("Item ID", Item.getIdFromItem(stack.getItem()));
            crashreportcategory.func_71507_a("Item data", stack.getDamage());
