...
public class ServerPlayerEntity extends PlayerEntity implements IContainerListener {
   ...
   private void func_241157_eT_() {
      ...
      this.world.func_225317_b(MobEntity.class, axisalignedbb).stream().filter((p_241155_0_) -> {
   ...
   public Entity changeDimension(ServerWorld p_241206_1_, net.minecraftforge.common.util.ITeleporter teleporter) {
      ...
      if (registrykey == World.field_234920_i_ && p_241206_1_.func_234923_W_() == World.field_234918_g_ && teleporter instanceof net.minecraft.world.Teleporter) { //Forge: Fix non-vanilla teleporters triggering end credits
         ...
         this.interactionManager.func_73080_a(p_241206_1_);
   ...
   private boolean func_241158_g_(BlockPos p_241158_1_) {
      ...
      return Math.abs(this.func_226277_ct_() - vector3d.getX()) <= 3.0D && Math.abs(this.func_226278_cu_() - vector3d.getY()) <= 2.0D && Math.abs(this.func_226281_cx_() - vector3d.getZ()) <= 3.0D;
   }
   ...
   public void func_200619_a(ServerWorld p_200619_1_, double x, double y, double z, float yaw, float pitch) {
      ...
      if (p_200619_1_ == this.world) {
         ...
         ServerWorld serverworld = this.func_71121_q();
         IWorldInfo iworldinfo = p_200619_1_.getWorldInfo();
         this.connection.sendPacket(new SRespawnPacket(p_200619_1_.func_234922_V_(), p_200619_1_.func_234923_W_(), BiomeManager.func_235200_a_(p_200619_1_.getSeed()), this.interactionManager.getGameType(), this.interactionManager.func_241815_c_(), p_200619_1_.func_234925_Z_(), p_200619_1_.func_241109_A_(), true));
         this.connection.sendPacket(new SServerDifficultyPacket(iworldinfo.getDifficulty(), iworldinfo.isDifficultyLocked()));
