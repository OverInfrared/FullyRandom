      ...
      if (this.world.isRemote) {
         if (this.clientSideAttackStarted) {
            ...
            if (this.lifeTicks == 14) {
               for(int i = 0; i < 12; ++i) {
                  double d0 = this.func_226277_ct_() + (this.rand.nextDouble() * 2.0D - 1.0D) * (double)this.getWidth() * 0.5D;
                  double d1 = this.func_226278_cu_() + 0.05D + this.rand.nextDouble();
                  double d2 = this.func_226281_cx_() + (this.rand.nextDouble() * 2.0D - 1.0D) * (double)this.getWidth() * 0.5D;
