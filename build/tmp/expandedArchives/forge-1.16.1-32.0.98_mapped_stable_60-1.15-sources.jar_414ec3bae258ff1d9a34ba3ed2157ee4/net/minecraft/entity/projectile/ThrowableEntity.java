...
public abstract class ThrowableEntity extends ProjectileEntity {
   ...
   protected ThrowableEntity(EntityType<? extends ThrowableEntity> type, LivingEntity livingEntityIn, World worldIn) {
      this(type, livingEntityIn.func_226277_ct_(), livingEntityIn.func_226280_cw_() - (double)0.1F, livingEntityIn.func_226281_cx_(), worldIn);
   ...
   public void tick() {
      ...
      double d2 = this.func_226277_ct_() + vector3d.x;
      double d0 = this.func_226278_cu_() + vector3d.y;
