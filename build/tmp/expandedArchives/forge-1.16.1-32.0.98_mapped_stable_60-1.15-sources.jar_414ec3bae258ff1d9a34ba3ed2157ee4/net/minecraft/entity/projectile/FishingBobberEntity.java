...
public class FishingBobberEntity extends ProjectileEntity {
   ...
   public FishingBobberEntity(PlayerEntity p_i50220_1_, World p_i50220_2_, int p_i50220_3_, int p_i50220_4_) {
      ...
      double d0 = p_i50220_1_.func_226277_ct_() - (double)f3 * 0.3D;
      double d1 = p_i50220_1_.func_226280_cw_();
      double d2 = p_i50220_1_.func_226281_cx_() - (double)f2 * 0.3D;
      ...
      if (playerentity == null) {
         ...
         if (this.currentState == FishingBobberEntity.State.FLYING) {
            ...
            if (this.currentState == FishingBobberEntity.State.BOBBING) {
               ...
               double d0 = this.func_226278_cu_() + vector3d.y - (double)blockpos.getY() - (double)f;
      ...
      if (!this.world.isRemote && playerentity != null) {
         ...
         if (this.caughtEntity != null) {
            ...
            for(ItemStack itemstack : list) {
               ...
               playerentity.world.addEntity(new ExperienceOrbEntity(playerentity.world, playerentity.func_226277_ct_(), playerentity.func_226278_cu_() + 0.5D, playerentity.func_226281_cx_() + 0.5D, this.rand.nextInt(6) + 1));
   ...
   protected void bringInHookedEntity() {
      ...
      if (entity != null) {
         Vector3d vector3d = (new Vector3d(entity.func_226277_ct_() - this.func_226277_ct_(), entity.func_226278_cu_() - this.func_226278_cu_(), entity.func_226281_cx_() - this.func_226281_cx_())).scale(0.1D);
