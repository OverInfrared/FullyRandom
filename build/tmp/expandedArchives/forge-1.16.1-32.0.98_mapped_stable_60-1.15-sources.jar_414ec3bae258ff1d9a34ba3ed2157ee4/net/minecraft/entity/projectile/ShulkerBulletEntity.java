...
public class ShulkerBulletEntity extends ProjectileEntity {
   ...
   private void selectNextMoveDirection(@Nullable Direction.Axis p_184569_1_) {
      ...
      if (!blockpos.withinDistance(this.getPositionVec(), 2.0D)) {
         ...
         if (p_184569_1_ != Direction.Axis.Y) {
            ...
            } else if (blockpos1.getY() > blockpos.getY() && this.world.isAirBlock(blockpos1.func_177977_b())) {
   ...
   public void tick() {
      ...
      this.setPosition(this.func_226277_ct_() + vector3d1.x, this.func_226278_cu_() + vector3d1.y, this.func_226281_cx_() + vector3d1.z);
      ProjectileHelper.rotateTowardsMovement(this, 0.5F);
      if (this.world.isRemote) {
         this.world.addParticle(ParticleTypes.END_ROD, this.func_226277_ct_() - vector3d1.x, this.func_226278_cu_() - vector3d1.y + 0.15D, this.func_226281_cx_() - vector3d1.z, 0.0D, 0.0D, 0.0D);
