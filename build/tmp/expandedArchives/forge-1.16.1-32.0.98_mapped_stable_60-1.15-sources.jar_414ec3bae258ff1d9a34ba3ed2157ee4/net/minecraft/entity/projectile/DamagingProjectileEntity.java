...
public abstract class DamagingProjectileEntity extends ProjectileEntity {
   ...
   public void tick() {
      ...
      if (this.world.isRemote || (entity == null || !entity.removed) && this.world.isBlockLoaded(this.func_233580_cy_())) {
         ...
         double d0 = this.func_226277_ct_() + vector3d.x;
         double d1 = this.func_226278_cu_() + vector3d.y;
         double d2 = this.func_226281_cx_() + vector3d.z;
   ...
   public IPacket<?> createSpawnPacket() {
      ...
      return new SSpawnObjectPacket(this.getEntityId(), this.getUniqueID(), this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), this.rotationPitch, this.rotationYaw, this.getType(), i, new Vector3d(this.accelerationX, this.accelerationY, this.accelerationZ));
   }
}