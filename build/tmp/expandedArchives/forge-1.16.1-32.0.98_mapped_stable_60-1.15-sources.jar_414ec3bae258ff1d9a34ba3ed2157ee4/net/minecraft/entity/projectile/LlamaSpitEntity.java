...
public class LlamaSpitEntity extends ProjectileEntity {
   ...
   public LlamaSpitEntity(World worldIn, LlamaEntity p_i47273_2_) {
      ...
      this.setPosition(p_i47273_2_.func_226277_ct_() - (double)(p_i47273_2_.getWidth() + 1.0F) * 0.5D * (double)MathHelper.sin(p_i47273_2_.renderYawOffset * ((float)Math.PI / 180F)), p_i47273_2_.func_226280_cw_() - (double)0.1F, p_i47273_2_.func_226281_cx_() + (double)(p_i47273_2_.getWidth() + 1.0F) * 0.5D * (double)MathHelper.cos(p_i47273_2_.renderYawOffset * ((float)Math.PI / 180F)));
   }
