...
public abstract class AbstractArrowEntity extends ProjectileEntity {
   ...
   private boolean func_234593_u_() {
      return this.inGround && this.world.func_226664_a_((new AxisAlignedBB(this.getPositionVec(), this.getPositionVec())).grow(0.06D));
   }
   ...
   protected void func_230299_a_(BlockRayTraceResult p_230299_1_) {
      ...
      Vector3d vector3d = p_230299_1_.getHitVec().subtract(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_());
      this.setMotion(vector3d);
      Vector3d vector3d1 = vector3d.normalize().scale((double)0.05F);
      this.func_226288_n_(this.func_226277_ct_() - vector3d1.x, this.func_226278_cu_() - vector3d1.y, this.func_226281_cx_() - vector3d1.z);
