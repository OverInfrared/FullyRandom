   ...
   private FullscreenResolutionOption(MainWindow p_i51745_1_, @Nullable Monitor p_i51745_2_) {
      super("options.fullscreen.resolution", -1.0D, p_i51745_2_ != null ? (double)(p_i51745_2_.getVideoModeCount() - 1) : -1.0D, 1.0F, (p_225306_2_) -> {
         ...
         if (p_i51745_2_ == null) {
            ...
            return d0 == -1.0D ? iformattabletextcomponent.func_230529_a_(new TranslationTextComponent("options.fullscreen.current")) : iformattabletextcomponent.func_240702_b_(p_i51745_2_.getVideoModeFromIndex((int)d0).toString());
         }
      });
   }
}