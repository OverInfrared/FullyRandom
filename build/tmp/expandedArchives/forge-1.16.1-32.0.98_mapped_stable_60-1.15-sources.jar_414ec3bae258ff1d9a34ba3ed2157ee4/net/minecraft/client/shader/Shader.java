...
public class Shader implements AutoCloseable {
   ...
   public void render(float partialTicks) {
      ...
      this.manager.getShaderUniform("ScreenSize").set((float)minecraft.func_228018_at_().getFramebufferWidth(), (float)minecraft.func_228018_at_().getFramebufferHeight());
      ...
      bufferbuilder.func_225582_a_(0.0D, 0.0D, 500.0D).func_225586_a_(255, 255, 255, 255).endVertex();
      bufferbuilder.func_225582_a_((double)f, 0.0D, 500.0D).func_225586_a_(255, 255, 255, 255).endVertex();
      bufferbuilder.func_225582_a_((double)f, (double)f1, 500.0D).func_225586_a_(255, 255, 255, 255).endVertex();
      bufferbuilder.func_225582_a_(0.0D, (double)f1, 500.0D).func_225586_a_(255, 255, 255, 255).endVertex();
