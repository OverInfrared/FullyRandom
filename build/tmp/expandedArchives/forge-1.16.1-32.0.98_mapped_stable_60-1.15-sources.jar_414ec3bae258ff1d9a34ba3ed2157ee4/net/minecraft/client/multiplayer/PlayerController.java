...
public class PlayerController {
   ...
   public void attackEntity(PlayerEntity playerIn, Entity targetEntity) {
      this.syncCurrentPlayItem();
      this.connection.sendPacket(new CUseEntityPacket(targetEntity, playerIn.func_225608_bj_()));
      if (this.currentGameType != GameType.SPECTATOR) {
   ...
   public ActionResultType interactWithEntity(PlayerEntity player, Entity target, Hand hand) {
      this.syncCurrentPlayItem();
      this.connection.sendPacket(new CUseEntityPacket(target, hand, player.func_225608_bj_()));
   ...
   public ActionResultType interactWithEntity(PlayerEntity player, Entity target, EntityRayTraceResult ray, Hand hand) {
      this.syncCurrentPlayItem();
      Vector3d vector3d = ray.getHitVec().subtract(target.func_226277_ct_(), target.func_226278_cu_(), target.func_226281_cx_());
      this.connection.sendPacket(new CUseEntityPacket(target, hand, vector3d, player.func_225608_bj_()));
      if (this.currentGameType == GameType.SPECTATOR) return ActionResultType.PASS; // don't fire for spectators to match non-specific EntityInteract
   ...
   public void func_225323_a(ClientWorld p_225323_1_, BlockPos p_225323_2_, BlockState p_225323_3_, CPlayerDiggingPacket.Action p_225323_4_, boolean p_225323_5_) {
      ...
      if ((posandrotation == null || !p_225323_5_ || p_225323_4_ != CPlayerDiggingPacket.Action.START_DESTROY_BLOCK && blockstate != p_225323_3_) && blockstate != p_225323_3_) {
         p_225323_1_.invalidateRegionAndSetBlock(p_225323_2_, p_225323_3_);
         if (posandrotation != null) {
            Vector3d vector3d = posandrotation.func_224783_a();
            this.mc.player.setPositionAndRotation(vector3d.x, vector3d.y, vector3d.z, posandrotation.func_224785_c(), posandrotation.func_224784_b());
         }
      }
