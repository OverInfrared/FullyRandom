...
public class ImageButton extends Button {
   ...
   public void func_230431_b_(MatrixStack p_230431_1_, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
      ...
      func_238463_a_(p_230431_1_, this.field_230690_l_, this.field_230691_m_, (float)this.xTexStart, (float)i, this.field_230688_j_, this.field_230689_k_, this.field_212935_e, this.field_212936_f);
   }
}