...
public class EditBookScreen extends Screen {
   ...
   private void func_238764_a_(Rectangle2d[] p_238764_1_) {
      ...
      for(Rectangle2d rectangle2d : p_238764_1_) {
         ...
         bufferbuilder.func_225582_a_((double)i, (double)l, 0.0D).endVertex();
         bufferbuilder.func_225582_a_((double)k, (double)l, 0.0D).endVertex();
         bufferbuilder.func_225582_a_((double)k, (double)j, 0.0D).endVertex();
         bufferbuilder.func_225582_a_((double)i, (double)j, 0.0D).endVertex();
      }
