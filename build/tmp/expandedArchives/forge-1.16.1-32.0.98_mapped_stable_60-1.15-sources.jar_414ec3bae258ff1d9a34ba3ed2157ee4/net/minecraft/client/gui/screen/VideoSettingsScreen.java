...
public class VideoSettingsScreen extends SettingsScreen {
   ...
   public VideoSettingsScreen(Screen parentScreenIn, GameSettings gameSettingsIn) {
      ...
      this.field_213108_e = gameSettingsIn.mipmapLevels;
   }
   ...
   protected void func_231160_c_() {
      ...
      this.optionsRowList.func_214333_a(new FullscreenResolutionOption(this.field_230706_i_.func_228018_at_()));
      ...
      this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 100, this.field_230709_l_ - 27, 200, 20, DialogTexts.field_240632_c_, (p_213106_1_) -> {
         ...
         this.field_230706_i_.func_228018_at_().update();
   ...
   public void func_231164_f_() {
      if (this.field_228183_b_.mipmapLevels != this.field_213108_e) {
         this.field_230706_i_.func_228020_b_(this.field_228183_b_.mipmapLevels);
   ...
   public boolean func_231044_a_(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
      ...
      GraphicsFanciness graphicsfanciness = this.field_228183_b_.field_238330_f_;
