...
public class ChatScreen extends Screen {
   ...
   protected void func_231160_c_() {
      ...
      this.field_228174_e_ = new CommandSuggestionHelper(this.field_230706_i_, this, this.inputField, this.field_230712_o_, false, false, 1, 10, true, -805306368);
   ...
   public boolean func_231046_a_(int p_231046_1_, int p_231046_2_, int p_231046_3_) {
      if (this.field_228174_e_.func_228115_a_(p_231046_1_, p_231046_2_, p_231046_3_)) {
         return true;
         ...
         if (p_231046_1_ == 265) {
            ...
            this.field_230706_i_.ingameGUI.getChatGUI().func_194813_a((double)(this.field_230706_i_.ingameGUI.getChatGUI().getLineCount() - 1));
            return true;
   ...
   public boolean func_231043_a_(double p_231043_1_, double p_231043_3_, double p_231043_5_) {
      ...
      if (this.field_228174_e_.func_228112_a_(p_231043_5_)) {
         return true;
      } else {
         if (!func_231173_s_()) {
            p_231043_5_ *= 7.0D;
         ...
         this.field_230706_i_.ingameGUI.getChatGUI().func_194813_a(p_231043_5_);
         return true;
      }
   }

   public boolean func_231044_a_(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
      if (this.field_228174_e_.func_228113_a_((double)((int)p_231044_1_), (double)((int)p_231044_3_), p_231044_5_)) {
         return true;
      } else {
         if (p_231044_5_ == 0) {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      func_238467_a_(p_230430_1_, 2, this.field_230709_l_ - 14, this.field_230708_k_ - 2, this.field_230709_l_ - 2, this.field_230706_i_.gameSettings.func_216839_a(Integer.MIN_VALUE));
      this.inputField.func_230430_a_(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      this.field_228174_e_.func_238500_a_(p_230430_1_, p_230430_2_, p_230430_3_);
