...
public class WorldLoadProgressScreen extends Screen {
   ...
   public void func_231164_f_() {
      NarratorChatListener.INSTANCE.func_216864_a((new TranslationTextComponent("narrator.loading.done")).getString());
   }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      int l = 30;
      func_238625_a_(p_230430_1_, this.field_213040_a, j, k + 30, 2, 0);
   ...
   public static void func_238625_a_(MatrixStack p_238625_0_, TrackingChunkStatusListener p_238625_1_, int p_238625_2_, int p_238625_3_, int p_238625_4_, int p_238625_5_) {
      ...
      for(int j2 = 0; j2 < l; ++j2) {
         for(int k2 = 0; k2 < l; ++k2) {
            ChunkStatus chunkstatus = p_238625_1_.func_219525_a(j2, k2);
            int l2 = j1 + j2 * i;
            int i3 = k1 + k2 * i;
