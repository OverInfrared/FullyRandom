...
public abstract class ContainerScreen<T extends Container> extends Screen implements IHasContainer<T> {
   ...
   private void func_238746_a_(MatrixStack p_238746_1_, Slot p_238746_2_) {
      ...
      if (itemstack.isEmpty() && p_238746_2_.isEnabled()) {
         ...
         if (pair != null) {
            TextureAtlasSprite textureatlassprite = this.field_230706_i_.func_228015_a_(pair.getFirst()).apply(pair.getSecond());
            this.field_230706_i_.getTextureManager().bindTexture(textureatlassprite.func_229241_m_().func_229223_g_());
