...
public abstract class Screen extends FocusableGui implements IScreen, IRenderable {
   ...
   public void renderToolTip(MatrixStack p_238654_1_, List<? extends ITextProperties> p_238654_2_, int p_238654_3_, int p_238654_4_, FontRenderer font) {
      ...
      if (false && !p_238654_2_.isEmpty()) {
         ...
         p_238654_1_.func_227861_a_(0.0D, 0.0D, 400.0D);
   ...
   public void func_231165_f_(int p_231165_1_) {
      ...
      bufferbuilder.func_225582_a_(0.0D, (double)this.field_230709_l_, 0.0D).func_225583_a_(0.0F, (float)this.field_230709_l_ / 32.0F + (float)p_231165_1_).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230708_k_, (double)this.field_230709_l_, 0.0D).func_225583_a_((float)this.field_230708_k_ / 32.0F, (float)this.field_230709_l_ / 32.0F + (float)p_231165_1_).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230708_k_, 0.0D, 0.0D).func_225583_a_((float)this.field_230708_k_ / 32.0F, (float)p_231165_1_).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_(0.0D, 0.0D, 0.0D).func_225583_a_(0.0F, (float)p_231165_1_).func_225586_a_(64, 64, 64, 255).endVertex();
      tessellator.draw();
   ...
   public static void func_231153_a_(Runnable p_231153_0_, String p_231153_1_, String p_231153_2_) {
      try {
         ...
         crashreportcategory.func_189529_a("Screen name", () -> {
            return p_231153_2_;
         });
