      ...
      public GamerulesList(final GameRules p_i232316_2_) {
         ...
         GameRules.func_223590_a(new GameRules.IRuleEntryVisitor() {
            ...
            private <T extends GameRules.RuleValue<T>> void func_239011_a_(GameRules.RuleKey<T> p_239011_1_, EditGamerulesScreen.IRuleEntry<T> p_239011_2_) {
               ...
               ITextComponent itextcomponent1 = (new StringTextComponent(p_239011_1_.func_223576_a())).func_240699_a_(TextFormatting.YELLOW);
               T t = p_i232316_2_.get(p_239011_1_);
               String s = t.func_223552_b();
         ...
         map.entrySet().stream().sorted(Map.Entry.comparingByKey()).forEach((p_239004_1_) -> {
            ...
            p_239004_1_.getValue().entrySet().stream().sorted(Map.Entry.comparingByKey(Comparator.comparing(GameRules.RuleKey::func_223576_a))).forEach((p_239005_1_) -> {
