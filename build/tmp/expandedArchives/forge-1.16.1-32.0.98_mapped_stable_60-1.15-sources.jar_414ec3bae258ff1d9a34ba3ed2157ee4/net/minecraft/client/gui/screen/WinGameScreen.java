...
public class WinGameScreen extends Screen {
   ...
   private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
      ...
      bufferbuilder.func_225582_a_(0.0D, (double)this.field_230709_l_, (double)this.func_230927_p_()).func_225583_a_(0.0F, f * 0.015625F).func_227885_a_(f3, f3, f3, 1.0F).endVertex();
      bufferbuilder.func_225582_a_((double)i, (double)this.field_230709_l_, (double)this.func_230927_p_()).func_225583_a_((float)i * 0.015625F, f * 0.015625F).func_227885_a_(f3, f3, f3, 1.0F).endVertex();
      bufferbuilder.func_225582_a_((double)i, 0.0D, (double)this.func_230927_p_()).func_225583_a_((float)i * 0.015625F, f1 * 0.015625F).func_227885_a_(f3, f3, f3, 1.0F).endVertex();
      bufferbuilder.func_225582_a_(0.0D, 0.0D, (double)this.func_230927_p_()).func_225583_a_(0.0F, f1 * 0.015625F).func_227885_a_(f3, f3, f3, 1.0F).endVertex();
      tessellator.draw();
   }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      BufferBuilder bufferbuilder = tessellator.getBuffer();
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      bufferbuilder.func_225582_a_(0.0D, (double)k1, (double)this.func_230927_p_()).func_225583_a_(0.0F, 1.0F).func_227885_a_(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      bufferbuilder.func_225582_a_((double)j1, (double)k1, (double)this.func_230927_p_()).func_225583_a_(1.0F, 1.0F).func_227885_a_(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      bufferbuilder.func_225582_a_((double)j1, 0.0D, (double)this.func_230927_p_()).func_225583_a_(1.0F, 0.0F).func_227885_a_(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      bufferbuilder.func_225582_a_(0.0D, 0.0D, (double)this.func_230927_p_()).func_225583_a_(0.0F, 0.0F).func_227885_a_(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      tessellator.draw();
      RenderSystem.disableBlend();
