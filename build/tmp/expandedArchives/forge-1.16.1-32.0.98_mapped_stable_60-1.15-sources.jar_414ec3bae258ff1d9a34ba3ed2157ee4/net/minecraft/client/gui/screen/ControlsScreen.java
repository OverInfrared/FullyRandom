...
public class ControlsScreen extends SettingsScreen {
   ...
   protected void func_231160_c_() {
      this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 155, 18, 150, 20, new TranslationTextComponent("options.mouse_settings"), (p_213126_1_) -> {
         this.field_230706_i_.displayGuiScreen(new MouseSettingsScreen(this, this.field_228183_b_));
      }));
      this.func_230480_a_(AbstractOption.AUTO_JUMP.createWidget(this.field_228183_b_, this.field_230708_k_ / 2 - 155 + 160, 18, 150));
   ...
   public boolean func_231044_a_(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
      if (this.buttonId != null) {
         this.field_228183_b_.setKeyBindingCode(this.buttonId, InputMappings.Type.MOUSE.getOrMakeInput(p_231044_5_));
         this.buttonId = null;
         KeyBinding.resetKeyBindingArrayAndHash();
         return true;
      } else {
   ...
   public boolean func_231046_a_(int p_231046_1_, int p_231046_2_, int p_231046_3_) {
      if (this.buttonId != null) {
         if (p_231046_1_ == 256) {
            ...
            this.field_228183_b_.setKeyBindingCode(this.buttonId, InputMappings.getInputByCode(p_231046_1_, p_231046_2_));
         }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      this.field_146493_s.field_230693_o_ = flag;
