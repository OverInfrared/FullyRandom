...
public class CustomizeSkinScreen extends SettingsScreen {
   ...
   protected void func_231160_c_() {
      ...
      this.func_230480_a_(new OptionButton(this.field_230708_k_ / 2 - 155 + i % 2 * 160, this.field_230709_l_ / 6 + 24 * (i >> 1), 150, 20, AbstractOption.MAIN_HAND, AbstractOption.MAIN_HAND.func_238157_c_(this.field_228183_b_), (p_213081_1_) -> {
         AbstractOption.MAIN_HAND.func_216722_a(this.field_228183_b_, 1);
         this.field_228183_b_.saveOptions();
         p_213081_1_.func_238482_a_(AbstractOption.MAIN_HAND.func_238157_c_(this.field_228183_b_));
   ...
   private ITextComponent func_238655_a_(PlayerModelPart p_238655_1_) {
      return p_238655_1_.getName().func_230532_e_().func_240702_b_(": ").func_230529_a_(DialogTexts.func_240638_a_(this.field_228183_b_.getModelParts().contains(p_238655_1_)));
   }
}