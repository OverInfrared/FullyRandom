...
public class LanguageScreen extends SettingsScreen {
   ...
   protected void func_231160_c_() {
      ...
      this.field_211832_i = this.func_230480_a_(new OptionButton(this.field_230708_k_ / 2 - 155, this.field_230709_l_ - 38, 150, 20, AbstractOption.FORCE_UNICODE_FONT, AbstractOption.FORCE_UNICODE_FONT.func_238152_c_(this.field_228183_b_), (p_213037_1_) -> {
         AbstractOption.FORCE_UNICODE_FONT.func_216740_a(this.field_228183_b_);
         this.field_228183_b_.saveOptions();
         p_213037_1_.func_238482_a_(AbstractOption.FORCE_UNICODE_FONT.func_238152_c_(this.field_228183_b_));
      ...
      this.confirmSettingsBtn = this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 155 + 160, this.field_230709_l_ - 38, 150, 20, DialogTexts.field_240632_c_, (p_213036_1_) -> {
         ...
         if (languagescreen$list$languageentry != null && !languagescreen$list$languageentry.field_214398_b.getCode().equals(this.languageManager.getCurrentLanguage().getCode())) {
            ...
            this.field_211832_i.func_238482_a_(AbstractOption.FORCE_UNICODE_FONT.func_238152_c_(this.field_228183_b_));
            this.field_228183_b_.saveOptions();
         }

         this.field_230706_i_.displayGuiScreen(this.field_228182_a_);
      }));
   ...
   class List extends ExtendedList<LanguageScreen.List.LanguageEntry> {
      ...
      public void func_241215_a_(@Nullable LanguageScreen.List.LanguageEntry p_241215_1_) {
         ...
         if (p_241215_1_ != null) {
            NarratorChatListener.INSTANCE.func_216864_a((new TranslationTextComponent("narrator.select", p_241215_1_.field_214398_b)).getString());
         }
