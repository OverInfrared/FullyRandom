...
public abstract class AbstractList<E extends AbstractList.AbstractListEntry<E>> extends FocusableGui implements IRenderable {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, (double)this.field_230673_j_, 0.0D).func_225583_a_((float)this.field_230675_l_ / 32.0F, (float)(this.field_230673_j_ + (int)this.func_230966_l_()) / 32.0F).func_225586_a_(32, 32, 32, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230674_k_, (double)this.field_230673_j_, 0.0D).func_225583_a_((float)this.field_230674_k_ / 32.0F, (float)(this.field_230673_j_ + (int)this.func_230966_l_()) / 32.0F).func_225586_a_(32, 32, 32, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230674_k_, (double)this.field_230672_i_, 0.0D).func_225583_a_((float)this.field_230674_k_ / 32.0F, (float)(this.field_230672_i_ + (int)this.func_230966_l_()) / 32.0F).func_225586_a_(32, 32, 32, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, (double)this.field_230672_i_, 0.0D).func_225583_a_((float)this.field_230675_l_ / 32.0F, (float)(this.field_230672_i_ + (int)this.func_230966_l_()) / 32.0F).func_225586_a_(32, 32, 32, 255).endVertex();
      tessellator.draw();
      ...
      int i1 = -100;
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, (double)this.field_230672_i_, -100.0D).func_225583_a_(0.0F, (float)this.field_230672_i_ / 32.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)(this.field_230675_l_ + this.field_230670_d_), (double)this.field_230672_i_, -100.0D).func_225583_a_((float)this.field_230670_d_ / 32.0F, (float)this.field_230672_i_ / 32.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)(this.field_230675_l_ + this.field_230670_d_), 0.0D, -100.0D).func_225583_a_((float)this.field_230670_d_ / 32.0F, 0.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, 0.0D, -100.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, (double)this.field_230671_e_, -100.0D).func_225583_a_(0.0F, (float)this.field_230671_e_ / 32.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)(this.field_230675_l_ + this.field_230670_d_), (double)this.field_230671_e_, -100.0D).func_225583_a_((float)this.field_230670_d_ / 32.0F, (float)this.field_230671_e_ / 32.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)(this.field_230675_l_ + this.field_230670_d_), (double)this.field_230673_j_, -100.0D).func_225583_a_((float)this.field_230670_d_ / 32.0F, (float)this.field_230673_j_ / 32.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, (double)this.field_230673_j_, -100.0D).func_225583_a_(0.0F, (float)this.field_230673_j_ / 32.0F).func_225586_a_(64, 64, 64, 255).endVertex();
      tessellator.draw();
      ...
      int j1 = 4;
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, (double)(this.field_230672_i_ + 4), 0.0D).func_225583_a_(0.0F, 1.0F).func_225586_a_(0, 0, 0, 0).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230674_k_, (double)(this.field_230672_i_ + 4), 0.0D).func_225583_a_(1.0F, 1.0F).func_225586_a_(0, 0, 0, 0).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230674_k_, (double)this.field_230672_i_, 0.0D).func_225583_a_(1.0F, 0.0F).func_225586_a_(0, 0, 0, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, (double)this.field_230672_i_, 0.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(0, 0, 0, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, (double)this.field_230673_j_, 0.0D).func_225583_a_(0.0F, 1.0F).func_225586_a_(0, 0, 0, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230674_k_, (double)this.field_230673_j_, 0.0D).func_225583_a_(1.0F, 1.0F).func_225586_a_(0, 0, 0, 255).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230674_k_, (double)(this.field_230673_j_ - 4), 0.0D).func_225583_a_(1.0F, 0.0F).func_225586_a_(0, 0, 0, 0).endVertex();
      bufferbuilder.func_225582_a_((double)this.field_230675_l_, (double)(this.field_230673_j_ - 4), 0.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(0, 0, 0, 0).endVertex();
      tessellator.draw();
      ...
      if (k1 > 0) {
         ...
         bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
         bufferbuilder.func_225582_a_((double)i, (double)this.field_230673_j_, 0.0D).func_225583_a_(0.0F, 1.0F).func_225586_a_(0, 0, 0, 255).endVertex();
         bufferbuilder.func_225582_a_((double)j, (double)this.field_230673_j_, 0.0D).func_225583_a_(1.0F, 1.0F).func_225586_a_(0, 0, 0, 255).endVertex();
         bufferbuilder.func_225582_a_((double)j, (double)this.field_230672_i_, 0.0D).func_225583_a_(1.0F, 0.0F).func_225586_a_(0, 0, 0, 255).endVertex();
         bufferbuilder.func_225582_a_((double)i, (double)this.field_230672_i_, 0.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(0, 0, 0, 255).endVertex();
         bufferbuilder.func_225582_a_((double)i, (double)(i2 + l1), 0.0D).func_225583_a_(0.0F, 1.0F).func_225586_a_(128, 128, 128, 255).endVertex();
         bufferbuilder.func_225582_a_((double)j, (double)(i2 + l1), 0.0D).func_225583_a_(1.0F, 1.0F).func_225586_a_(128, 128, 128, 255).endVertex();
         bufferbuilder.func_225582_a_((double)j, (double)i2, 0.0D).func_225583_a_(1.0F, 0.0F).func_225586_a_(128, 128, 128, 255).endVertex();
         bufferbuilder.func_225582_a_((double)i, (double)i2, 0.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(128, 128, 128, 255).endVertex();
         bufferbuilder.func_225582_a_((double)i, (double)(i2 + l1 - 1), 0.0D).func_225583_a_(0.0F, 1.0F).func_225586_a_(192, 192, 192, 255).endVertex();
         bufferbuilder.func_225582_a_((double)(j - 1), (double)(i2 + l1 - 1), 0.0D).func_225583_a_(1.0F, 1.0F).func_225586_a_(192, 192, 192, 255).endVertex();
         bufferbuilder.func_225582_a_((double)(j - 1), (double)i2, 0.0D).func_225583_a_(1.0F, 0.0F).func_225586_a_(192, 192, 192, 255).endVertex();
         bufferbuilder.func_225582_a_((double)i, (double)i2, 0.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(192, 192, 192, 255).endVertex();
         tessellator.draw();
      }
