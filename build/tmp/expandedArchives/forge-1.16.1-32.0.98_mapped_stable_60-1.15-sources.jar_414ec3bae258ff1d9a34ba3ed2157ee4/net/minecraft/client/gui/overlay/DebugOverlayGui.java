...
public class DebugOverlayGui extends AbstractGui {
         ...
         if (this.mc.world != null) {
            if (this.mc.world.isBlockLoaded(blockpos)) {
               ...
               if (chunk.isEmpty()) {
                  ...
                  int i = this.mc.world.getChunkProvider().func_212863_j_().func_227470_b_(blockpos, 0);
         ...
         if (serverworld != null) {
            ...
            if (worldentityspawner$entitydensitymanager != null) {
               ...
               list.add("SC: " + l + ", " + (String)Stream.of(EntityClassification.values()).map((p_238511_1_) -> {
                  return Character.toUpperCase(p_238511_1_.func_220363_a().charAt(0)) + ": " + object2intmap.getInt(p_238511_1_);
   ...
   private ServerWorld func_238515_d_() {
      IntegratedServer integratedserver = this.mc.getIntegratedServer();
      return integratedserver != null ? integratedserver.func_71218_a(this.mc.world.func_234923_W_()) : null;
   }
   ...
   private World func_212922_g() {
      return DataFixUtils.orElse(Optional.ofNullable(this.mc.getIntegratedServer()).flatMap((p_212917_1_) -> {
         return Optional.ofNullable(p_212917_1_.func_71218_a(this.mc.world.func_234923_W_()));
      }), this.mc.world);
   }
   ...
   private void func_238509_a_(MatrixStack p_238509_1_, FrameTimer p_238509_2_, int p_238509_3_, int p_238509_4_, boolean p_238509_5_) {
      ...
      for(Matrix4f matrix4f = TransformationMatrix.func_227983_a_().func_227988_c_(); lvt_9_1_ != j; lvt_9_1_ = p_238509_2_.parseIndex(lvt_9_1_ + 1)) {
