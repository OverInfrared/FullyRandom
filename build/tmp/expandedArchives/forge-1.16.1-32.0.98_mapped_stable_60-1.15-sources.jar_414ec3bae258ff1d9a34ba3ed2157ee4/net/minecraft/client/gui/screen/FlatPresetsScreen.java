...
public class FlatPresetsScreen extends Screen {
   ...
   class SlotList extends ExtendedList<FlatPresetsScreen.SlotList.PresetEntry> {
      ...
      public void func_241215_a_(@Nullable FlatPresetsScreen.SlotList.PresetEntry p_241215_1_) {
         ...
         if (p_241215_1_ != null) {
            NarratorChatListener.INSTANCE.func_216864_a((new TranslationTextComponent("narrator.select", FlatPresetsScreen.FLAT_WORLD_PRESETS.get(this.func_231039_at__().indexOf(p_241215_1_)).func_238644_a_())).getString());
         }
