...
public class SubtitleOverlayGui extends AbstractGui implements ISoundEventListener {
   ...
   public void render(MatrixStack p_195620_1_) {
      ...
      if (this.enabled && !this.subtitles.isEmpty()) {
         ...
         Vector3d vector3d = new Vector3d(this.client.player.func_226277_ct_(), this.client.player.func_226280_cw_(), this.client.player.func_226281_cx_());
         ...
         for(SubtitleOverlayGui.Subtitle subtitleoverlaygui$subtitle1 : this.subtitles) {
            ...
            func_238467_a_(p_195620_1_, -l - 1, -j1 - 1, l + 1, j1 + 1, this.client.gameSettings.func_216841_b(0.8F));
            RenderSystem.enableBlend();
            if (!flag) {
               if (d0 > 0.0D) {
