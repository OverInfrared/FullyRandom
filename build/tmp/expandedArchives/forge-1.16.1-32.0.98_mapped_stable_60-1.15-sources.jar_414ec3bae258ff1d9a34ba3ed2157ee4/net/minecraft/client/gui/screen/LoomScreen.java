...
public class LoomScreen extends ContainerScreen<LoomContainer> {
   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      if (this.field_230155_n_ != null && !this.field_214125_w) {
         ...
         p_230450_1_.func_227861_a_((double)(i + 139), (double)(j + 52), 0.0D);
         p_230450_1_.func_227862_a_(24.0F, -24.0F, 1.0F);
         p_230450_1_.func_227861_a_(0.5D, 0.5D, 0.5D);
         float f = 0.6666667F;
         p_230450_1_.func_227862_a_(0.6666667F, -0.6666667F, -0.6666667F);
         this.field_228188_m_.rotateAngleX = 0.0F;
         this.field_228188_m_.rotationPointY = -32.0F;
         BannerTileEntityRenderer.func_230180_a_(p_230450_1_, irendertypebuffer$impl, 15728880, OverlayTexture.field_229196_a_, this.field_228188_m_, ModelBakery.field_229315_f_, true, this.field_230155_n_);
   ...
   private void func_228190_b_(int p_228190_1_, int p_228190_2_, int p_228190_3_) {
      ...
      BannerTileEntityRenderer.func_230180_a_(matrixstack, irendertypebuffer$impl, 15728880, OverlayTexture.field_229196_a_, this.field_228188_m_, ModelBakery.field_229315_f_, true, list);
