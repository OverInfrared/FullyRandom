...
public class OptionsSoundsScreen extends SettingsScreen {
   ...
   protected void func_231160_c_() {
      ...
      ++i;
      this.func_230480_a_(new OptionButton(j, k + 24 * (i >> 1), 150, 20, AbstractOption.SHOW_SUBTITLES, AbstractOption.SHOW_SUBTITLES.func_238152_c_(this.field_228183_b_), (p_213105_1_) -> {
         AbstractOption.SHOW_SUBTITLES.func_216740_a(this.field_230706_i_.gameSettings);
