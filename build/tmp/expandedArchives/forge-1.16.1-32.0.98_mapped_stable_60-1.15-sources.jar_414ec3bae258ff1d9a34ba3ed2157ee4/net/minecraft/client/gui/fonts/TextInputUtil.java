...
public class TextInputUtil {
   ...
   public TextInputUtil(Supplier<String> p_i232265_1_, Consumer<String> p_i232265_2_, Supplier<String> p_i232265_3_, Consumer<String> p_i232265_4_, Predicate<String> p_i232265_5_) {
      this.field_216902_c = p_i232265_1_;
      this.field_216903_d = p_i232265_2_;
   ...
   public boolean func_216894_a(char p_216894_1_) {
      if (SharedConstants.isAllowedCharacter(p_216894_1_)) {
         this.func_238572_a_(this.field_216902_c.get(), Character.toString(p_216894_1_));
      }
   ...
   private int func_238589_g_(int p_238589_1_) {
      return MathHelper.clamp(p_238589_1_, 0, this.field_216902_c.get().length());
   }
   ...
   public void func_216892_a(String p_216892_1_) {
      this.func_238572_a_(this.field_216902_c.get(), p_216892_1_);
   }
   ...
   public void func_238569_a_(int p_238569_1_, boolean p_238569_2_) {
      this.field_216905_f = Util.func_240980_a_(this.field_216902_c.get(), this.field_216905_f, p_238569_1_);
      this.func_238573_a_(p_238569_2_);
   }

   public void func_238575_b_(int p_238575_1_, boolean p_238575_2_) {
      this.field_216905_f = CharacterManager.func_238351_a_(this.field_216902_c.get(), p_238575_1_, this.field_216905_f, true);
   ...
   public void func_238567_a_() {
      ...
      this.field_216903_d.accept(this.func_238583_c_(s));
   }

   public void func_238574_b_() {
      this.func_238572_a_(this.field_216902_c.get(), this.field_238564_c_.get());
      this.field_216906_g = this.field_216905_f;
   }

   public void func_238580_c_() {
      this.field_238565_d_.accept(this.func_238578_b_(this.field_216902_c.get()));
   }
   ...
   public void func_238568_a_(int p_238568_1_, int p_238568_2_) {
      int i = this.field_216902_c.get().length();
