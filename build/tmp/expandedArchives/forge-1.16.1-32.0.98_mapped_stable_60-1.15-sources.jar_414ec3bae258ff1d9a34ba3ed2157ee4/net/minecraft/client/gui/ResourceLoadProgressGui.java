...
public class ResourceLoadProgressGui extends LoadingGui {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      int j2 = (int)((double)this.mc.func_228018_at_().getScaledWidth() * 0.5D);
      int i1 = (int)((double)this.mc.func_228018_at_().getScaledHeight() * 0.5D);
      double d0 = Math.min((double)this.mc.func_228018_at_().getScaledWidth() * 0.75D, (double)this.mc.func_228018_at_().getScaledHeight()) * 0.25D;
      int j1 = (int)(d0 * 0.5D);
      double d1 = d0 * 4.0D;
      int k1 = (int)(d1 * 0.5D);
      ...
      int l1 = (int)((double)this.mc.func_228018_at_().getScaledHeight() * 0.8325D);
      ...
      if (this.field_212979_g == -1L && this.asyncReloader.fullyDone() && (!this.reloading || f1 >= 2.0F)) {
         this.field_212979_g = Util.milliTime(); // Moved up to guard against inf loops caused by callback
         try {
         ...
         if (this.mc.currentScreen != null) {
            this.mc.currentScreen.func_231158_b_(this.mc, this.mc.func_228018_at_().getScaledWidth(), this.mc.func_228018_at_().getScaledHeight());
         }
      }
   ...
   private void func_238629_a_(MatrixStack p_238629_1_, int p_238629_2_, int p_238629_3_, int p_238629_4_, int p_238629_5_, float p_238629_6_) {
      int i = MathHelper.ceil((float)(p_238629_4_ - p_238629_2_ - 2) * this.field_212978_f);
