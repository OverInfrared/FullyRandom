...
public class EnchantmentScreen extends ContainerScreen<EnchantmentContainer> {
   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      int k = (int)this.field_230706_i_.func_228018_at_().getGuiScaleFactor();
      ...
      MatrixStack.Entry matrixstack$entry = p_230450_1_.func_227866_c_();
      matrixstack$entry.func_227870_a_().func_226591_a_();
      matrixstack$entry.func_227872_b_().func_226119_c_();
      p_230450_1_.func_227861_a_(0.0D, (double)3.3F, 1984.0D);
      float f = 5.0F;
      p_230450_1_.func_227862_a_(5.0F, 5.0F, 5.0F);
      p_230450_1_.func_227863_a_(Vector3f.field_229183_f_.func_229187_a_(180.0F));
      p_230450_1_.func_227863_a_(Vector3f.field_229179_b_.func_229187_a_(20.0F));
      float f1 = MathHelper.lerp(p_230450_2_, this.oOpen, this.open);
      p_230450_1_.func_227861_a_((double)((1.0F - f1) * 0.2F), (double)((1.0F - f1) * 0.1F), (double)((1.0F - f1) * 0.25F));
      float f2 = -(1.0F - f1) * 90.0F - 90.0F;
      p_230450_1_.func_227863_a_(Vector3f.field_229181_d_.func_229187_a_(f2));
      p_230450_1_.func_227863_a_(Vector3f.field_229179_b_.func_229187_a_(180.0F));
      ...
      MODEL_BOOK.func_225598_a_(p_230450_1_, ivertexbuilder, 15728880, OverlayTexture.field_229196_a_, 1.0F, 1.0F, 1.0F, 1.0F);
      irendertypebuffer$impl.func_228461_a_();
      p_230450_1_.func_227865_b_();
      RenderSystem.matrixMode(5889);
      RenderSystem.viewport(0, 0, this.field_230706_i_.func_228018_at_().getFramebufferWidth(), this.field_230706_i_.func_228018_at_().getFramebufferHeight());
