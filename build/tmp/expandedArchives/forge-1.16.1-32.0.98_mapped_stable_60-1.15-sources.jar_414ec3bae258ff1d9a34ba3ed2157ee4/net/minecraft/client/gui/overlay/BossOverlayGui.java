      ...
      if (!this.mapBossInfos.isEmpty()) {
         ...
         for(ClientBossInfo clientbossinfo : this.mapBossInfos.values()) {
            ...
            net.minecraftforge.client.event.RenderGameOverlayEvent.BossInfo event =
               net.minecraftforge.client.ForgeHooksClient.bossBarRenderPre(p_238484_1_, this.client.func_228018_at_(), clientbossinfo, k, j, 10 + this.client.fontRenderer.FONT_HEIGHT);
            if (!event.isCanceled()) {
            ...
            net.minecraftforge.client.ForgeHooksClient.bossBarRenderPost(p_238484_1_, this.client.func_228018_at_());
