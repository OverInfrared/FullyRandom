...
public class CreativeScreen extends DisplayEffectsScreen<CreativeScreen.CreativeContainer> {
   ...
   protected void func_230450_a_(MatrixStack p_230450_1_, float p_230450_2_, int p_230450_3_, int p_230450_4_) {
      ...
      if (itemgroup == ItemGroup.INVENTORY) {
         InventoryScreen.func_228187_a_(this.guiLeft + 88, this.guiTop + 45, 20, (float)(this.guiLeft + 88 - p_230450_3_), (float)(this.guiTop + 45 - 30 - p_230450_4_), this.field_230706_i_.player);
      }
