...
public abstract class AbstractFurnaceScreen<T extends AbstractFurnaceContainer> extends ContainerScreen<T> implements IRecipeShownListener {
   ...
   public void func_231160_c_() {
      ...
      this.field_214090_m = this.field_230708_k_ < 379;
      this.recipeGui.init(this.field_230708_k_, this.field_230709_l_, this.field_230706_i_, this.field_214090_m, this.container);
      this.guiLeft = this.recipeGui.updateScreenPosition(this.field_214090_m, this.field_230708_k_, this.xSize);
   ...
   public boolean func_231044_a_(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
      if (this.recipeGui.func_231044_a_(p_231044_1_, p_231044_3_, p_231044_5_)) {
         ...
         return this.field_214090_m && this.recipeGui.isVisible() ? true : super.func_231044_a_(p_231044_1_, p_231044_3_, p_231044_5_);
      }
   }
