...
public class InputMappings {
   ...
   public static enum Type {
      ...
      MOUSE("key.mouse", (p_237524_0_, p_237524_1_) -> {
         return LanguageMap.func_74808_a().func_230506_b_(p_237524_1_) ? new TranslationTextComponent(p_237524_1_) : new TranslationTextComponent("key.mouse", p_237524_0_ + 1);
      });
