...
public class MinecartRenderer<T extends AbstractMinecartEntity> extends EntityRenderer<T> {
   ...
   public void func_225623_a_(T p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      if (vector3d != null) {
         Vector3d vector3d1 = p_225623_1_.getPosOffset(d0, d1, d2, (double)0.3F);
         Vector3d vector3d2 = p_225623_1_.getPosOffset(d0, d1, d2, (double)-0.3F);
         if (vector3d1 == null) {
            vector3d1 = vector3d;
         }
         ...
         p_225623_4_.func_227861_a_(vector3d.x - d0, (vector3d1.y + vector3d2.y) / 2.0D - d1, vector3d.z - d2);
