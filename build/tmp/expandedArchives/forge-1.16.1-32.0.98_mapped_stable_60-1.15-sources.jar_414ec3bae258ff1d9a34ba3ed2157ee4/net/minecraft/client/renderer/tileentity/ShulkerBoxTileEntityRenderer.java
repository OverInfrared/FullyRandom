...
public class ShulkerBoxTileEntityRenderer extends TileEntityRenderer<ShulkerBoxTileEntity> {
   ...
   public void func_225616_a_(ShulkerBoxTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      ...
      if (dyecolor == null) {
         rendermaterial = Atlases.field_228748_g_;
      } else {
         rendermaterial = Atlases.field_228749_h_.get(dyecolor.getId());
      }
      ...
      IVertexBuilder ivertexbuilder = rendermaterial.func_229311_a_(p_225616_4_, RenderType::func_228640_c_);
      this.model.func_205069_a().func_228308_a_(p_225616_3_, ivertexbuilder, p_225616_5_, p_225616_6_);
      ...
      this.model.func_205068_b().func_228308_a_(p_225616_3_, ivertexbuilder, p_225616_5_, p_225616_6_);
