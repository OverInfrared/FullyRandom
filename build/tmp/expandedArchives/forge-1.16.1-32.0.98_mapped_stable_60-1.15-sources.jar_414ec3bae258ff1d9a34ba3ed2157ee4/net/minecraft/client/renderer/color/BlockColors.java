...
public class BlockColors {
   ...
   public static BlockColors init() {
      ...
      blockcolors.register((p_228065_0_, p_228065_1_, p_228065_2_, p_228065_3_) -> {
         return p_228065_1_ != null && p_228065_2_ != null ? BiomeColors.func_228358_a_(p_228065_1_, p_228065_0_.get(DoublePlantBlock.HALF) == DoubleBlockHalf.UPPER ? p_228065_2_.func_177977_b() : p_228065_2_) : -1;
      }, Blocks.LARGE_FERN, Blocks.TALL_GRASS);
      blockcolors.func_225308_a(DoublePlantBlock.HALF, Blocks.LARGE_FERN, Blocks.TALL_GRASS);
   ...
   private void func_225309_a(Set<Property<?>> p_225309_1_, Block... p_225309_2_) {
   ...
   private void func_225308_a(Property<?> p_225308_1_, Block... p_225308_2_) {
      this.func_225309_a(ImmutableSet.of(p_225308_1_), p_225308_2_);
   }

   public Set<Property<?>> func_225310_a(Block p_225310_1_) {
