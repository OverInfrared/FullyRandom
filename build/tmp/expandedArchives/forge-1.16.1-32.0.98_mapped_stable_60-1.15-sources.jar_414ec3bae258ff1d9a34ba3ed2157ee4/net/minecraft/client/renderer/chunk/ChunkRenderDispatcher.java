...
public class ChunkRenderDispatcher {
   ...
   private Vector3d field_217672_l = Vector3d.ZERO;
   ...
   public class ChunkRender implements net.minecraftforge.client.extensions.IForgeRenderChunk {
      ...
      public void setPosition(int x, int y, int z) {
         if (x != this.position.getX() || y != this.position.getY() || z != this.position.getZ()) {
            ...
            for(Direction direction : Direction.values()) {
               this.mapEnumFacing[direction.ordinal()].func_189533_g(this.position).func_189534_c(direction, 16);
            }
      ...
      public ChunkRenderDispatcher.CompiledChunk func_178571_g() {
      ...
      public boolean func_228925_a_(RenderType p_228925_1_, ChunkRenderDispatcher p_228925_2_) {
         ChunkRenderDispatcher.CompiledChunk chunkrenderdispatcher$compiledchunk = this.func_178571_g();
      ...
      public ChunkRenderDispatcher.ChunkRender.ChunkRenderTask func_178574_d() {
         this.func_228935_i_();
      ...
      public void func_228929_a_(ChunkRenderDispatcher p_228929_1_) {
         ChunkRenderDispatcher.ChunkRender.ChunkRenderTask chunkrenderdispatcher$chunkrender$chunkrendertask = this.func_178574_d();
            ...
            if (chunkrendercache != null) {
               ...
               for(BlockPos blockpos2 : BlockPos.getAllInBoxMutable(blockpos, blockpos1)) {
                  ...
                  if (!fluidstate.isEmpty() && RenderTypeLookup.canRenderInLayer(fluidstate, rendertype)) {
                     ...
                     if (blockrendererdispatcher.func_228794_a_(blockpos2, chunkrendercache, bufferbuilder, fluidstate)) {
