...
public class BufferBuilder extends DefaultColorVertexBuilder implements IVertexConsumer {
   ...
   private void func_227829_a_(FloatBuffer p_227829_1_, int p_227829_2_) {
      ...
      ((Buffer)p_227829_1_).limit(this.field_227823_k_ / 4 + (p_227829_2_ + 1) * i);
      ((Buffer)p_227829_1_).position(this.field_227823_k_ / 4 + p_227829_2_ * i);
   }

   public BufferBuilder.State getVertexState() {
      ((Buffer)this.byteBuffer).limit(this.field_227824_l_);
      ((Buffer)this.byteBuffer).position(this.field_227823_k_);
