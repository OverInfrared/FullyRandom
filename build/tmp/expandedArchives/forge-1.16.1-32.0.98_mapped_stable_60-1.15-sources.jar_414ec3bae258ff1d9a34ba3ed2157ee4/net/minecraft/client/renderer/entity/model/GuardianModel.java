...
public class GuardianModel extends SegmentedModel<GuardianEntity> {
   ...
   public GuardianModel() {
      ...
      this.guardianBody.func_78784_a(0, 0).func_228300_a_(-6.0F, 10.0F, -8.0F, 12.0F, 12.0F, 16.0F);
      this.guardianBody.func_78784_a(0, 28).func_228300_a_(-8.0F, 10.0F, -6.0F, 2.0F, 12.0F, 12.0F);
      this.guardianBody.func_78784_a(0, 28).func_228304_a_(6.0F, 10.0F, -6.0F, 2.0F, 12.0F, 12.0F, true);
      this.guardianBody.func_78784_a(16, 40).func_228300_a_(-6.0F, 8.0F, -6.0F, 12.0F, 2.0F, 12.0F);
      this.guardianBody.func_78784_a(16, 40).func_228300_a_(-6.0F, 22.0F, -6.0F, 12.0F, 2.0F, 12.0F);
      ...
      this.guardianTail[2].func_78784_a(41, 32).func_228300_a_(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F);
      this.guardianTail[2].func_78784_a(25, 19).func_228300_a_(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F);
   ...
   public void func_225597_a_(GuardianEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      if (entity != null) {
         ...
         Vector3d vector3d2 = p_225597_1_.getLook(0.0F);
