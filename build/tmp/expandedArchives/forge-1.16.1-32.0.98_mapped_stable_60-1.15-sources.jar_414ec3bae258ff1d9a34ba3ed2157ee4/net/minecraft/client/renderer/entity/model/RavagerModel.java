...
public class RavagerModel extends SegmentedModel<RavagerEntity> {
   ...
   public RavagerModel() {
      ...
      this.field_217175_k.func_78784_a(68, 73).func_228301_a_(-5.0F, -1.0F, -18.0F, 10.0F, 10.0F, 18.0F, 0.0F);
      this.field_217168_a = new ModelRenderer(this);
      this.field_217168_a.setRotationPoint(0.0F, 16.0F, -17.0F);
      this.field_217168_a.func_78784_a(0, 0).func_228301_a_(-8.0F, -20.0F, -14.0F, 16.0F, 20.0F, 16.0F, 0.0F);
      this.field_217168_a.func_78784_a(0, 0).func_228301_a_(-2.0F, -6.0F, -18.0F, 4.0F, 8.0F, 4.0F, 0.0F);
      ...
      this.field_217168_a.func_78792_a(modelrenderer);
      ...
      this.field_217168_a.func_78792_a(modelrenderer1);
      this.field_217169_b = new ModelRenderer(this);
      this.field_217169_b.setRotationPoint(0.0F, -2.0F, 2.0F);
      this.field_217169_b.func_78784_a(0, 36).func_228301_a_(-8.0F, 0.0F, -16.0F, 16.0F, 3.0F, 16.0F, 0.0F);
      this.field_217168_a.func_78792_a(this.field_217169_b);
      this.field_217175_k.func_78792_a(this.field_217168_a);
      this.field_217170_f = new ModelRenderer(this);
      this.field_217170_f.func_78784_a(0, 55).func_228301_a_(-7.0F, -10.0F, -7.0F, 14.0F, 16.0F, 20.0F, 0.0F);
      this.field_217170_f.func_78784_a(0, 91).func_228301_a_(-6.0F, 6.0F, -7.0F, 12.0F, 13.0F, 18.0F, 0.0F);
