   ...
   public void func_225623_a_(FishingBobberEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      if (playerentity != null) {
         ...
         if ((this.renderManager.options == null || this.renderManager.options.thirdPersonView <= 0) && playerentity == Minecraft.getInstance().player) {
            ...
            vector3d = vector3d.rotatePitch(-MathHelper.lerp(p_225623_3_, playerentity.prevRotationPitch, playerentity.rotationPitch) * ((float)Math.PI / 180F));
            vector3d = vector3d.rotateYaw(-MathHelper.lerp(p_225623_3_, playerentity.prevRotationYaw, playerentity.rotationYaw) * ((float)Math.PI / 180F));
            vector3d = vector3d.rotateYaw(f1 * 0.5F);
            vector3d = vector3d.rotatePitch(-f1 * 0.7F);
            d4 = MathHelper.lerp((double)p_225623_3_, playerentity.prevPosX, playerentity.func_226277_ct_()) + vector3d.x;
            d5 = MathHelper.lerp((double)p_225623_3_, playerentity.prevPosY, playerentity.func_226278_cu_()) + vector3d.y;
            d6 = MathHelper.lerp((double)p_225623_3_, playerentity.prevPosZ, playerentity.func_226281_cx_()) + vector3d.z;
