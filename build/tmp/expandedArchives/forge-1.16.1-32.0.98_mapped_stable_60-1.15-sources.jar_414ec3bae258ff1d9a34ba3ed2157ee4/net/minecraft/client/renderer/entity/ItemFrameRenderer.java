...
public class ItemFrameRenderer extends EntityRenderer<ItemFrameEntity> {
   ...
   public void func_225623_a_(ItemFrameEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      Vector3d vector3d = this.func_225627_b_(p_225623_1_, p_225623_3_);
      p_225623_4_.func_227861_a_(-vector3d.getX(), -vector3d.getY(), -vector3d.getZ());
      double d0 = 0.46875D;
   ...
   public Vector3d func_225627_b_(ItemFrameEntity p_225627_1_, float p_225627_2_) {
   ...
   protected void func_225629_a_(ItemFrameEntity p_225629_1_, ITextComponent p_225629_2_, MatrixStack p_225629_3_, IRenderTypeBuffer p_225629_4_, int p_225629_5_) {
      super.func_225629_a_(p_225629_1_, p_225629_1_.getDisplayedItem().getDisplayName(), p_225629_3_, p_225629_4_, p_225629_5_);
   }
}