...
public class BipedModel<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead {
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      boolean flag1 = p_225597_1_.isActualySwimming();
      this.bipedHead.rotateAngleY = p_225597_5_ * ((float)Math.PI / 180F);
      if (flag) {
         this.bipedHead.rotateAngleX = (-(float)Math.PI / 4F);
      } else if (this.swimAnimation > 0.0F) {
         if (flag1) {
            this.bipedHead.rotateAngleX = this.func_205060_a(this.swimAnimation, this.bipedHead.rotateAngleX, (-(float)Math.PI / 4F));
         } else {
            this.bipedHead.rotateAngleX = this.func_205060_a(this.swimAnimation, this.bipedHead.rotateAngleX, p_225597_6_ * ((float)Math.PI / 180F));
         }
      } else {
      ...
      boolean flag2 = p_225597_1_.getPrimaryHand() == HandSide.RIGHT;
      ...
      if (this.swimAnimation > 0.0F) {
         ...
         if (f1 < 14.0F) {
            this.bipedLeftArm.rotateAngleX = this.func_205060_a(f3, this.bipedLeftArm.rotateAngleX, 0.0F);
            this.bipedRightArm.rotateAngleX = MathHelper.lerp(f2, this.bipedRightArm.rotateAngleX, 0.0F);
            this.bipedLeftArm.rotateAngleY = this.func_205060_a(f3, this.bipedLeftArm.rotateAngleY, (float)Math.PI);
            this.bipedRightArm.rotateAngleY = MathHelper.lerp(f2, this.bipedRightArm.rotateAngleY, (float)Math.PI);
            this.bipedLeftArm.rotateAngleZ = this.func_205060_a(f3, this.bipedLeftArm.rotateAngleZ, (float)Math.PI + 1.8707964F * this.func_203068_a(f1) / this.func_203068_a(14.0F));
            this.bipedRightArm.rotateAngleZ = MathHelper.lerp(f2, this.bipedRightArm.rotateAngleZ, (float)Math.PI - 1.8707964F * this.func_203068_a(f1) / this.func_203068_a(14.0F));
         } else if (f1 >= 14.0F && f1 < 22.0F) {
            float f6 = (f1 - 14.0F) / 8.0F;
            this.bipedLeftArm.rotateAngleX = this.func_205060_a(f3, this.bipedLeftArm.rotateAngleX, ((float)Math.PI / 2F) * f6);
            this.bipedRightArm.rotateAngleX = MathHelper.lerp(f2, this.bipedRightArm.rotateAngleX, ((float)Math.PI / 2F) * f6);
            this.bipedLeftArm.rotateAngleY = this.func_205060_a(f3, this.bipedLeftArm.rotateAngleY, (float)Math.PI);
            this.bipedRightArm.rotateAngleY = MathHelper.lerp(f2, this.bipedRightArm.rotateAngleY, (float)Math.PI);
            this.bipedLeftArm.rotateAngleZ = this.func_205060_a(f3, this.bipedLeftArm.rotateAngleZ, 5.012389F - 1.8707964F * f6);
            ...
            this.bipedLeftArm.rotateAngleX = this.func_205060_a(f3, this.bipedLeftArm.rotateAngleX, ((float)Math.PI / 2F) - ((float)Math.PI / 2F) * f4);
            this.bipedRightArm.rotateAngleX = MathHelper.lerp(f2, this.bipedRightArm.rotateAngleX, ((float)Math.PI / 2F) - ((float)Math.PI / 2F) * f4);
            this.bipedLeftArm.rotateAngleY = this.func_205060_a(f3, this.bipedLeftArm.rotateAngleY, (float)Math.PI);
            this.bipedRightArm.rotateAngleY = MathHelper.lerp(f2, this.bipedRightArm.rotateAngleY, (float)Math.PI);
            this.bipedLeftArm.rotateAngleZ = this.func_205060_a(f3, this.bipedLeftArm.rotateAngleZ, (float)Math.PI);
   ...
   protected void func_230486_a_(T p_230486_1_, float p_230486_2_) {
      if (!(this.swingProgress <= 0.0F)) {
         HandSide handside = this.func_217147_a(p_230486_1_);
   ...
   public void func_217148_a(BipedModel<T> p_217148_1_) {
      ...
      p_217148_1_.bipedHead.func_217177_a(this.bipedHead);
      p_217148_1_.bipedHeadwear.func_217177_a(this.bipedHeadwear);
      p_217148_1_.bipedBody.func_217177_a(this.bipedBody);
      p_217148_1_.bipedRightArm.func_217177_a(this.bipedRightArm);
      p_217148_1_.bipedLeftArm.func_217177_a(this.bipedLeftArm);
      p_217148_1_.bipedRightLeg.func_217177_a(this.bipedRightLeg);
      p_217148_1_.bipedLeftLeg.func_217177_a(this.bipedLeftLeg);
   }
   ...
   public void func_225599_a_(HandSide p_225599_1_, MatrixStack p_225599_2_) {
      this.func_187074_a(p_225599_1_).func_228307_a_(p_225599_2_);
   }
