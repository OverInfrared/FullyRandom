...
public abstract class RenderType extends RenderState {
   ...
   private static final RenderType field_239257_ac_ = func_228633_a_("translucent_moving_block", DefaultVertexFormats.BLOCK, 7, 262144, false, true, func_239262_B_());
   ...
   private static final RenderType field_239258_ag_ = func_228632_a_("armor_glint", DefaultVertexFormats.POSITION_TEX, 7, 256, RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(ItemRenderer.RES_ITEM_GLINT, true, false)).func_228727_a_(field_228496_F_).func_228714_a_(field_228491_A_).func_228715_a_(field_228493_C_).func_228726_a_(field_239240_f_).func_228725_a_(field_228526_r_).func_228718_a_(field_239235_M_).func_228728_a_(false));
   private static final RenderType field_239259_ah_ = func_228632_a_("armor_entity_glint", DefaultVertexFormats.POSITION_TEX, 7, 256, RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(ItemRenderer.RES_ITEM_GLINT, true, false)).func_228727_a_(field_228496_F_).func_228714_a_(field_228491_A_).func_228715_a_(field_228493_C_).func_228726_a_(field_239240_f_).func_228725_a_(field_228527_s_).func_228718_a_(field_239235_M_).func_228728_a_(false));
   private static final RenderType field_228622_Y_ = func_228632_a_("glint", DefaultVertexFormats.POSITION_TEX, 7, 256, RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(ItemRenderer.RES_ITEM_GLINT, true, false)).func_228727_a_(field_228496_F_).func_228714_a_(field_228491_A_).func_228715_a_(field_228493_C_).func_228726_a_(field_228513_e_).func_228721_a_(field_241712_U_).func_228725_a_(field_228526_r_).func_228728_a_(false));
   private static final RenderType field_239260_aj_ = func_228632_a_("glint_direct", DefaultVertexFormats.POSITION_TEX, 7, 256, RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(ItemRenderer.RES_ITEM_GLINT, true, false)).func_228727_a_(field_228496_F_).func_228714_a_(field_228491_A_).func_228715_a_(field_228493_C_).func_228726_a_(field_239240_f_).func_228725_a_(field_228526_r_).func_228728_a_(false));
   ...
   private static final RenderType field_239261_al_ = func_228632_a_("entity_glint_direct", DefaultVertexFormats.POSITION_TEX, 7, 256, RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(ItemRenderer.RES_ITEM_GLINT, true, false)).func_228727_a_(field_228496_F_).func_228714_a_(field_228491_A_).func_228715_a_(field_228493_C_).func_228726_a_(field_239240_f_).func_228725_a_(field_228527_s_).func_228728_a_(false));
   private static final RenderType field_228624_aa_ = func_228633_a_("lightning", DefaultVertexFormats.POSITION_COLOR, 7, 256, false, true, RenderType.State.func_228694_a_().func_228727_a_(field_228495_E_).func_228726_a_(field_228512_d_).func_228721_a_(field_239238_U_).func_228723_a_(field_228520_l_).func_228728_a_(false));
   private static final RenderType field_241713_am_ = func_228633_a_("tripwire", DefaultVertexFormats.BLOCK, 7, 262144, true, true, func_241714_D_());
   ...
   private static RenderType.State func_239262_B_() {
      return RenderType.State.func_228694_a_().func_228723_a_(field_228520_l_).func_228719_a_(field_228528_t_).func_228724_a_(field_228521_m_).func_228726_a_(field_228515_g_).func_228721_a_(field_241712_U_).func_228728_a_(true);
   }
   ...
   public static RenderType func_239266_b_(ResourceLocation p_239266_0_, boolean p_239266_1_) {
      RenderType.State rendertype$state = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_239266_0_, false, false)).func_228726_a_(field_228510_b_).func_228716_a_(field_228532_x_).func_228713_a_(field_228517_i_).func_228714_a_(field_228491_A_).func_228719_a_(field_228528_t_).func_228722_a_(field_228530_v_).func_228718_a_(field_239235_M_).func_228728_a_(p_239266_1_);
      return func_228633_a_("entity_cutout_no_cull_z_offset", DefaultVertexFormats.field_227849_i_, 7, 256, true, false, rendertype$state);
   }
   ...
   public static RenderType func_239268_f_(ResourceLocation p_239268_0_) {
      RenderType.State rendertype$state = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_239268_0_, false, false)).func_228726_a_(field_228515_g_).func_228721_a_(field_241712_U_).func_228716_a_(field_228532_x_).func_228713_a_(field_228517_i_).func_228719_a_(field_228528_t_).func_228722_a_(field_228530_v_).func_228727_a_(RenderState.field_228495_E_).func_228728_a_(true);
      return func_228633_a_("item_entity_translucent_cull", DefaultVertexFormats.field_227849_i_, 7, 256, true, true, rendertype$state);
   }
   ...
   public static RenderType func_239272_l_(ResourceLocation p_239272_0_) {
      RenderType.State rendertype$state = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_239272_0_, false, false)).func_228726_a_(field_228515_g_).func_228716_a_(field_228532_x_).func_228713_a_(field_228517_i_).func_228714_a_(field_228534_z_).func_228719_a_(field_228528_t_).func_228722_a_(field_228530_v_).func_228727_a_(field_228496_F_).func_228715_a_(field_228494_D_).func_228718_a_(field_239235_M_).func_228728_a_(false);
      return func_228633_a_("entity_shadow", DefaultVertexFormats.field_227849_i_, 7, 256, false, false, rendertype$state);
   }

   public static RenderType func_239264_a_(ResourceLocation p_239264_0_, float p_239264_1_) {
      RenderType.State rendertype$state = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_239264_0_, false, false)).func_228713_a_(new RenderState.AlphaState(p_239264_1_)).func_228714_a_(field_228491_A_).func_228728_a_(true);
   ...
   private static RenderType.State func_241714_D_() {
      return RenderType.State.func_228694_a_().func_228723_a_(field_228520_l_).func_228719_a_(field_228528_t_).func_228724_a_(field_228521_m_).func_228726_a_(field_228515_g_).func_228721_a_(field_239238_U_).func_228728_a_(true);
   }
   ...
   public static List<RenderType> func_228661_n_() {
      return ImmutableList.of(func_228639_c_(), func_228641_d_(), func_228643_e_(), func_228645_f_(), func_241715_r_());
   }
   ...
   public static final class State {
      ...
      public String toString() {
         return "CompositeState[" + this.field_228693_q_ + ", outlineProperty=" + this.field_230171_p_ + ']';
      }
   ...
   static final class Type extends RenderType {
      ...
      private Type(String p_i225993_1_, VertexFormat p_i225993_2_, int p_i225993_3_, int p_i225993_4_, boolean p_i225993_5_, boolean p_i225993_6_, RenderType.State p_i225993_7_) {
         ...
         this.field_228670_U_ = p_i225993_7_.field_230171_p_ == RenderType.OutlineState.AFFECTS_OUTLINE ? p_i225993_7_.field_228677_a_.func_228606_c_().map((p_239275_1_) -> {
            return func_239265_a_(p_239275_1_, p_i225993_7_.field_228683_g_);
         }) : Optional.empty();
      ...
      public String toString() {
         return "RenderType[" + this.field_228668_S_ + ']';
      }
