...
public class EntityRendererManager {
   ...
   public <E extends Entity> void func_229084_a_(E p_229084_1_, double p_229084_2_, double p_229084_4_, double p_229084_6_, float p_229084_8_, float p_229084_9_, MatrixStack p_229084_10_, IRenderTypeBuffer p_229084_11_, int p_229084_12_) {
      ...
      try {
         ...
         double d2 = p_229084_2_ + vector3d.getX();
         double d3 = p_229084_4_ + vector3d.getY();
         double d0 = p_229084_6_ + vector3d.getZ();
         ...
         p_229084_10_.func_227861_a_(-vector3d.getX(), -vector3d.getY(), -vector3d.getZ());
         ...
         crashreportcategory1.func_71507_a("Location", CrashReportCategory.getCoordinateInfo(p_229084_2_, p_229084_4_, p_229084_6_));
   ...
   private void func_229093_a_(MatrixStack p_229093_1_, IVertexBuilder p_229093_2_, Entity p_229093_3_, float p_229093_4_) {
      ...
      if (p_229093_3_ instanceof EnderDragonEntity) {
         double d0 = -MathHelper.lerp((double)p_229093_4_, p_229093_3_.lastTickPosX, p_229093_3_.func_226277_ct_());
         double d1 = -MathHelper.lerp((double)p_229093_4_, p_229093_3_.lastTickPosY, p_229093_3_.func_226278_cu_());
         double d2 = -MathHelper.lerp((double)p_229093_4_, p_229093_3_.lastTickPosZ, p_229093_3_.func_226281_cx_());

         for(EnderDragonPartEntity enderdragonpartentity : ((EnderDragonEntity)p_229093_3_).getDragonParts()) {
      ...
      Vector3d vector3d = p_229093_3_.getLook(p_229093_4_);
      ...
      p_229093_2_.func_227888_a_(matrix4f, (float)(vector3d.x * 2.0D), (float)((double)p_229093_3_.getEyeHeight() + vector3d.y * 2.0D), (float)(vector3d.z * 2.0D)).func_225586_a_(0, 0, 255, 255).endVertex();
   }
   ...
   private static void func_229092_a_(MatrixStack.Entry p_229092_0_, IVertexBuilder p_229092_1_, IWorldReader p_229092_2_, BlockPos p_229092_3_, double p_229092_4_, double p_229092_6_, double p_229092_8_, float p_229092_10_, float p_229092_11_) {
      ...
      if (blockstate.getRenderType() != BlockRenderType.INVISIBLE && p_229092_2_.getLight(p_229092_3_) > 3) {
         if (blockstate.func_235785_r_(p_229092_2_, blockpos)) {
            VoxelShape voxelshape = blockstate.getShape(p_229092_2_, p_229092_3_.func_177977_b());
