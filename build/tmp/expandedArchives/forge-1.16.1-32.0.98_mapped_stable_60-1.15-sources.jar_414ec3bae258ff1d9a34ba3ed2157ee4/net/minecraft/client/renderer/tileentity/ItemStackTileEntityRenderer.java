   ...
   public void func_239207_a_(ItemStack p_239207_1_, ItemCameraTransforms.TransformType p_239207_2_, MatrixStack p_239207_3_, IRenderTypeBuffer p_239207_4_, int p_239207_5_, int p_239207_6_) {
      ...
      if (item instanceof BlockItem) {
         ...
         if (block instanceof AbstractSkullBlock) {
            ...
            SkullTileEntityRenderer.func_228879_a_((Direction)null, 180.0F, ((AbstractSkullBlock)block).getSkullType(), gameprofile, 0.0F, p_239207_3_, p_239207_4_, p_239207_5_);
         } else {
            ...
            TileEntityRendererDispatcher.instance.func_228852_a_(tileentity, p_239207_3_, p_239207_4_, p_239207_5_, p_239207_6_);
         }
      } else {
         if (item == Items.SHIELD) {
            boolean flag = p_239207_1_.getChildTag("BlockEntityTag") != null;
            p_239207_3_.func_227860_a_();
            p_239207_3_.func_227862_a_(1.0F, -1.0F, -1.0F);
            RenderMaterial rendermaterial = flag ? ModelBakery.field_229316_g_ : ModelBakery.field_229317_h_;
            IVertexBuilder ivertexbuilder = rendermaterial.func_229314_c_().func_229230_a_(ItemRenderer.func_239391_c_(p_239207_4_, this.modelShield.func_228282_a_(rendermaterial.func_229310_a_()), true, p_239207_1_.hasEffect()));
            this.modelShield.func_228294_b_().func_228309_a_(p_239207_3_, ivertexbuilder, p_239207_5_, p_239207_6_, 1.0F, 1.0F, 1.0F, 1.0F);
            if (flag) {
               ...
               this.modelShield.func_228293_a_().func_228309_a_(p_239207_3_, ivertexbuilder, p_239207_5_, p_239207_6_, 1.0F, 1.0F, 1.0F, 1.0F);
            }

            p_239207_3_.func_227865_b_();
         } else if (item == Items.TRIDENT) {
            p_239207_3_.func_227860_a_();
            p_239207_3_.func_227862_a_(1.0F, -1.0F, -1.0F);
            IVertexBuilder ivertexbuilder1 = ItemRenderer.func_239391_c_(p_239207_4_, this.trident.func_228282_a_(TridentModel.TEXTURE_LOCATION), false, p_239207_1_.hasEffect());
            this.trident.func_225598_a_(p_239207_3_, ivertexbuilder1, p_239207_5_, p_239207_6_, 1.0F, 1.0F, 1.0F, 1.0F);
            p_239207_3_.func_227865_b_();
         }
