...
public class ActiveRenderInfo {
   ...
   public void update(IBlockReader worldIn, Entity renderViewEntity, boolean thirdPersonIn, boolean thirdPersonReverseIn, float partialTicks) {
      ...
      this.setPosition(MathHelper.lerp((double)partialTicks, renderViewEntity.prevPosX, renderViewEntity.func_226277_ct_()), MathHelper.lerp((double)partialTicks, renderViewEntity.prevPosY, renderViewEntity.func_226278_cu_()) + (double)MathHelper.lerp(partialTicks, this.previousHeight, this.height), MathHelper.lerp((double)partialTicks, renderViewEntity.prevPosZ, renderViewEntity.func_226281_cx_()));
      if (thirdPersonIn) {
   ...
   protected void setPostion(Vector3d posIn) {
      this.pos = posIn;
      this.blockPos.func_189532_c(posIn.x, posIn.y, posIn.z);
   }
