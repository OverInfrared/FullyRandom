...
public class Atlases {
   ...
   public static final RenderMaterial field_228748_g_ = new RenderMaterial(field_228742_a_, new ResourceLocation("entity/shulker/shulker"));
   public static final List<RenderMaterial> field_228749_h_ = Stream.of("white", "orange", "magenta", "light_blue", "yellow", "lime", "pink", "gray", "light_gray", "cyan", "purple", "blue", "brown", "green", "red", "black").map((p_228777_0_) -> {
      return new RenderMaterial(field_228742_a_, new ResourceLocation("entity/shulker/shulker_" + p_228777_0_));
   }).collect(ImmutableList.toImmutableList());
   public static final Map<WoodType, RenderMaterial> field_228750_i_ = WoodType.func_227046_a_().collect(Collectors.toMap(Function.identity(), Atlases::func_228773_a_));
   public static final RenderMaterial[] field_228751_j_ = Arrays.stream(DyeColor.values()).sorted(Comparator.comparingInt(DyeColor::getId)).map((p_228770_0_) -> {
      return new RenderMaterial(field_228743_b_, new ResourceLocation("entity/bed/" + p_228770_0_.getTranslationKey()));
   }).toArray((p_228769_0_) -> {
      return new RenderMaterial[p_228769_0_];
   });
   public static final RenderMaterial field_228752_k_ = func_228774_a_("trapped");
   public static final RenderMaterial field_228753_l_ = func_228774_a_("trapped_left");
   public static final RenderMaterial field_228754_m_ = func_228774_a_("trapped_right");
   public static final RenderMaterial field_228755_n_ = func_228774_a_("christmas");
   public static final RenderMaterial field_228756_o_ = func_228774_a_("christmas_left");
   public static final RenderMaterial field_228757_p_ = func_228774_a_("christmas_right");
   public static final RenderMaterial field_228758_q_ = func_228774_a_("normal");
   public static final RenderMaterial field_228759_r_ = func_228774_a_("normal_left");
   public static final RenderMaterial field_228760_s_ = func_228774_a_("normal_right");
   public static final RenderMaterial field_228761_t_ = func_228774_a_("ender");
   ...
   public static void func_228775_a_(Consumer<RenderMaterial> p_228775_0_) {
      p_228775_0_.accept(field_228748_g_);
      field_228749_h_.forEach(p_228775_0_);

      for(BannerPattern bannerpattern : BannerPattern.values()) {
         p_228775_0_.accept(new RenderMaterial(field_228744_c_, bannerpattern.func_226957_a_(true)));
         p_228775_0_.accept(new RenderMaterial(field_228745_d_, bannerpattern.func_226957_a_(false)));
      }

      field_228750_i_.values().forEach(p_228775_0_);

      for(RenderMaterial rendermaterial : field_228751_j_) {
   ...
   private static RenderMaterial func_228774_a_(String p_228774_0_) {
      return new RenderMaterial(field_228747_f_, new ResourceLocation("entity/chest/" + p_228774_0_));
   }

   public static RenderMaterial func_228771_a_(TileEntity p_228771_0_, ChestType p_228771_1_, boolean p_228771_2_) {
      if (p_228771_2_) {
   ...
   private static RenderMaterial func_228772_a_(ChestType p_228772_0_, RenderMaterial p_228772_1_, RenderMaterial p_228772_2_, RenderMaterial p_228772_3_) {
      switch(p_228772_0_) {
      case LEFT:
         return p_228772_2_;
      case RIGHT:
