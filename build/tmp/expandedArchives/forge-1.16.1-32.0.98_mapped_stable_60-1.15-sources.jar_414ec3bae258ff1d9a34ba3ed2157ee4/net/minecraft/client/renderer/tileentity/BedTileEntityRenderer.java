...
public class BedTileEntityRenderer extends TileEntityRenderer<BedTileEntity> {
   ...
   public void func_225616_a_(BedTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      RenderMaterial rendermaterial = Atlases.field_228751_j_[p_225616_1_.getColor().getId()];
      ...
      if (world != null) {
         ...
         this.func_228847_a_(p_225616_3_, p_225616_4_, blockstate.get(BedBlock.PART) == BedPart.HEAD, blockstate.get(BedBlock.HORIZONTAL_FACING), rendermaterial, i, p_225616_6_, false);
      } else {
         this.func_228847_a_(p_225616_3_, p_225616_4_, true, Direction.SOUTH, rendermaterial, p_225616_5_, p_225616_6_, false);
         this.func_228847_a_(p_225616_3_, p_225616_4_, false, Direction.SOUTH, rendermaterial, p_225616_5_, p_225616_6_, true);
      }
