...
public class BellTileEntityRenderer extends TileEntityRenderer<BellTileEntity> {
   public static final RenderMaterial field_217653_c = new RenderMaterial(AtlasTexture.LOCATION_BLOCKS_TEXTURE, new ResourceLocation("entity/bell/bell_body"));
   ...
   public void func_225616_a_(BellTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      float f = (float)p_225616_1_.ringingTicks + p_225616_2_;
      float f1 = 0.0F;
      float f2 = 0.0F;
      if (p_225616_1_.isRinging) {
         float f3 = MathHelper.sin(f / (float)Math.PI) / (4.0F + f / 3.0F);
         if (p_225616_1_.ringDirection == Direction.NORTH) {
            f1 = -f3;
         } else if (p_225616_1_.ringDirection == Direction.SOUTH) {
            f1 = f3;
         } else if (p_225616_1_.ringDirection == Direction.EAST) {
            f2 = -f3;
         } else if (p_225616_1_.ringDirection == Direction.WEST) {
            f2 = f3;
         }
      }
