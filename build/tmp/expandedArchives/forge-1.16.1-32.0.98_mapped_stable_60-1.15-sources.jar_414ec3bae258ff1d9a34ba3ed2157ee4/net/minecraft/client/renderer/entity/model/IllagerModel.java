...
public class IllagerModel<T extends AbstractIllagerEntity> extends SegmentedModel<T> implements IHasArm, IHasHead {
   ...
   public IllagerModel(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
      ...
      ModelRenderer modelrenderer = (new ModelRenderer(this)).func_78787_b(textureWidthIn, textureHeightIn);
      ...
      ModelRenderer modelrenderer1 = (new ModelRenderer(this, 44, 22)).func_78787_b(textureWidthIn, textureHeightIn);
      ...
      this.field_217143_g = (new ModelRenderer(this, 0, 22)).func_78787_b(textureWidthIn, textureHeightIn);
      ...
      this.field_217144_h = (new ModelRenderer(this, 0, 22)).func_78787_b(textureWidthIn, textureHeightIn);
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      if (abstractillagerentity$armpose == AbstractIllagerEntity.ArmPose.ATTACKING) {
         ModelHelper.func_239103_a_(this.rightArm, this.leftArm, p_225597_1_, this.swingProgress, p_225597_4_);
         ...
         ModelHelper.func_239102_a_(this.rightArm, this.leftArm, p_225597_1_, true);
   ...
   private ModelRenderer func_191216_a(HandSide p_191216_1_) {
   ...
   public void func_225599_a_(HandSide p_225599_1_, MatrixStack p_225599_2_) {
      this.func_191216_a(p_225599_1_).func_228307_a_(p_225599_2_);
   }
}