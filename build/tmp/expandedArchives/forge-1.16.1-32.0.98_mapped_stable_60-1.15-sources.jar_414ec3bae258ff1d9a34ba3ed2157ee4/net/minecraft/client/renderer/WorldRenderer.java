...
public class WorldRenderer implements IResourceManagerReloadListener, AutoCloseable {
   ...
   public void func_228436_a_(ActiveRenderInfo p_228436_1_) {
      ...
      if (!(f <= 0.0F)) {
         ...
         for(int j = 0; j < i; ++j) {
            ...
            BlockPos blockpos2 = iworldreader.getHeight(Heightmap.Type.MOTION_BLOCKING, blockpos.add(k, 0, l)).func_177977_b();
            Biome biome = iworldreader.func_226691_t_(blockpos2);
            if (blockpos2.getY() > 0 && blockpos2.getY() <= blockpos.getY() + 10 && blockpos2.getY() >= blockpos.getY() - 10 && biome.getPrecipitation() == Biome.RainType.RAIN && biome.func_225486_c(blockpos2) >= 0.15F) {
               blockpos1 = blockpos2;
   ...
   private void func_239233_v_() {
      ...
      try {
         ...
         shadergroup.createBindFramebuffers(this.mc.func_228018_at_().getFramebufferWidth(), this.mc.func_228018_at_().getFramebufferHeight());
   ...
   public void loadRenderers() {
      if (this.world != null) {
         ...
         RenderTypeLookup.func_228393_a_(Minecraft.isFancyGraphicsEnabled());
   ...
   private void func_228437_a_(ActiveRenderInfo p_228437_1_, ClippingHelper p_228437_2_, boolean p_228437_3_, int p_228437_4_, boolean p_228437_5_) {
      Vector3d vector3d = p_228437_1_.getProjectedView();
      ...
      this.renderDispatcher.func_217669_a(vector3d);
   ...
   public void func_228426_a_(MatrixStack p_228426_1_, float p_228426_2_, long p_228426_3_, boolean p_228426_5_, ActiveRenderInfo p_228426_6_, GameRenderer p_228426_7_, LightTexture p_228426_8_, Matrix4f p_228426_9_) {
      ...
      Vector3d vector3d = p_228426_6_.getProjectedView();
      ...
      if (flag) {
         ...
         clippinghelper.func_228952_a_(this.debugTerrainFrustumPosition.x, this.debugTerrainFrustumPosition.y, this.debugTerrainFrustumPosition.z);
      } else {
      ...
      if (this.debugFixTerrainFrustum) {
         this.func_228419_a_(matrix4f, p_228426_9_, vector3d.x, vector3d.y, vector3d.z, flag ? new ClippingHelper(matrix4f, p_228426_9_) : clippinghelper);
      ...
      this.func_228437_a_(p_228426_6_, clippinghelper, flag, this.field_228409_ai_++, this.mc.player.isSpectator());
         ...
         if (!list.isEmpty()) {
            for(TileEntity tileentity1 : list) {
               ...
               if (sortedset != null && !sortedset.isEmpty()) {
                  ...
                  if (j3 >= 0) {
                     MatrixStack.Entry matrixstack$entry = p_228426_1_.func_227866_c_();
                     IVertexBuilder ivertexbuilder = new MatrixApplyingVertexBuilder(this.field_228415_m_.func_228489_c_().getBuffer(ModelBakery.field_229320_k_.get(j3)), matrixstack$entry.func_227870_a_(), matrixstack$entry.func_227872_b_());
      ...
      for(Entry<SortedSet<DestroyBlockProgress>> entry : this.field_228407_B_.long2ObjectEntrySet()) {
         ...
         if (!(d3 * d3 + d4 * d4 + d5 * d5 > 1024.0D)) {
            ...
            if (sortedset1 != null && !sortedset1.isEmpty()) {
               ...
               MatrixStack.Entry matrixstack$entry1 = p_228426_1_.func_227866_c_();
               IVertexBuilder ivertexbuilder1 = new MatrixApplyingVertexBuilder(this.field_228415_m_.func_228489_c_().getBuffer(ModelBakery.field_229320_k_.get(k3)), matrixstack$entry1.func_227870_a_(), matrixstack$entry1.func_227872_b_());
      ...
      if (this.field_239227_K_ != null) {
         ...
         this.field_239227_K_.render(p_228426_2_);
         this.mc.getFramebuffer().bindFramebuffer(false);
      } else {
   ...
   public void func_228424_a_(MatrixStack p_228424_1_, float p_228424_2_) {
      if (this.mc.world.func_239132_a_().func_241683_c_() == DimensionRenderInfo.FogType.END) {
         ...
         RenderSystem.disableTexture();
         Vector3d vector3d = this.world.func_228318_a_(this.mc.gameRenderer.getActiveRenderInfo().getBlockPos(), p_228424_2_);
         ...
         RenderSystem.enableBlend();
         RenderSystem.defaultBlendFunc();
         float[] afloat = this.world.func_239132_a_().func_230492_a_(this.world.getCelestialAngle(p_228424_2_), p_228424_2_);
         if (afloat != null) {
            RenderSystem.disableTexture();
         ...
         double d0 = this.mc.player.getEyePosition(p_228424_2_).y - this.world.getWorldInfo().func_239159_f_();
         if (d0 < 0.0D) {
            p_228424_1_.func_227860_a_();
   ...
   public void func_228425_a_(MatrixStack p_228425_1_, float p_228425_2_, double p_228425_3_, double p_228425_5_, double p_228425_7_) {
      ...
      if (!Float.isNaN(f)) {
         ...
         Vector3d vector3d = this.world.func_228328_h_(p_228425_2_);
         ...
         p_228425_1_.func_227861_a_((double)(-f3), (double)f4, (double)(-f5));
         if (this.cloudsVBO != null) {
   ...
   public static int func_228421_a_(IBlockDisplayReader p_228421_0_, BlockPos p_228421_1_) {
      return func_228420_a_(p_228421_0_, p_228421_0_.getBlockState(p_228421_1_), p_228421_1_);
   }

   public static int func_228420_a_(IBlockDisplayReader p_228420_0_, BlockState p_228420_1_, BlockPos p_228420_2_) {
      if (p_228420_1_.func_227035_k_(p_228420_0_, p_228420_2_)) {
         return 15728880;
      } else {
