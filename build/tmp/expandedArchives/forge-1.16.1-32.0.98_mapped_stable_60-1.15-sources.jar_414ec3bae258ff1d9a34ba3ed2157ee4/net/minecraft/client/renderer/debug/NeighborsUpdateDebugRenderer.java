         ...
         if (k > 200L) {
            ...
            for(Entry<BlockPos, Integer> entry1 : map1.entrySet()) {
               ...
               if (set.add(blockpos)) {
                  ...
                  WorldRenderer.func_228427_a_(p_225619_1_, ivertexbuilder, axisalignedbb.minX, axisalignedbb.minY, axisalignedbb.minZ, axisalignedbb.maxX, axisalignedbb.maxY, axisalignedbb.maxZ, 1.0F, 1.0F, 1.0F, 1.0F);
