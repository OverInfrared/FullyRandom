      ...
      if (p_229034_3_) {
         for(int j = 0; j < p_229034_0_.getCurrentPathLength(); ++j) {
            ...
            if (func_229033_a_(pathpoint1.func_224759_a(), p_229034_4_, p_229034_6_, p_229034_8_) <= 80.0F) {
               DebugRenderer.func_217734_a(String.format("%s", pathpoint1.nodeType), (double)pathpoint1.x + 0.5D, (double)pathpoint1.y + 0.75D, (double)pathpoint1.z + 0.5D, -1, 0.02F, true, 0.0F, true);
               DebugRenderer.func_217734_a(String.format(Locale.ROOT, "%.2f", pathpoint1.costMalus), (double)pathpoint1.x + 0.5D, (double)pathpoint1.y + 0.25D, (double)pathpoint1.z + 0.5D, -1, 0.02F, true, 0.0F, true);
            }
         }
      }
