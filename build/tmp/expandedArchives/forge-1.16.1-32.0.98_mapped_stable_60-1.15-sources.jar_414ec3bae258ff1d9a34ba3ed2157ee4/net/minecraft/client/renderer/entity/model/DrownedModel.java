...
public class DrownedModel<T extends ZombieEntity> extends ZombieModel<T> {
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      if (this.swimAnimation > 0.0F) {
         this.bipedRightArm.rotateAngleX = this.func_205060_a(this.swimAnimation, this.bipedRightArm.rotateAngleX, -2.5132742F) + this.swimAnimation * 0.35F * MathHelper.sin(0.1F * p_225597_4_);
         this.bipedLeftArm.rotateAngleX = this.func_205060_a(this.swimAnimation, this.bipedLeftArm.rotateAngleX, -2.5132742F) - this.swimAnimation * 0.35F * MathHelper.sin(0.1F * p_225597_4_);
         this.bipedRightArm.rotateAngleZ = this.func_205060_a(this.swimAnimation, this.bipedRightArm.rotateAngleZ, -0.15F);
         this.bipedLeftArm.rotateAngleZ = this.func_205060_a(this.swimAnimation, this.bipedLeftArm.rotateAngleZ, 0.15F);
