...
public class GuardianRenderer extends MobRenderer<GuardianEntity, GuardianModel> {
   ...
   public boolean func_225626_a_(GuardianEntity p_225626_1_, ClippingHelper p_225626_2_, double p_225626_3_, double p_225626_5_, double p_225626_7_) {
      if (super.func_225626_a_(p_225626_1_, p_225626_2_, p_225626_3_, p_225626_5_, p_225626_7_)) {
         ...
         if (p_225626_1_.hasTargetedEntity()) {
            ...
            if (livingentity != null) {
               ...
               return p_225626_2_.func_228957_a_(new AxisAlignedBB(vector3d1.x, vector3d1.y, vector3d1.z, vector3d.x, vector3d.y, vector3d.z));
            }
         }
   ...
   public void func_225623_a_(GuardianEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      if (livingentity != null) {
         ...
         Vector3d vector3d = this.getPosition(livingentity, (double)livingentity.getHeight() * 0.5D, p_225623_3_);
