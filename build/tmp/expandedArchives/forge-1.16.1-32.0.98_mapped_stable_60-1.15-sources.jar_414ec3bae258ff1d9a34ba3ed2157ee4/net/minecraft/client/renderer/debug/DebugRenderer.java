...
public class DebugRenderer {
   ...
   public static Optional<Entity> func_217728_a(@Nullable Entity p_217728_0_, int p_217728_1_) {
      if (p_217728_0_ == null) {
         ...
         Vector3d vector3d1 = p_217728_0_.getLook(1.0F).scale((double)p_217728_1_);
         Vector3d vector3d2 = vector3d.add(vector3d1);
         AxisAlignedBB axisalignedbb = p_217728_0_.getBoundingBox().expand(vector3d1).grow(1.0D);
         ...
         EntityRayTraceResult entityraytraceresult = ProjectileHelper.rayTraceEntities(p_217728_0_, vector3d, vector3d2, axisalignedbb, predicate, (double)i);
