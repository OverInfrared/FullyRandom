   ...
   public void func_225619_a_(MatrixStack p_225619_1_, IRenderTypeBuffer p_225619_2_, double p_225619_3_, double p_225619_5_, double p_225619_7_) {
      ...
      for(int i = -32; i <= 32; i += 16) {
         for(int j = -32; j <= 32; j += 16) {
            ...
            for(Entry<Heightmap.Type, Heightmap> entry : ichunk.func_217311_f()) {
               ...
               for(int k = 0; k < 16; ++k) {
                  for(int l = 0; l < 16; ++l) {
                     ...
                     WorldRenderer.addChainedFilledBoxVertices(bufferbuilder, (double)((float)i1 + 0.25F) - p_225619_3_, (double)f, (double)((float)j1 + 0.25F) - p_225619_7_, (double)((float)i1 + 0.75F) - p_225619_3_, (double)(f + 0.09375F), (double)((float)j1 + 0.75F) - p_225619_7_, vector3f.getX(), vector3f.getY(), vector3f.getZ(), 1.0F);
                  }
               }
            }
         }
