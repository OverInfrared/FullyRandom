...
public class BlockModelRenderer {
   ...
   public boolean renderModel(IBlockDisplayReader worldIn, IBakedModel modelIn, BlockState stateIn, BlockPos posIn, MatrixStack matrixIn, IVertexBuilder buffer, boolean checkSides, Random randomIn, long rand, int combinedOverlayIn, net.minecraftforge.client.model.data.IModelData modelData) {
      ...
      matrixIn.func_227861_a_(vector3d.x, vector3d.y, vector3d.z);
   ...
   public boolean renderModelFlat(IBlockDisplayReader worldIn, IBakedModel modelIn, BlockState stateIn, BlockPos posIn, MatrixStack matrixStackIn, IVertexBuilder buffer, boolean checkSides, Random randomIn, long rand, int combinedOverlayIn, net.minecraftforge.client.model.data.IModelData modelData) {
      ...
      for(Direction direction : Direction.values()) {
         ...
         List<BakedQuad> list = modelIn.getQuads(stateIn, direction, randomIn, modelData);
         if (!list.isEmpty() && (!checkSides || Block.shouldSideBeRendered(stateIn, worldIn, posIn, direction))) {
            int i = WorldRenderer.func_228420_a_(worldIn, stateIn, posIn.offset(direction));
   ...
   private void func_228799_a_(IBlockDisplayReader p_228799_1_, BlockState p_228799_2_, BlockPos p_228799_3_, MatrixStack p_228799_4_, IVertexBuilder p_228799_5_, List<BakedQuad> p_228799_6_, float[] p_228799_7_, BitSet p_228799_8_, BlockModelRenderer.AmbientOcclusionFace p_228799_9_, int p_228799_10_) {
      for(BakedQuad bakedquad : p_228799_6_) {
         ...
         p_228799_9_.func_239285_a_(p_228799_1_, p_228799_2_, p_228799_3_, bakedquad.getFace(), p_228799_7_, p_228799_8_, bakedquad.func_239287_f_());
   ...
   private void func_228801_a_(IBlockDisplayReader p_228801_1_, BlockState p_228801_2_, BlockPos p_228801_3_, int[] p_228801_4_, Direction p_228801_5_, @Nullable float[] p_228801_6_, BitSet p_228801_7_) {
      ...
      case DOWN:
         ...
         p_228801_7_.set(0, f1 == f4 && (f1 < 1.0E-4F || p_228801_2_.func_235785_r_(p_228801_1_, p_228801_3_)));
         break;
      case UP:
         p_228801_7_.set(1, f >= 1.0E-4F || f2 >= 1.0E-4F || f3 <= 0.9999F || f5 <= 0.9999F);
         p_228801_7_.set(0, f1 == f4 && (f4 > 0.9999F || p_228801_2_.func_235785_r_(p_228801_1_, p_228801_3_)));
         break;
      case NORTH:
         p_228801_7_.set(1, f >= 1.0E-4F || f1 >= 1.0E-4F || f3 <= 0.9999F || f4 <= 0.9999F);
         p_228801_7_.set(0, f2 == f5 && (f2 < 1.0E-4F || p_228801_2_.func_235785_r_(p_228801_1_, p_228801_3_)));
         break;
      case SOUTH:
         p_228801_7_.set(1, f >= 1.0E-4F || f1 >= 1.0E-4F || f3 <= 0.9999F || f4 <= 0.9999F);
         p_228801_7_.set(0, f2 == f5 && (f5 > 0.9999F || p_228801_2_.func_235785_r_(p_228801_1_, p_228801_3_)));
         break;
      case WEST:
         p_228801_7_.set(1, f1 >= 1.0E-4F || f2 >= 1.0E-4F || f4 <= 0.9999F || f5 <= 0.9999F);
         p_228801_7_.set(0, f == f3 && (f < 1.0E-4F || p_228801_2_.func_235785_r_(p_228801_1_, p_228801_3_)));
         break;
      case EAST:
         p_228801_7_.set(1, f1 >= 1.0E-4F || f2 >= 1.0E-4F || f4 <= 0.9999F || f5 <= 0.9999F);
         p_228801_7_.set(0, f == f3 && (f3 > 0.9999F || p_228801_2_.func_235785_r_(p_228801_1_, p_228801_3_)));
      }
   ...
   private void func_228798_a_(IBlockDisplayReader p_228798_1_, BlockState p_228798_2_, BlockPos p_228798_3_, int p_228798_4_, int p_228798_5_, boolean p_228798_6_, MatrixStack p_228798_7_, IVertexBuilder p_228798_8_, List<BakedQuad> p_228798_9_, BitSet p_228798_10_) {
      for(BakedQuad bakedquad : p_228798_9_) {
         ...
         float f = p_228798_1_.func_230487_a_(bakedquad.getFace(), bakedquad.func_239287_f_());
   ...
   class AmbientOcclusionFace {
      ...
      public void func_239285_a_(IBlockDisplayReader p_239285_1_, BlockState p_239285_2_, BlockPos p_239285_3_, Direction p_239285_4_, float[] p_239285_5_, BitSet p_239285_6_, boolean p_239285_7_) {
         ...
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[0]).func_189536_c(p_239285_4_);
         boolean flag = p_239285_1_.getBlockState(blockpos$mutable).getOpacity(p_239285_1_, blockpos$mutable) == 0;
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[1]).func_189536_c(p_239285_4_);
         boolean flag1 = p_239285_1_.getBlockState(blockpos$mutable).getOpacity(p_239285_1_, blockpos$mutable) == 0;
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[2]).func_189536_c(p_239285_4_);
         boolean flag2 = p_239285_1_.getBlockState(blockpos$mutable).getOpacity(p_239285_1_, blockpos$mutable) == 0;
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[3]).func_189536_c(p_239285_4_);
         ...
         if (!flag2 && !flag) {
            ...
            blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[0]).func_189536_c(blockmodelrenderer$neighborinfo.corners[2]);
         ...
         if (!flag3 && !flag) {
            ...
            blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[0]).func_189536_c(blockmodelrenderer$neighborinfo.corners[3]);
         ...
         if (!flag2 && !flag1) {
            ...
            blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[1]).func_189536_c(blockmodelrenderer$neighborinfo.corners[2]);
         ...
         if (!flag3 && !flag1) {
            ...
            blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[1]).func_189536_c(blockmodelrenderer$neighborinfo.corners[3]);
         ...
         float f8 = p_239285_6_.get(0) ? blockmodelrenderer$cache.func_228811_b_(p_239285_1_.getBlockState(blockpos), p_239285_1_, blockpos) : blockmodelrenderer$cache.func_228811_b_(p_239285_1_.getBlockState(p_239285_3_), p_239285_1_, p_239285_3_);
