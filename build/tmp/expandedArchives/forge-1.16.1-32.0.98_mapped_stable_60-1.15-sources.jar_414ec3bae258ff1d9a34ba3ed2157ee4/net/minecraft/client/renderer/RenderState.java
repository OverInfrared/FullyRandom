...
public abstract class RenderState {
   ...
   protected static final RenderState.DepthTestState field_228492_B_ = new RenderState.DepthTestState("always", 519);
   ...
   public static class DepthTestState extends RenderState {
      ...
      public DepthTestState(String p_i232464_1_, int p_i232464_2_) {
         ...
         this.field_228580_Q_ = p_i232464_2_;
      }
   ...
   public static class LineState extends RenderState {
      ...
      public String toString() {
         return this.field_228509_a_ + '[' + (this.field_228587_Q_.isPresent() ? this.field_228587_Q_.getAsDouble() : "window_scale") + ']';
      }
   }
