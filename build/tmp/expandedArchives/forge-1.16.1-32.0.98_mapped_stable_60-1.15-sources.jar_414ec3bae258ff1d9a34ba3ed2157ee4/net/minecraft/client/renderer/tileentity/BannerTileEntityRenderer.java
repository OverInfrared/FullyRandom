...
public class BannerTileEntityRenderer extends TileEntityRenderer<BannerTileEntity> {
   ...
   public static void func_241717_a_(MatrixStack p_241717_0_, IRenderTypeBuffer p_241717_1_, int p_241717_2_, int p_241717_3_, ModelRenderer p_241717_4_, RenderMaterial p_241717_5_, boolean p_241717_6_, List<Pair<BannerPattern, DyeColor>> p_241717_7_, boolean p_241717_8_) {
      p_241717_4_.func_228308_a_(p_241717_0_, p_241717_5_.func_241742_a_(p_241717_1_, RenderType::func_228634_a_, p_241717_8_), p_241717_2_, p_241717_3_);
      ...
      for(int i = 0; i < 17 && i < p_241717_7_.size(); ++i) {
         ...
         RenderMaterial rendermaterial = new RenderMaterial(p_241717_6_ ? Atlases.field_228744_c_ : Atlases.field_228745_d_, pair.getFirst().func_226957_a_(p_241717_6_));
         p_241717_4_.func_228309_a_(p_241717_0_, rendermaterial.func_229311_a_(p_241717_1_, RenderType::func_228650_h_), p_241717_2_, p_241717_3_, afloat[0], afloat[1], afloat[2], 1.0F);
      }
