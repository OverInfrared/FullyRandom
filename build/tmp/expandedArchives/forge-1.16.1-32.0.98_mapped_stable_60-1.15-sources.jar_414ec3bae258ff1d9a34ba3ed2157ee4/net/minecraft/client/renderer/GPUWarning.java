...
public class GPUWarning extends ReloadListener<GPUWarning.GPUInfo> {
   ...
   protected void apply(GPUWarning.GPUInfo splashList, IResourceManager resourceManagerIn, IProfiler profilerIn) {
      this.field_241688_c_ = splashList.func_241709_a_();
   }
   ...
   public static final class GPUInfo {
      ...
      private ImmutableMap<String, String> func_241709_a_() {
         ...
         String s = func_241711_a_(this.field_241706_a_, PlatformDescriptors.func_227776_c_());
         if (!s.isEmpty()) {
            builder.put("renderer", s);
         }

         String s1 = func_241711_a_(this.field_241707_b_, PlatformDescriptors.func_227777_d_());
         if (!s1.isEmpty()) {
            builder.put("version", s1);
         }

         String s2 = func_241711_a_(this.field_241708_c_, PlatformDescriptors.func_227774_a_());
         if (!s2.isEmpty()) {
