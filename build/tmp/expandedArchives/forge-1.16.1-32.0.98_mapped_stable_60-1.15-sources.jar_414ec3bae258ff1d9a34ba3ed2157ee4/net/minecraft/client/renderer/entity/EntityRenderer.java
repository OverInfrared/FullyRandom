...
public abstract class EntityRenderer<T extends Entity> {
   ...
   public final int func_229100_c_(T p_229100_1_, float p_229100_2_) {
      BlockPos blockpos = new BlockPos(p_229100_1_.getEyePosition(p_229100_2_));
   ...
   protected int func_239381_b_(T p_239381_1_, BlockPos p_239381_2_) {
      return p_239381_1_.world.func_226658_a_(LightType.SKY, p_239381_2_);
   }

   protected int func_225624_a_(T p_225624_1_, BlockPos p_225624_2_) {
      return p_225624_1_.isBurning() ? 15 : p_225624_1_.world.func_226658_a_(LightType.BLOCK, p_225624_2_);
   }
   ...
   public void func_225623_a_(T p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      net.minecraftforge.client.event.RenderNameplateEvent renderNameplateEvent = new net.minecraftforge.client.event.RenderNameplateEvent(p_225623_1_, p_225623_1_.getDisplayName(), this, p_225623_4_, p_225623_5_, p_225623_6_);
   ...
   protected void func_225629_a_(T p_225629_1_, ITextComponent p_225629_2_, MatrixStack p_225629_3_, IRenderTypeBuffer p_225629_4_, int p_225629_5_) {
      ...
      if (!(d0 > 4096.0D)) {
         ...
         float f2 = (float)(-fontrenderer.func_238414_a_(p_225629_2_) / 2);
         fontrenderer.func_238416_a_(p_225629_2_, f2, (float)i, 553648127, false, matrix4f, p_225629_4_, flag, j, p_225629_5_);
         if (flag) {
            fontrenderer.func_238416_a_(p_225629_2_, f2, (float)i, -1, false, matrix4f, p_225629_4_, false, 0, p_225629_5_);
         }
