...
public class HorseMarkingsLayer extends LayerRenderer<HorseEntity, HorseModel<HorseEntity>> {
   ...
   public void func_225628_a_(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, HorseEntity p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
      ResourceLocation resourcelocation = field_239405_a_.get(p_225628_4_.func_234240_eM_());
      if (resourcelocation != null && !p_225628_4_.isInvisible()) {
         IVertexBuilder ivertexbuilder = p_225628_2_.getBuffer(RenderType.func_228644_e_(resourcelocation));
         this.getEntityModel().func_225598_a_(p_225628_1_, ivertexbuilder, p_225628_3_, LivingRenderer.func_229117_c_(p_225628_4_, 0.0F), 1.0F, 1.0F, 1.0F, 1.0F);
      }
   }
}