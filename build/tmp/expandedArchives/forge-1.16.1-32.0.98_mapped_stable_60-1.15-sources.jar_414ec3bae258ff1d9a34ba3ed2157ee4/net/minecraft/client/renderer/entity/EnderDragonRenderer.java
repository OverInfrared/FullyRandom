...
public class EnderDragonRenderer extends EntityRenderer<EnderDragonEntity> {
   ...
   public void func_225623_a_(EnderDragonEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      if (p_225623_1_.deathTicks > 0) {
         ...
         IVertexBuilder ivertexbuilder = p_225623_5_.getBuffer(RenderType.func_239264_a_(DRAGON_EXPLODING_TEXTURES, f2));
      ...
      p_225623_4_.func_227865_b_();
      if (p_225623_1_.closestEnderCrystal != null) {
         p_225623_4_.func_227860_a_();
         float f6 = (float)(p_225623_1_.closestEnderCrystal.func_226277_ct_() - MathHelper.lerp((double)p_225623_3_, p_225623_1_.prevPosX, p_225623_1_.func_226277_ct_()));
         float f8 = (float)(p_225623_1_.closestEnderCrystal.func_226278_cu_() - MathHelper.lerp((double)p_225623_3_, p_225623_1_.prevPosY, p_225623_1_.func_226278_cu_()));
         float f9 = (float)(p_225623_1_.closestEnderCrystal.func_226281_cx_() - MathHelper.lerp((double)p_225623_3_, p_225623_1_.prevPosZ, p_225623_1_.func_226281_cx_()));
         func_229059_a_(f6, f8 + EnderCrystalRenderer.func_229051_a_(p_225623_1_.closestEnderCrystal, p_225623_3_), f9, p_225623_3_, p_225623_1_.ticksExisted, p_225623_4_, p_225623_5_, p_225623_6_);
         p_225623_4_.func_227865_b_();
      }
