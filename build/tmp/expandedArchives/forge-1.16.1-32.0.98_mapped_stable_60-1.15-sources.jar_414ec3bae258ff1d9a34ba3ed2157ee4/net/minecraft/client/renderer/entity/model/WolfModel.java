...
public class WolfModel<T extends WolfEntity> extends TintedAgeableModel<T> {
   ...
   public WolfModel() {
      ...
      this.head.func_78792_a(this.field_228298_b_);
      ...
      this.tail.func_78792_a(this.field_228299_l_);
      this.field_228298_b_.func_78784_a(16, 14).func_228301_a_(-2.0F, -5.0F, 0.0F, 2.0F, 2.0F, 1.0F, 0.0F);
      this.field_228298_b_.func_78784_a(16, 14).func_228301_a_(2.0F, -5.0F, 0.0F, 2.0F, 2.0F, 1.0F, 0.0F);
      this.field_228298_b_.func_78784_a(0, 10).func_228301_a_(-0.5F, 0.0F, -5.0F, 3.0F, 3.0F, 4.0F, 0.0F);
   }
