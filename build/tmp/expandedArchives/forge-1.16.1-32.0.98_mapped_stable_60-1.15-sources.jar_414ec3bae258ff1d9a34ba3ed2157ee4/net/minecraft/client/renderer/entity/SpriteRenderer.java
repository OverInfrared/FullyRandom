...
public class SpriteRenderer<T extends Entity & IRendersAsItem> extends EntityRenderer<T> {
   ...
   public void func_225623_a_(T p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      if (p_225623_1_.ticksExisted >= 2 || !(this.renderManager.info.getRenderViewEntity().getDistanceSq(p_225623_1_) < 12.25D)) {
         ...
         this.itemRenderer.func_229110_a_(p_225623_1_.getItem(), ItemCameraTransforms.TransformType.GROUND, p_225623_6_, OverlayTexture.field_229196_a_, p_225623_4_, p_225623_5_);
