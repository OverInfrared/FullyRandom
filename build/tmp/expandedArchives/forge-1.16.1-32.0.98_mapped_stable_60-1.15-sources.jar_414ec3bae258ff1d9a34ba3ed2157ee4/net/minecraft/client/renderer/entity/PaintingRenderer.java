   ...
   private void func_229122_a_(MatrixStack p_229122_1_, IVertexBuilder p_229122_2_, PaintingEntity p_229122_3_, int p_229122_4_, int p_229122_5_, TextureAtlasSprite p_229122_6_, TextureAtlasSprite p_229122_7_) {
      ...
      for(int k = 0; k < i; ++k) {
         for(int l = 0; l < j; ++l) {
            ...
            int i1 = MathHelper.floor(p_229122_3_.func_226277_ct_());
            int j1 = MathHelper.floor(p_229122_3_.func_226278_cu_() + (double)((f17 + f18) / 2.0F / 16.0F));
            int k1 = MathHelper.floor(p_229122_3_.func_226281_cx_());
            Direction direction = p_229122_3_.getHorizontalFacing();
            if (direction == Direction.NORTH) {
               i1 = MathHelper.floor(p_229122_3_.func_226277_ct_() + (double)((f15 + f16) / 2.0F / 16.0F));
            }

            if (direction == Direction.WEST) {
               k1 = MathHelper.floor(p_229122_3_.func_226281_cx_() - (double)((f15 + f16) / 2.0F / 16.0F));
            }
