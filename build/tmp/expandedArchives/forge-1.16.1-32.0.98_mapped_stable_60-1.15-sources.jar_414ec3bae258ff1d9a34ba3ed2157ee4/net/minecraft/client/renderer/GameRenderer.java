...
public class GameRenderer implements IResourceManagerReloadListener, AutoCloseable {
   ...
   private double getFOVModifier(ActiveRenderInfo p_215311_1_, float p_215311_2_, boolean p_215311_3_) {
      if (this.debugView) {
         ...
         if (p_215311_1_.getRenderViewEntity() instanceof LivingEntity && ((LivingEntity)p_215311_1_.getRenderViewEntity()).func_233643_dh_()) {
         ...
         FluidState fluidstate = p_215311_1_.getFluidState();
   ...
   public void func_228378_a_(float p_228378_1_, long p_228378_2_, MatrixStack p_228378_4_) {
      ...
      net.minecraftforge.client.ForgeHooksClient.dispatchRenderLast(this.mc.worldRenderer, p_228378_4_, p_228378_1_, matrix4f, p_228378_2_);
