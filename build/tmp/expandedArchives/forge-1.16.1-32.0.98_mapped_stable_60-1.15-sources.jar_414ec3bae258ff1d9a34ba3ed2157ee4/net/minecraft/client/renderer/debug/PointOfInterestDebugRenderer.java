...
public class PointOfInterestDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   private boolean func_217694_d(PointOfInterestDebugRenderer.BrainInfo p_217694_1_) {
      ...
      BlockPos blockpos = new BlockPos(playerentity.func_226277_ct_(), p_217694_1_.field_217750_d.getY(), playerentity.func_226281_cx_());
   ...
   private void func_217710_d() {
      DebugRenderer.func_217728_a(this.client.getRenderViewEntity(), 8).ifPresent((p_239317_1_) -> {
