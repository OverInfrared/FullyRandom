...
public abstract class MobRenderer<T extends MobEntity, M extends EntityModel<T>> extends LivingRenderer<T, M> {
   ...
   private <E extends Entity> void func_229118_a_(T p_229118_1_, float p_229118_2_, MatrixStack p_229118_3_, IRenderTypeBuffer p_229118_4_, E p_229118_5_) {
      ...
      Vector3d vector3d = p_229118_1_.func_241205_ce_();
      ...
      double d11 = MathHelper.lerp((double)p_229118_2_, p_229118_1_.prevPosY, p_229118_1_.func_226278_cu_()) + vector3d.y;
      double d12 = MathHelper.lerp((double)p_229118_2_, p_229118_1_.prevPosZ, p_229118_1_.func_226281_cx_()) + d3;
      p_229118_3_.func_227861_a_(d2, vector3d.y, d3);
      ...
      int i = this.func_225624_a_(p_229118_1_, blockpos);
      int j = this.renderManager.getRenderer(p_229118_5_).func_225624_a_(p_229118_5_, blockpos1);
      int k = p_229118_1_.world.func_226658_a_(LightType.SKY, blockpos);
      int l = p_229118_1_.world.func_226658_a_(LightType.SKY, blockpos1);
