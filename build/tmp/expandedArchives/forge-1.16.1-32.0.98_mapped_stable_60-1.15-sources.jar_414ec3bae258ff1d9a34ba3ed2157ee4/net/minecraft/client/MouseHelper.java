...
public class MouseHelper {
   ...
   public void grabMouse() {
      if (this.minecraft.isGameFocused()) {
         if (!this.mouseGrabbed) {
            ...
            InputMappings.setCursorPosAndMode(this.minecraft.func_228018_at_().getHandle(), 212995, this.mouseX, this.mouseY);
   ...
   public void ungrabMouse() {
      if (this.mouseGrabbed) {
         ...
         this.mouseX = (double)(this.minecraft.func_228018_at_().getWidth() / 2);
         this.mouseY = (double)(this.minecraft.func_228018_at_().getHeight() / 2);
         InputMappings.setCursorPosAndMode(this.minecraft.func_228018_at_().getHandle(), 212993, this.mouseX, this.mouseY);
      }
   }
