...
public class LegacyResourcePackWrapperV4 implements IResourcePack {
   ...
   public boolean resourceExists(ResourcePackType type, ResourceLocation location) {
      if (!"minecraft".equals(location.getNamespace())) {
         ...
         if ("textures/misc/enchanted_item_glint.png".equals(s)) {
            ...
            return this.field_239479_h_.resourceExists(type, field_229278_c_);
            ...
            if (field_229281_f_.contains(s)) {
               return this.field_239479_h_.resourceExists(type, field_229276_a_) && this.field_239479_h_.resourceExists(type, location);
               ...
               return this.field_239479_h_.resourceExists(type, field_229277_b_) && this.field_239479_h_.resourceExists(type, location);
            }
         } else {
            return false;
         }
   ...
   public InputStream getResourceStream(ResourcePackType type, ResourceLocation location) throws IOException {
      if (!"minecraft".equals(location.getNamespace())) {
         ...
         if ("textures/entity/iron_golem/iron_golem.png".equals(s)) {
            return this.field_239479_h_.getResourceStream(type, field_229278_c_);
         } else {
            if (field_229281_f_.contains(s)) {
               InputStream inputstream2 = func_229286_a_(this.field_239479_h_.getResourceStream(type, field_229276_a_), this.field_239479_h_.getResourceStream(type, location), 64, 2, 2, 12, 22);
               if (inputstream2 != null) {
                  return inputstream2;
               }
            } else if (field_229282_g_.contains(s)) {
               InputStream inputstream1 = func_229286_a_(this.field_239479_h_.getResourceStream(type, field_229277_b_), this.field_239479_h_.getResourceStream(type, location), 64, 0, 0, 42, 41);
   ...
   public Collection<ResourceLocation> func_225637_a_(ResourcePackType p_225637_1_, String p_225637_2_, String p_225637_3_, int p_225637_4_, Predicate<String> p_225637_5_) {
      return this.field_239479_h_.func_225637_a_(p_225637_1_, p_225637_2_, p_225637_3_, p_225637_4_, p_225637_5_);
   }
