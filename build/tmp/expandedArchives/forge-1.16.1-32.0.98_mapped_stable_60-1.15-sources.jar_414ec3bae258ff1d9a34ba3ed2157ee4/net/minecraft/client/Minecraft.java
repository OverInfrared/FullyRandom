...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
   ...
   public Minecraft(GameConfiguration gameConfig) {
      ...
      this.resourcePackRepository = new ResourcePackList<>(Minecraft::func_228011_a_, this.packFinder, new FolderPackFinder(this.fileResourcepacks, IPackNameDecorator.field_232625_a_));
      ...
      this.setLoadingGui(new ResourceLoadProgressGui(this, this.resourceManager.reloadResources(Util.getServerExecutor(), this, field_223714_G, list), (p_238197_1_) -> {
         Util.acceptOrElse(p_238197_1_, this::func_229988_a_, () -> {
   ...
   private void func_229988_a_(Throwable p_229988_1_) {
      if (this.resourcePackRepository.getEnabledPacks().stream().anyMatch(e -> !e.isAlwaysEnabled())) { //Forge: This caused infinite loop if any resource packs are forced. Such as mod resources. So check if we can disable any.
         ...
         if (p_229988_1_ instanceof SimpleReloadableResourceManager.FailedPackException) {
            itextcomponent = new StringTextComponent(((SimpleReloadableResourceManager.FailedPackException)p_229988_1_).func_241203_a().getName());
         } else {
            itextcomponent = null;
         }
   ...
   public CompletableFuture<Void> reloadResources() {
      if (this.field_213276_aV != null) {
         ...
         if (this.loadingGui instanceof ResourceLoadProgressGui) {
            ...
            this.resourcePackRepository.reloadPacksFromFinders();
            List<IResourcePack> list = this.resourcePackRepository.func_232623_f_();
            this.setLoadingGui(new ResourceLoadProgressGui(this, this.resourceManager.reloadResources(Util.getServerExecutor(), this, field_223714_G, list), (p_238200_2_) -> {
               Util.acceptOrElse(p_238200_2_, this::func_229988_a_, () -> {
   ...
   public void displayGuiScreen(@Nullable Screen guiScreenIn) {
      ...
      if (guiScreenIn != null) {
         ...
         NarratorChatListener.INSTANCE.func_216864_a(guiScreenIn.func_231167_h_());
      } else {
   ...
   private void processKeyBinds() {
      ...
      while(this.gameSettings.keyBindDrop.isPressed()) {
         if (!this.player.isSpectator() && this.player.func_225609_n_(Screen.func_231172_r_())) {
            this.player.swingArm(Hand.MAIN_HAND);
         }
      }
   ...
   private void func_238195_a_(String p_238195_1_, IDynamicRegistries.Impl p_238195_2_, Function<SaveFormat.LevelSave, DatapackCodec> p_238195_3_, Function4<SaveFormat.LevelSave, IDynamicRegistries.Impl, IResourceManager, DatapackCodec, IServerConfiguration> p_238195_4_, boolean p_238195_5_, Minecraft.WorldSelectionType p_238195_6_) {
      ...
      if (p_238195_6_ == Minecraft.WorldSelectionType.NONE || !flag && !flag1) {
         ...
         try {
            ...
            crashreportcategory.func_71507_a("Level Name", iserverconfiguration.getWorldName());
            throw new ReportedException(crashreport);
         }
   ...
   public BackgroundMusicSelector func_238178_U_() {
      if (this.currentScreen instanceof WinGameScreen) {
         ...
         if (this.player.world.func_234923_W_() == World.field_234920_i_) {
            ...
            Biome.Category biome$category = this.player.world.func_226691_t_(this.player.func_233580_cy_()).getCategory();
            if (!this.musicTicker.func_239540_b_(BackgroundMusicTracks.field_232675_f_) && (!this.player.canSwim() || biome$category != Biome.Category.OCEAN && biome$category != Biome.Category.RIVER)) {
               return this.player.world.func_234923_W_() != World.field_234919_h_ && this.player.abilities.isCreativeMode && this.player.abilities.allowFlying ? BackgroundMusicTracks.field_232671_b_ : this.world.func_225523_d_().func_235201_b_(this.player.func_233580_cy_()).func_235094_x_().orElse(BackgroundMusicTracks.field_232676_g_);
            } else {
   ...
   public boolean func_238206_b_(Entity p_238206_1_) {
      return p_238206_1_.func_225510_bt_() || this.player != null && this.player.isSpectator() && this.gameSettings.keyBindSpectatorOutlines.isKeyDown() && p_238206_1_.getType() == EntityType.PLAYER;
   }
   ...
   private static ClientResourcePackInfo func_228011_a_(String p_228011_0_, boolean p_228011_1_, Supplier<IResourcePack> p_228011_2_, IResourcePack p_228011_3_, PackMetadataSection p_228011_4_, ResourcePackInfo.Priority p_228011_5_, IPackNameDecorator p_228011_6_) {
