...
public class BiomeSoundHandler implements IAmbientSoundHandler {
   ...
   public void tick() {
      ...
      this.field_239515_f_.ifPresent((p_239521_1_) -> {
         ...
         BlockPos blockpos = new BlockPos(this.field_239510_a_.func_226277_ct_() + (double)this.field_239513_d_.nextInt(i) - (double)p_239521_1_.func_235037_c_(), this.field_239510_a_.func_226280_cw_() + (double)this.field_239513_d_.nextInt(i) - (double)p_239521_1_.func_235037_c_(), this.field_239510_a_.func_226281_cx_() + (double)this.field_239513_d_.nextInt(i) - (double)p_239521_1_.func_235037_c_());
         int j = world.func_226658_a_(LightType.SKY, blockpos);
         if (j > 0) {
            this.field_239517_h_ -= (float)j / (float)world.getMaxLightLevel() * 0.001F;
         } else {
            this.field_239517_h_ -= (float)(world.func_226658_a_(LightType.BLOCK, blockpos) - 1) / (float)p_239521_1_.func_235035_b_();
         }
         ...
         if (this.field_239517_h_ >= 1.0F) {
            ...
            double d3 = d0 - this.field_239510_a_.func_226277_ct_();
            double d4 = d1 - this.field_239510_a_.func_226280_cw_();
            double d5 = d2 - this.field_239510_a_.func_226281_cx_();
            double d6 = (double)MathHelper.sqrt(d3 * d3 + d4 * d4 + d5 * d5);
            double d7 = d6 + p_239521_1_.func_235039_d_();
            SimpleSound simplesound = SimpleSound.func_239531_b_(p_239521_1_.func_235032_a_(), this.field_239510_a_.func_226277_ct_() + d3 / d6 * d7, this.field_239510_a_.func_226280_cw_() + d4 / d6 * d7, this.field_239510_a_.func_226281_cx_() + d5 / d6 * d7);
