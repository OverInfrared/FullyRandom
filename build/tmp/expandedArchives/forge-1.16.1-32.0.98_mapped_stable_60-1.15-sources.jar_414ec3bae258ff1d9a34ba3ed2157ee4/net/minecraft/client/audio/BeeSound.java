...
public abstract class BeeSound extends TickableSound {
   ...
   public BeeSound(BeeEntity p_i226060_1_, SoundEvent p_i226060_2_, SoundCategory p_i226060_3_) {
      ...
      this.x = (double)((float)p_i226060_1_.func_226277_ct_());
      this.y = (double)((float)p_i226060_1_.func_226278_cu_());
      this.z = (double)((float)p_i226060_1_.func_226281_cx_());
      this.repeat = true;
      this.repeatDelay = 0;
      this.volume = 0.0F;
   }
   ...
   public void tick() {
      ...
      if (!this.field_229357_o_.removed && !this.field_229358_p_) {
         this.x = (double)((float)this.field_229357_o_.func_226277_ct_());
         this.y = (double)((float)this.field_229357_o_.func_226278_cu_());
         this.z = (double)((float)this.field_229357_o_.func_226281_cx_());
