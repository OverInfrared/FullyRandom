...
public class MinecartTickableSound extends TickableSound {
   ...
   public MinecartTickableSound(AbstractMinecartEntity minecartIn) {
      ...
      this.repeatDelay = 0;
      this.volume = 0.0F;
      this.x = (double)((float)minecartIn.func_226277_ct_());
      this.y = (double)((float)minecartIn.func_226278_cu_());
      this.z = (double)((float)minecartIn.func_226281_cx_());
   }
   ...
   public void tick() {
      if (this.minecart.removed) {
         ...
         this.x = (double)((float)this.minecart.func_226277_ct_());
         this.y = (double)((float)this.minecart.func_226278_cu_());
         this.z = (double)((float)this.minecart.func_226281_cx_());
