...
public class KeyboardListener {
      ...
      if (this.debugCrashKeyPressTime > 0L && this.debugCrashKeyPressTime < Util.milliTime() - 100L) {
         ...
         case 67:
            if (this.mc.player.hasReducedDebug()) {
               ...
               this.setClipboardString(String.format(Locale.ROOT, "/execute in %s run tp @s %.2f %.2f %.2f %.2f %.2f", this.mc.player.world.func_234923_W_().func_240901_a_(), this.mc.player.func_226277_ct_(), this.mc.player.func_226278_cu_(), this.mc.player.func_226281_cx_(), this.mc.player.rotationYaw, this.mc.player.rotationPitch));
               return true;
            }
         case 68:
   ...
   public String getClipboardString() {
      return this.clipboardHelper.getClipboardString(this.mc.func_228018_at_().getHandle(), (p_227998_1_, p_227998_2_) -> {
   ...
   public void setClipboardString(String string) {
      this.clipboardHelper.setClipboardString(this.mc.func_228018_at_().getHandle(), string);
   }
