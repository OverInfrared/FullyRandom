...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
   ...
   public ClientPlayerEntity(Minecraft p_i232461_1_, ClientWorld p_i232461_2_, ClientPlayNetHandler p_i232461_3_, StatisticsManager p_i232461_4_, ClientRecipeBook p_i232461_5_, boolean p_i232461_6_, boolean p_i232461_7_) {
      ...
      this.ambientSoundHandlers.add(new BiomeSoundHandler(this, p_i232461_1_.getSoundHandler(), p_i232461_2_.func_225523_d_()));
   }
   ...
   public void livingTick() {
      ...
      this.field_239203_ch_ = !this.abilities.isFlying && !this.isSwimming() && this.isPoseClear(Pose.CROUCHING) && (this.func_225608_bj_() || !this.isSleeping() && !this.isPoseClear(Pose.STANDING));
      ...
      if (this.isInWater() && this.movementInput.field_228350_h_ && this.func_241208_cS_()) {
