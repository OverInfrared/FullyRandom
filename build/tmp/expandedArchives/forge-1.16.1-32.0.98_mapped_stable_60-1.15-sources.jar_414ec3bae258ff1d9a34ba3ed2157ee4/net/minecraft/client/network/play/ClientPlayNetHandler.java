...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
   ...
   public void handleJoinGame(SJoinGamePacket packetIn) {
      ...
      this.world = new ClientWorld(this, clientworld$clientworldinfo, registrykey1, registrykey, dimensiontype, this.viewDistance, this.client::getProfiler, this.client.worldRenderer, flag, packetIn.func_229742_c_());
      ...
      this.client.player.func_228355_a_(packetIn.func_229743_k_());
   ...
   public void handleSpawnObject(SSpawnObjectPacket packetIn) {
      ...
      if (entity != null) {
         ...
         entity.func_225653_b_(d0, d1, d2);
   ...
   public void handlePlayerPosLook(SPlayerPositionLookPacket packetIn) {
      ...
      if (flag) {
         d0 = vector3d.getX();
         d1 = playerentity.func_226277_ct_() + packetIn.getX();
      ...
      if (flag1) {
         d2 = vector3d.getY();
         d3 = playerentity.func_226278_cu_() + packetIn.getY();
      ...
      if (flag2) {
         d4 = vector3d.getZ();
         d5 = playerentity.func_226281_cx_() + packetIn.getZ();
   ...
   public void handleChunkData(SChunkDataPacket packetIn) {
      ...
      Chunk chunk = this.world.getChunkProvider().func_228313_a_(i, j, packetIn.func_229739_i_(), packetIn.getReadBuffer(), packetIn.getHeightmapTags(), packetIn.getAvailableSections(), packetIn.isFullChunk());
      ...
      if (!packetIn.func_241782_g_()) {
         this.world.func_225524_e_().func_215571_a(chunk.getPos(), false);
         int l = packetIn.getAvailableSections();

         for(int i1 = 0; i1 < 16; ++i1) {
            if ((l & 1 << i1) != 0) {
               this.world.func_225524_e_().setData(LightType.BLOCK, SectionPos.from(chunk.getPos(), i1), new NibbleArray(), false);
               this.world.func_225524_e_().setData(LightType.SKY, SectionPos.from(chunk.getPos(), i1), new NibbleArray(), false);
            }
         }

         this.world.func_225524_e_().tick(Integer.MAX_VALUE, true, true);
         this.world.func_225524_e_().func_215571_a(chunk.getPos(), true);
         chunk.getLightSources().forEach((p_241666_2_) -> {
            this.world.func_225524_e_().func_215573_a(p_241666_2_, chunk.getLightValue(p_241666_2_));
         });
      }
   ...
   public void processChunkUnload(SUnloadChunkPacket packetIn) {
      ...
      WorldLightManager worldlightmanager = clientchunkprovider.func_212863_j_();
   ...
   public void handleCollectItem(SCollectItemPacket packetIn) {
      ...
      if (entity != null) {
         ...
         this.client.particles.addEffect(new ItemPickupParticle(this.client.getRenderManager(), this.client.func_228019_au_(), this.world, entity, livingentity));
         ...
         for(int i : packetIn.getPassengerIds()) {
            ...
            if (entity1 != null) {
               ...
               if (entity1 == this.client.player && !flag) {
                  this.client.ingameGUI.setOverlayMessage(new TranslationTextComponent("mount.onboard", this.client.gameSettings.field_228046_af_.func_238171_j_()), false);
               }
            }
         }
   ...
   public void handleRespawn(SRespawnPacket packetIn) {
      ...
      if (registrykey1 != clientplayerentity.world.func_234923_W_()) {
         ...
         this.field_239161_g_ = clientworld$clientworldinfo;
         this.world = new ClientWorld(this, clientworld$clientworldinfo, registrykey1, registrykey, dimensiontype, this.viewDistance, this.client::getProfiler, this.client.worldRenderer, flag, packetIn.func_229747_c_());
      ...
      ClientPlayerEntity clientplayerentity1 = this.client.playerController.func_239167_a_(this.world, clientplayerentity.getStats(), clientplayerentity.getRecipeBook(), clientplayerentity.func_225608_bj_(), clientplayerentity.isSprinting());
   ...
   public void handleSignEditorOpen(SOpenSignMenuPacket packetIn) {
      ...
      if (!(tileentity instanceof SignTileEntity)) {
         ...
         tileentity.func_226984_a_(this.world, packetIn.getSignPosition());
      }
         ...
         if (s.startsWith("level://")) {
            try {
               ...
               if (file2.isFile()) {
                  ...
                  CompletableFuture<?> completablefuture = this.client.getPackFinder().func_217816_a(file2, IPackNameDecorator.field_232627_c_);
   ...
   public void handleUpdateLight(SUpdateLightPacket packetIn) {
      ...
      int i = packetIn.getChunkX();
      int j = packetIn.getChunkZ();
      WorldLightManager worldlightmanager = this.world.getChunkProvider().func_212863_j_();
