...
public abstract class AbstractOption {
   ...
   public static final SliderPercentageOption field_238235_g_ = new SliderPercentageOption("options.chat.line_spacing", 0.0D, 1.0D, 0.0F, (p_238287_0_) -> {
      ...
      return p_238297_1_.func_238238_a_().func_240702_b_((int)(p_238297_1_.func_216726_a(p_238297_1_.get(p_238297_0_)) * 100.0D) + "%");
   });
   ...
   public static final SliderPercentageOption MOUSE_WHEEL_SENSITIVITY = new SliderMultiplierOption("options.mouseWheelSensitivity", 0.01D, 10.0D, 0.01F, (p_216581_0_) -> {
      ...
      return p_216675_1_.func_238238_a_().func_240702_b_(String.format("%.2f", p_216675_1_.func_216725_b(d0)));
   });
   ...
   public static final SliderPercentageOption ACCESSIBILITY_TEXT_BACKGROUND_OPACITY = new SliderPercentageOption("options.accessibility.text_background_opacity", 0.0D, 1.0D, 0.0F, (p_216597_0_) -> {
      ...
      return p_216626_1_.func_238238_a_().func_240702_b_((int)(p_216626_1_.func_216726_a(p_216626_1_.get(p_216626_0_)) * 100.0D) + "%");
   });
   public static final IteratableOption AO = new IteratableOption("options.ao", (p_216653_0_, p_216653_1_) -> {
      ...
      return p_216630_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216630_0_.ambientOcclusionStatus.func_216569_b()));
   });
   public static final IteratableOption ATTACK_INDICATOR = new IteratableOption("options.attackIndicator", (p_216615_0_, p_216615_1_) -> {
      ...
      return p_216609_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216609_0_.attackIndicator.func_216748_b()));
   });
   public static final IteratableOption CHAT_VISIBILITY = new IteratableOption("options.chat.visibility", (p_216640_0_, p_216640_1_) -> {
      ...
      return p_216598_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216598_0_.chatVisibility.func_221251_b()));
   });
   ...
   public static final IteratableOption PARTICLES = new IteratableOption("options.particles", (p_216622_0_, p_216622_1_) -> {
      ...
      return p_216616_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216616_0_.particles.func_216831_a()));
   });
   public static final IteratableOption RENDER_CLOUDS = new IteratableOption("options.renderClouds", (p_216605_0_, p_216605_1_) -> {
      ...
      return p_216602_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_216602_0_.cloudOption.func_216803_b()));
   });
   ...
   public static final BooleanOption FORCE_UNICODE_FONT = new BooleanOption("options.forceUnicodeFont", (p_216657_0_) -> {
      ...
      Minecraft minecraft = Minecraft.getInstance();
      if (minecraft.func_228018_at_() != null) {
   ...
   public static final IteratableOption field_228034_N_ = new IteratableOption("key.sneak", (p_228043_0_, p_228043_1_) -> {
      ...
      return p_228041_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_228041_0_.field_228044_Y_ ? "options.key.toggle" : "options.key.hold"));
   });
   public static final IteratableOption field_228035_O_ = new IteratableOption("key.sprint", (p_228039_0_, p_228039_1_) -> {
      ...
      return p_228037_1_.func_238238_a_().func_230529_a_(new TranslationTextComponent(p_228037_0_.field_228045_Z_ ? "options.key.toggle" : "options.key.hold"));
   });
