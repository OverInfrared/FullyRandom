...
public abstract class TexturedParticle extends Particle {
   ...
   public void func_225606_a_(IVertexBuilder p_225606_1_, ActiveRenderInfo p_225606_2_, float p_225606_3_) {
      ...
      float f = (float)(MathHelper.lerp((double)p_225606_3_, this.prevPosX, this.posX) - vector3d.getX());
      float f1 = (float)(MathHelper.lerp((double)p_225606_3_, this.prevPosY, this.posY) - vector3d.getY());
      float f2 = (float)(MathHelper.lerp((double)p_225606_3_, this.prevPosZ, this.posZ) - vector3d.getZ());
