...
public class EmitterParticle extends MetaParticle {
   ...
   private EmitterParticle(ClientWorld p_i232453_1_, Entity p_i232453_2_, IParticleData p_i232453_3_, int p_i232453_4_, Vector3d p_i232453_5_) {
      super(p_i232453_1_, p_i232453_2_.func_226277_ct_(), p_i232453_2_.func_226283_e_(0.5D), p_i232453_2_.func_226281_cx_(), p_i232453_5_.x, p_i232453_5_.y, p_i232453_5_.z);
   ...
   public void tick() {
      for(int i = 0; i < 16; ++i) {
         ...
         if (!(d0 * d0 + d1 * d1 + d2 * d2 > 1.0D)) {
            double d3 = this.attachedEntity.func_226275_c_(d0 / 4.0D);
            double d4 = this.attachedEntity.func_226283_e_(0.5D + d1 / 4.0D);
            double d5 = this.attachedEntity.func_226285_f_(d2 / 4.0D);
