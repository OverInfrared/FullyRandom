...
public class BambooBlock extends Block implements IGrowable {
   ...
   public void func_225542_b_(BlockState p_225542_1_, ServerWorld p_225542_2_, BlockPos p_225542_3_, Random p_225542_4_) {
      if (p_225542_1_.get(PROPERTY_STAGE) == 0) {
         if (p_225542_4_.nextInt(3) == 0 && p_225542_2_.isAirBlock(p_225542_3_.up()) && p_225542_2_.func_226659_b_(p_225542_3_.up(), 0) >= 9) {
            int i = this.getNumBambooBlocksBelow(p_225542_2_, p_225542_3_) + 1;
            if (i < 16 && net.minecraftforge.common.ForgeHooks.onCropsGrowPre(p_225542_2_, p_225542_3_, p_225542_1_, p_225542_4_.nextInt(3) == 0 && p_225542_2_.isAirBlock(p_225542_3_.up()) && p_225542_2_.func_226659_b_(p_225542_3_.up(), 0) >= 9)) {
               this.grow(p_225542_1_, p_225542_2_, p_225542_3_, p_225542_4_, i);
   ...
   public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
      return worldIn.getBlockState(pos.func_177977_b()).func_235714_a_(BlockTags.BAMBOO_PLANTABLE_ON);
   }
   ...
   protected int getNumBambooBlocksBelow(IBlockReader worldIn, BlockPos pos) {
      int i;
      for(i = 0; i < 16 && worldIn.getBlockState(pos.func_177979_c(i + 1)).isIn(Blocks.BAMBOO); ++i) {
      }
