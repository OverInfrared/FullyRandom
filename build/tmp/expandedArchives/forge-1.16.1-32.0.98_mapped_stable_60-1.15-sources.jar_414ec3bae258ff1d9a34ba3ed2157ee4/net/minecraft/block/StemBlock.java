...
public class StemBlock extends BushBlock implements IGrowable {
   ...
   public void func_225542_b_(BlockState p_225542_1_, ServerWorld p_225542_2_, BlockPos p_225542_3_, Random p_225542_4_) {
      ...
      if (p_225542_2_.func_226659_b_(p_225542_3_, 0) >= 9) {
         ...
         if (net.minecraftforge.common.ForgeHooks.onCropsGrowPre(p_225542_2_, p_225542_3_, p_225542_1_, p_225542_4_.nextInt((int)(25.0F / f) + 1) == 0)) {
            ...
            if (i < 7) {
               p_225542_2_.setBlockState(p_225542_3_, p_225542_1_.with(AGE, Integer.valueOf(i + 1)), 2);
            } else {
               Direction direction = Direction.Plane.HORIZONTAL.random(p_225542_4_);
               BlockPos blockpos = p_225542_3_.offset(direction);
               BlockState blockstate = p_225542_2_.getBlockState(blockpos.func_177977_b());
               Block block = blockstate.getBlock();
               if (p_225542_2_.isAirBlock(blockpos) && (blockstate.canSustainPlant(p_225542_2_, blockpos.func_177977_b(), Direction.UP, this) || block == Blocks.FARMLAND || block == Blocks.DIRT || block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.GRASS_BLOCK)) {
                  p_225542_2_.setBlockState(blockpos, this.crop.getDefaultState());
                  p_225542_2_.setBlockState(p_225542_3_, this.crop.getAttachedStem().getDefaultState().with(HorizontalBlock.HORIZONTAL_FACING, direction));
               }
            }
   ...
   public void func_225535_a_(ServerWorld p_225535_1_, Random p_225535_2_, BlockPos p_225535_3_, BlockState p_225535_4_) {
      ...
      if (i == 7) {
         blockstate.func_227034_b_(p_225535_1_, p_225535_3_, p_225535_1_.rand);
      }
