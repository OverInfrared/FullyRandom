...
public class ScaffoldingBlock extends Block implements IWaterLoggable {
   ...
   public void func_225534_a_(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      ...
      if (blockstate.get(field_220118_a) == 7) {
         if (p_225534_1_.get(field_220118_a) == 7) {
            p_225534_2_.addEntity(new FallingBlockEntity(p_225534_2_, (double)p_225534_3_.getX() + 0.5D, (double)p_225534_3_.getY(), (double)p_225534_3_.getZ() + 0.5D, blockstate.with(WATERLOGGED, Boolean.valueOf(false))));
         } else {
   ...
   private boolean func_220116_a(IBlockReader p_220116_1_, BlockPos p_220116_2_, int p_220116_3_) {
      return p_220116_3_ > 0 && !p_220116_1_.getBlockState(p_220116_2_.func_177977_b()).isIn(this);
   }
