...
public class BellBlock extends ContainerBlock {
   ...
   public static final EnumProperty<BellAttachment> field_220134_b = BlockStateProperties.BELL_ATTACHMENT;
   ...
   public ActionResultType func_225533_a_(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      return this.func_226884_a_(p_225533_2_, p_225533_1_, p_225533_6_, p_225533_4_, true) ? ActionResultType.func_233537_a_(p_225533_2_.isRemote) : ActionResultType.PASS;
   }
   ...
   public BlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      if (direction$axis == Direction.Axis.Y) {
         ...
         boolean flag1 = world.getBlockState(blockpos.func_177977_b()).func_224755_d(world, blockpos.func_177977_b(), Direction.UP);
