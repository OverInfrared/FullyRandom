...
public class CampfireBlock extends ContainerBlock implements IWaterLoggable {
   ...
   public BlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      return this.getDefaultState().with(WATERLOGGED, Boolean.valueOf(flag)).with(SIGNAL_FIRE, Boolean.valueOf(this.isHayBlock(iworld.getBlockState(blockpos.func_177977_b())))).with(LIT, Boolean.valueOf(!flag)).with(FACING, context.getPlacementHorizontalFacing());
   }
   ...
   public static boolean func_235474_a_(World p_235474_0_, BlockPos p_235474_1_) {
      for(int i = 1; i <= 5; ++i) {
         ...
         if (flag) {
            BlockState blockstate1 = p_235474_0_.getBlockState(blockpos.func_177977_b());
