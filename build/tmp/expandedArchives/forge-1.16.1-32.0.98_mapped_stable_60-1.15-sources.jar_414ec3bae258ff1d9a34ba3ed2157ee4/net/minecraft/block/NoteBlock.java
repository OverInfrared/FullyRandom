...
public class NoteBlock extends Block {
   ...
   public ActionResultType func_225533_a_(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      if (p_225533_2_.isRemote) {
         ...
         int _new = net.minecraftforge.common.ForgeHooks.onNoteChange(p_225533_2_, p_225533_3_, p_225533_1_, p_225533_1_.get(NOTE), p_225533_1_.func_235896_a_(NOTE).get(NOTE));
         if (_new == -1) return ActionResultType.FAIL;
         p_225533_1_ = p_225533_1_.with(NOTE, _new);
