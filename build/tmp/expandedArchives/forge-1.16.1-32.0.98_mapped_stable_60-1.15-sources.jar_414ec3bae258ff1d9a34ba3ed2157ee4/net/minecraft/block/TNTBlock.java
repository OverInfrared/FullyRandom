...
public class TNTBlock extends Block {
   ...
   private static void explode(World worldIn, BlockPos pos, @Nullable LivingEntity entityIn) {
      if (!worldIn.isRemote) {
         ...
         worldIn.addEntity(tntentity);
         worldIn.playSound((PlayerEntity)null, tntentity.func_226277_ct_(), tntentity.func_226278_cu_(), tntentity.func_226281_cx_(), SoundEvents.ENTITY_TNT_PRIMED, SoundCategory.BLOCKS, 1.0F, 1.0F);
      }
   }
