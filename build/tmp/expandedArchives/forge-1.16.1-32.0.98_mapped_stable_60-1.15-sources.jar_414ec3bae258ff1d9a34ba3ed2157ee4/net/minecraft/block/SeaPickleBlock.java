...
public class SeaPickleBlock extends BushBlock implements IGrowable, IWaterLoggable {
   ...
   public void func_225535_a_(ServerWorld p_225535_1_, Random p_225535_2_, BlockPos p_225535_3_, BlockState p_225535_4_) {
      if (!isInBadEnvironment(p_225535_4_) && p_225535_1_.getBlockState(p_225535_3_.func_177977_b()).func_235714_a_(BlockTags.CORAL_BLOCKS)) {
         int i = 5;
         int j = 1;
         int k = 2;
         int l = 0;
         ...
         for(int k1 = 0; k1 < 5; ++k1) {
            for(int l1 = 0; l1 < j; ++l1) {
               ...
               for(int j2 = i2 - 2; j2 < i2; ++j2) {
                  ...
                  if (blockpos != p_225535_3_ && p_225535_2_.nextInt(6) == 0 && p_225535_1_.getBlockState(blockpos).isIn(Blocks.WATER)) {
                     BlockState blockstate = p_225535_1_.getBlockState(blockpos.func_177977_b());
