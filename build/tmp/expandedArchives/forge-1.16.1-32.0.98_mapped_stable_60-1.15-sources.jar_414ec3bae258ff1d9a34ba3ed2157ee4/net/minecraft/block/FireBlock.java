...
public class FireBlock extends AbstractFireBlock {
   ...
   public void func_225534_a_(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      p_225534_2_.getPendingBlockTicks().scheduleTick(p_225534_3_, this, func_235495_a_(p_225534_2_.rand));
      if (p_225534_2_.getGameRules().getBoolean(GameRules.DO_FIRE_TICK)) {
         ...
         BlockState blockstate = p_225534_2_.getBlockState(p_225534_3_.func_177977_b());
                     ...
                     if (l != 0 || j1 != 0 || i1 != 0) {
                        ...
                        if (l1 > 0) {
                           ...
                           if (i2 > 0 && p_225534_4_.nextInt(k1) <= i2 && (!p_225534_2_.isRaining() || !this.canDie(p_225534_2_, blockpos$mutable))) {
                              ...
                              p_225534_2_.setBlockState(blockpos$mutable, this.func_235494_a_(p_225534_2_, blockpos$mutable, j2), 3);
                           }
                        }
                     }
                  }
