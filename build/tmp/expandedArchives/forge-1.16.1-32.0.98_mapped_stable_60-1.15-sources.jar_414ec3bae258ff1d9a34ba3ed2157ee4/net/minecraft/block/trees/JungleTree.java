...
public class JungleTree extends BigTree {
   ...
   protected ConfiguredFeature<BaseTreeFeatureConfig, ?> func_225546_b_(Random p_225546_1_, boolean p_225546_2_) {
      return (new TreeFeature(BaseTreeFeatureConfig.field_236676_a_)).func_225566_b_(DefaultBiomeFeatures.field_226808_c_);
   }

   @Nullable
   protected ConfiguredFeature<BaseTreeFeatureConfig, ?> func_225547_a_(Random p_225547_1_) {
      return Feature.field_236291_c_.func_225566_b_(DefaultBiomeFeatures.field_226825_t_);
   }
}