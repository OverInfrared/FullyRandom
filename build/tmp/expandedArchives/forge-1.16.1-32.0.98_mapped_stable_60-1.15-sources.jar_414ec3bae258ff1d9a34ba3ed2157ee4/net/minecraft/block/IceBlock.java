...
public class IceBlock extends BreakableBlock {
   ...
   public void harvestBlock(World worldIn, PlayerEntity player, BlockPos pos, BlockState state, @Nullable TileEntity te, ItemStack stack) {
      ...
      if (EnchantmentHelper.getEnchantmentLevel(Enchantments.SILK_TOUCH, stack) == 0) {
         ...
         Material material = worldIn.getBlockState(pos.func_177977_b()).getMaterial();
   ...
   public void func_225542_b_(BlockState p_225542_1_, ServerWorld p_225542_2_, BlockPos p_225542_3_, Random p_225542_4_) {
      if (p_225542_2_.func_226658_a_(LightType.BLOCK, p_225542_3_) > 11 - p_225542_1_.getOpacity(p_225542_2_, p_225542_3_)) {
         this.turnIntoWater(p_225542_1_, p_225542_2_, p_225542_3_);
      }
