...
public class FarmlandBlock extends Block {
   ...
   public void func_225542_b_(BlockState p_225542_1_, ServerWorld p_225542_2_, BlockPos p_225542_3_, Random p_225542_4_) {
      int i = p_225542_1_.get(MOISTURE);
      if (!hasWater(p_225542_2_, p_225542_3_) && !p_225542_2_.isRainingAt(p_225542_3_.up())) {
         if (i > 0) {
            p_225542_2_.setBlockState(p_225542_3_, p_225542_1_.with(MOISTURE, Integer.valueOf(i - 1)), 2);
         } else if (!hasCrops(p_225542_2_, p_225542_3_)) {
            turnToDirt(p_225542_1_, p_225542_2_, p_225542_3_);
         }
      } else if (i < 7) {
         p_225542_2_.setBlockState(p_225542_3_, p_225542_1_.with(MOISTURE, Integer.valueOf(7)), 2);
      }
