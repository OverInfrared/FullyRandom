...
public class RespawnAnchorBlock extends Block {
   ...
   public ActionResultType func_225533_a_(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      ...
      if (p_225533_5_ == Hand.MAIN_HAND && !func_235561_a_(itemstack) && func_235561_a_(p_225533_4_.getHeldItem(Hand.OFF_HAND))) {
      ...
      } else if (p_225533_1_.get(field_235559_a_) == 0) {
         return ActionResultType.PASS;
         ...
         if (!p_225533_2_.isRemote) {
            ...
            if (serverplayerentity.func_241141_L_() != p_225533_2_.func_234923_W_() || !serverplayerentity.func_241140_K_().equals(p_225533_3_)) {
               serverplayerentity.func_241153_a_(p_225533_2_.func_234923_W_(), p_225533_3_, false, true);
               p_225533_2_.playSound((PlayerEntity)null, (double)p_225533_3_.getX() + 0.5D, (double)p_225533_3_.getY() + 0.5D, (double)p_225533_3_.getZ() + 0.5D, SoundEvents.field_232819_mt_, SoundCategory.BLOCKS, 1.0F, 1.0F);
   ...
   private static boolean func_235566_a_(BlockPos p_235566_0_, World p_235566_1_) {
      ...
      if (!fluidstate.isTagged(FluidTags.WATER)) {
         ...
         if (f < 2.0F) {
            ...
            FluidState fluidstate1 = p_235566_1_.getFluidState(p_235566_0_.func_177977_b());
