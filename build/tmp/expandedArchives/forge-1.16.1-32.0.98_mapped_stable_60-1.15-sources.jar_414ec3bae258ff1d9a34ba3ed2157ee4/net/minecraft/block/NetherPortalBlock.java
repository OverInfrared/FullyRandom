...
public class NetherPortalBlock extends Block {
   ...
   public void func_225542_b_(BlockState p_225542_1_, ServerWorld p_225542_2_, BlockPos p_225542_3_, Random p_225542_4_) {
      if (p_225542_2_.func_230315_m_().func_236043_f_() && p_225542_2_.getGameRules().getBoolean(GameRules.DO_MOB_SPAWNING) && p_225542_4_.nextInt(2000) < p_225542_2_.getDifficulty().getId()) {
         while(p_225542_2_.getBlockState(p_225542_3_).isIn(this)) {
            p_225542_3_ = p_225542_3_.func_177977_b();
         }

         if (p_225542_2_.getBlockState(p_225542_3_).canEntitySpawn(p_225542_2_, p_225542_3_, EntityType.field_233592_ba_)) {
            Entity entity = EntityType.field_233592_ba_.spawn(p_225542_2_, (CompoundNBT)null, (ITextComponent)null, (PlayerEntity)null, p_225542_3_.up(), SpawnReason.STRUCTURE, false, false);
            if (entity != null) {
   ...
   public static class Size {
      ...
      public Size(IWorld worldIn, BlockPos pos, Direction.Axis axisIn) {
         ...
         for(BlockPos blockpos = pos; pos.getY() > blockpos.getY() - 21 && pos.getY() > 0 && this.func_196900_a(worldIn.getBlockState(pos.func_177977_b())); pos = pos.func_177977_b()) {
         }
      ...
      protected int getDistanceUntilEdge(BlockPos pos, Direction directionIn) {
         ...
         for(i = 0; i < 22; ++i) {
            ...
            if (!this.func_196900_a(this.world.getBlockState(blockpos)) || !this.world.getBlockState(blockpos.func_177977_b()).isPortalFrame(world, blockpos.func_177977_b())) {
               break;
            }
         }
