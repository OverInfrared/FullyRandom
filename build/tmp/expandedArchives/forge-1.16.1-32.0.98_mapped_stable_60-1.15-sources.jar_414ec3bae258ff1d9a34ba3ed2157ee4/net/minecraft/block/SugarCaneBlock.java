...
public class SugarCaneBlock extends Block implements net.minecraftforge.common.IPlantable {
   ...
   public void func_225542_b_(BlockState p_225542_1_, ServerWorld p_225542_2_, BlockPos p_225542_3_, Random p_225542_4_) {
      if (p_225542_2_.isAirBlock(p_225542_3_.up())) {
         int i;
         ...
         if (i < 3) {
            ...
            if (j == 15) {
               p_225542_2_.setBlockState(p_225542_3_.up(), this.getDefaultState());
               p_225542_2_.setBlockState(p_225542_3_, p_225542_1_.with(AGE, Integer.valueOf(0)), 4);
            } else {
