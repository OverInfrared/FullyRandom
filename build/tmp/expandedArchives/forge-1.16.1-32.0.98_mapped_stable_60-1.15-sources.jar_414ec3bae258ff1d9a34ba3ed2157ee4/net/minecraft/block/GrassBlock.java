      ...
      for(int i = 0; i < 128; ++i) {
         ...
         while(true) {
            if (j >= i / 16) {
               ...
               if (blockstate2.isIn(blockstate.getBlock()) && p_225535_2_.nextInt(10) == 0) {
            ...
            if (!p_225535_1_.getBlockState(blockpos1.func_177977_b()).isIn(this) || p_225535_1_.getBlockState(blockpos1).func_235785_r_(p_225535_1_, blockpos1)) {
               break;
            }
