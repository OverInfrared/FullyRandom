   ...
   public ActionResultType func_225533_a_(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      if (p_225533_2_.isRemote) {
         ...
         if (!func_235330_a_(p_225533_2_)) {
            ...
            if (p_225533_2_.getBlockState(blockpos).isIn(this)) {
               p_225533_2_.removeBlock(blockpos, false);
            }

            p_225533_2_.func_230546_a_((Entity)null, DamageSource.func_233546_a_(), (IExplosionContext)null, (double)p_225533_3_.getX() + 0.5D, (double)p_225533_3_.getY() + 0.5D, (double)p_225533_3_.getZ() + 0.5D, 5.0F, true, Explosion.Mode.DESTROY);
            return ActionResultType.SUCCESS;
         } else if (p_225533_1_.get(OCCUPIED)) {
      ...
      if (voxelshape.getEnd(Direction.Axis.Y) > 0.4375D) {
         ...
         if (voxelshape1.isEmpty()) {
            ...
            if ((double)p_220175_2_.getY() - d0 > 2.0D) {
               ...
               return p_220175_1_.func_226664_a_(axisalignedbb) && p_220175_1_.func_234853_a_(axisalignedbb.expand(0.0D, (double)-0.2F, 0.0D)).noneMatch(p_220175_0_::func_233597_a_) ? Optional.of(vector3d) : Optional.empty();
            }
         }
      }
   }
