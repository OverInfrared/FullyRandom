...
public class HoneyBlock extends BreakableBlock {
   ...
   private boolean func_226935_a_(BlockPos p_226935_1_, Entity p_226935_2_) {
      if (p_226935_2_.func_233570_aj_()) {
         ...
         double d0 = Math.abs((double)p_226935_1_.getX() + 0.5D - p_226935_2_.func_226277_ct_());
         double d1 = Math.abs((double)p_226935_1_.getZ() + 0.5D - p_226935_2_.func_226281_cx_());
   ...
   private static void func_226932_a_(Entity p_226932_0_, int p_226932_1_) {
      if (p_226932_0_.world.isRemote) {
         ...
         for(int i = 0; i < p_226932_1_; ++i) {
            p_226932_0_.world.addParticle(new BlockParticleData(ParticleTypes.BLOCK, blockstate), p_226932_0_.func_226277_ct_(), p_226932_0_.func_226278_cu_(), p_226932_0_.func_226281_cx_(), 0.0D, 0.0D, 0.0D);
         }
