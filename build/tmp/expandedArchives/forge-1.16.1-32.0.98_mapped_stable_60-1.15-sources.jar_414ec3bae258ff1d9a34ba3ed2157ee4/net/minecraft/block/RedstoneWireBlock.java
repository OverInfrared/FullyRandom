...
public class RedstoneWireBlock extends Block {
   ...
   public void updateDiagonalNeighbors(BlockState state, IWorld worldIn, BlockPos pos, int flags, int p_196248_5_) {
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         ...
         if (redstoneside != RedstoneSide.NONE && !worldIn.getBlockState(blockpos$mutable.func_239622_a_(pos, direction)).isIn(this)) {
            ...
            blockpos$mutable.func_239622_a_(pos, direction).func_189536_c(Direction.UP);
   ...
   private RedstoneSide func_235545_a_(IBlockReader p_235545_1_, BlockPos p_235545_2_, Direction p_235545_3_, boolean p_235545_4_) {
      ...
      if (p_235545_4_) {
         ...
         if (flag && canConnectTo(p_235545_1_.getBlockState(blockpos.up()), p_235545_1_, blockpos.up(), null) ) {
            if (blockstate.func_224755_d(p_235545_1_, blockpos, p_235545_3_.getOpposite())) {
      ...
      return !canConnectTo(blockstate, p_235545_1_, blockpos, p_235545_3_) && (blockstate.isNormalCube(p_235545_1_, blockpos) || !canConnectTo(p_235545_1_.getBlockState(blockpos.func_177977_b()), p_235545_1_, blockpos.func_177977_b(), null)) ? RedstoneSide.NONE : RedstoneSide.SIDE;
   }
   ...
   private boolean func_235552_b_(IBlockReader p_235552_1_, BlockPos p_235552_2_, BlockState p_235552_3_) {
      return p_235552_3_.func_224755_d(p_235552_1_, p_235552_2_, Direction.UP) || p_235552_3_.isIn(Blocks.HOPPER);
   }
      ...
      if (i < 15) {
         for(Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (blockstate.isNormalCube(p_235546_1_, blockpos) && !p_235546_1_.getBlockState(blockpos1).isNormalCube(p_235546_1_, blockpos1)) {
               ...
               j = Math.max(j, this.func_235557_o_(p_235546_1_.getBlockState(blockpos.func_177977_b())));
            }
         }
      }
   ...
   private void func_235553_d_(World p_235553_1_, BlockPos p_235553_2_) {
      ...
      for(Direction direction1 : Direction.Plane.HORIZONTAL) {
         ...
         if (p_235553_1_.getBlockState(blockpos).isNormalCube(p_235553_1_, blockpos)) {
            ...
            this.notifyWireNeighborsOfStateChange(p_235553_1_, blockpos.func_177977_b());
         }
      }
   ...
   public ActionResultType func_225533_a_(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      if (!p_225533_4_.abilities.allowEdit) {
         ...
         if (func_235555_m_(p_225533_1_) || func_235556_n_(p_225533_1_)) {
            BlockState blockstate = func_235555_m_(p_225533_1_) ? this.getDefaultState() : this.field_235543_o_;
            blockstate = blockstate.with(POWER, p_225533_1_.get(POWER));
            blockstate = this.func_235544_a_(p_225533_2_, blockstate, p_225533_3_);
            if (blockstate != p_225533_1_) {
               p_225533_2_.setBlockState(p_225533_3_, blockstate, 3);
