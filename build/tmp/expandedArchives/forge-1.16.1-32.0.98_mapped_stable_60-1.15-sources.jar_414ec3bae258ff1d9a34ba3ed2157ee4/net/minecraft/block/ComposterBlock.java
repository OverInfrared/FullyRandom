...
public class ComposterBlock extends Block implements ISidedInventoryProvider {
   ...
   public ActionResultType func_225533_a_(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      ...
      if (i < 8 && CHANCES.containsKey(itemstack.getItem())) {
         if (i < 7 && !p_225533_2_.isRemote) {
            ...
            p_225533_2_.playEvent(1500, p_225533_3_, p_225533_1_ != blockstate ? 1 : 0);
   ...
   public void func_225534_a_(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (p_225534_1_.get(LEVEL) == 7) {
         p_225534_2_.setBlockState(p_225534_3_, p_225534_1_.func_235896_a_(LEVEL), 3);
