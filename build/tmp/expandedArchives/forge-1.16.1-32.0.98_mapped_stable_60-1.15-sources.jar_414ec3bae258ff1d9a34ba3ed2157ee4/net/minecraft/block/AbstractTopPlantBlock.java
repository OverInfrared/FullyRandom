...
public abstract class AbstractTopPlantBlock extends AbstractPlantBlock implements IGrowable {
   ...
   public void func_225542_b_(BlockState p_225542_1_, ServerWorld p_225542_2_, BlockPos p_225542_3_, Random p_225542_4_) {
      if (p_225542_1_.get(field_235502_d_) < 25 && net.minecraftforge.common.ForgeHooks.onCropsGrowPre(p_225542_2_, p_225542_3_.offset(this.field_235498_a_), p_225542_2_.getBlockState(p_225542_3_.offset(this.field_235498_a_)),p_225542_4_.nextDouble() < this.field_235503_e_)) {
         BlockPos blockpos = p_225542_3_.offset(this.field_235498_a_);
         if (this.func_230334_h_(p_225542_2_.getBlockState(blockpos))) {
            p_225542_2_.setBlockState(blockpos, p_225542_1_.func_235896_a_(field_235502_d_));
   ...
   public void func_225535_a_(ServerWorld p_225535_1_, Random p_225535_2_, BlockPos p_225535_3_, BlockState p_225535_4_) {
      BlockPos blockpos = p_225535_3_.offset(this.field_235498_a_);
      int i = Math.min(p_225535_4_.get(field_235502_d_) + 1, 25);
      int j = this.func_230332_a_(p_225535_2_);

      for(int k = 0; k < j && this.func_230334_h_(p_225535_1_.getBlockState(blockpos)); ++k) {
         p_225535_1_.setBlockState(blockpos, p_225535_4_.with(field_235502_d_, Integer.valueOf(i)));
