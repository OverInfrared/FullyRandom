...
public class ResourcePackInfo implements AutoCloseable {
   ...
   private static final PackMetadataSection field_212500_b = new PackMetadataSection((new TranslationTextComponent("resourcePack.broken_assets")).func_240701_a_(new TextFormatting[]{TextFormatting.RED, TextFormatting.ITALIC}), SharedConstants.getVersion().getPackVersion());
