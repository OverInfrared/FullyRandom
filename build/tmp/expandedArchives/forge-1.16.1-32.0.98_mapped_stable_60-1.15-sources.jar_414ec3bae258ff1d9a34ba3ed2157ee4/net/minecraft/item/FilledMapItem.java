...
public class FilledMapItem extends AbstractMapItem {
                           ...
                           for(int i4 = 0; i4 < i; ++i4) {
                              for(int j4 = 0; j4 < i; ++j4) {
                                 ...
                                 if (k4 <= 1) {
                                    ...
                                    while(true) {
                                       --k4;
                                       blockpos$mutable1.func_181079_c(chunkpos.getXStart() + i4 + i3, k4, chunkpos.getZStart() + j4 + j3);
   ...
   private BlockState func_211698_a(World worldIn, BlockState state, BlockPos pos) {
      ...
      return !fluidstate.isEmpty() && !state.func_224755_d(worldIn, pos, Direction.UP) ? fluidstate.getBlockState() : state;
   }
