   ...
   private static final IDispenseItemBehavior MINECART_DISPENSER_BEHAVIOR = new DefaultDispenseItemBehavior() {
      ...
      public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
         ...
         if (blockstate.func_235714_a_(BlockTags.RAILS)) {
            ...
            if (!blockstate.isAir() || !world.getBlockState(blockpos.func_177977_b()).func_235714_a_(BlockTags.RAILS)) {
               return this.behaviourDefaultDispenseItem.dispense(source, stack);
            }

            BlockState blockstate1 = world.getBlockState(blockpos.func_177977_b());
