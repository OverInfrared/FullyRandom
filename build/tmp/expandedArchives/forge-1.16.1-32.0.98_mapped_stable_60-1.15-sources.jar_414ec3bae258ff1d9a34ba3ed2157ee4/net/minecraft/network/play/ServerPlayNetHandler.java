...
public class ServerPlayNetHandler implements IServerPlayNetHandler {
   ...
   public void func_230549_a_(CJigsawBlockGeneratePacket p_230549_1_) {
      PacketThreadUtil.func_218796_a(p_230549_1_, this, this.player.func_71121_q());
      if (this.player.canUseCommandBlock()) {
         BlockPos blockpos = p_230549_1_.func_240844_b_();
         TileEntity tileentity = this.player.world.getTileEntity(blockpos);
         if (tileentity instanceof JigsawTileEntity) {
            JigsawTileEntity jigsawtileentity = (JigsawTileEntity)tileentity;
            jigsawtileentity.func_235665_a_(this.player.func_71121_q(), p_230549_1_.func_240845_c_(), p_230549_1_.func_240846_d_());
         }
            ...
            if (this.targetPos != null) {
               ...
               if (this.player.isPassenger()) {
                  ...
                  if (this.player.isSleeping()) {
                     ...
                     if (this.player.noClip || this.player.isSleeping() || (!flag1 || !serverworld.func_226665_a__(this.player, axisalignedbb)) && !this.func_241163_a_(serverworld, axisalignedbb)) {
   ...
   public void processTryUseItemOnBlock(CPlayerTryUseItemOnBlockPacket packetIn) {
      ...
      if (blockpos.getY() < this.server.getBuildLimit()) {
         ...
         if (this.targetPos == null && this.player.getDistanceSq((double)blockpos.getX() + 0.5D, (double)blockpos.getY() + 0.5D, (double)blockpos.getZ() + 0.5D) < dist && serverworld.isBlockModifiable(this.player, blockpos)) {
            ...
            if (direction == Direction.UP && !actionresulttype.func_226246_a_() && blockpos.getY() >= this.server.getBuildLimit() - 1 && func_241166_a_(this.player, itemstack)) {
      ...
      if (entity != null) {
         ...
         if (this.player.getDistanceSq(entity) < 36.0D) {
            ...
            if (optional.isPresent() && optional.get().func_226246_a_()) {
               ...
               if (optional.get().func_226247_b_()) {
                  this.player.func_226292_a_(hand, true);
               }
            }
         }
