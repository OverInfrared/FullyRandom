...
public class NetherTravelTrigger extends AbstractCriterionTrigger<NetherTravelTrigger.Instance> {
   ...
   public void trigger(ServerPlayerEntity player, Vector3d enteredNetherPosition) {
      this.func_235959_a_(player, (p_226945_2_) -> {
         return p_226945_2_.func_193206_a(player.func_71121_q(), enteredNetherPosition, player.func_226277_ct_(), player.func_226278_cu_(), player.func_226281_cx_());
      });
   }
   ...
   public static class Instance extends CriterionInstance {
      ...
      public boolean func_193206_a(ServerWorld world, Vector3d enteredNetherPosition, double x, double y, double z) {
         if (!this.entered.func_193452_a(world, enteredNetherPosition.x, enteredNetherPosition.y, enteredNetherPosition.z)) {
            return false;
         } else if (!this.exited.func_193452_a(world, x, y, z)) {
            return false;
         } else {
