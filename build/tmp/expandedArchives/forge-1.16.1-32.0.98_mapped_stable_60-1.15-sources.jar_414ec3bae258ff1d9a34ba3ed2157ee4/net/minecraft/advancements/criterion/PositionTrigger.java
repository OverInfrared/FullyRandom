...
public class PositionTrigger extends AbstractCriterionTrigger<PositionTrigger.Instance> {
   ...
   public void trigger(ServerPlayerEntity player) {
      this.func_235959_a_(player, (p_226923_1_) -> {
         return p_226923_1_.func_193204_a(player.func_71121_q(), player.func_226277_ct_(), player.func_226278_cu_(), player.func_226281_cx_());
      });
   }
   ...
   public static class Instance extends CriterionInstance {
      ...
      public boolean func_193204_a(ServerWorld world, double x, double y, double z) {
         return this.location.func_193452_a(world, x, y, z);
      }
