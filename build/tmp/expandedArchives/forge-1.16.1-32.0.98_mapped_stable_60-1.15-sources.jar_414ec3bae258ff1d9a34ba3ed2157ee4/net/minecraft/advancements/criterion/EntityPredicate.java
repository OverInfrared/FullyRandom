...
public class EntityPredicate {
   ...
   public boolean test(ServerPlayerEntity player, @Nullable Entity entity) {
      return this.func_217993_a(player.func_71121_q(), player.getPositionVec(), entity);
   }
   ...
   public boolean func_217993_a(ServerWorld p_217993_1_, @Nullable Vector3d p_217993_2_, @Nullable Entity p_217993_3_) {
      if (this == ANY) {
         ...
         if (!this.location.func_193452_a(p_217993_1_, p_217993_3_.func_226277_ct_(), p_217993_3_.func_226278_cu_(), p_217993_3_.func_226281_cx_())) {
            return false;
   ...
   public static LootContext func_234575_b_(ServerPlayerEntity p_234575_0_, Entity p_234575_1_) {
      return (new LootContext.Builder(p_234575_0_.func_71121_q())).withParameter(LootParameters.THIS_ENTITY, p_234575_1_).withParameter(LootParameters.POSITION, p_234575_1_.func_233580_cy_()).withParameter(LootParameters.field_237457_g_, p_234575_0_.getPositionVec()).withRandom(p_234575_0_.getRNG()).build(LootParameterSets.field_237454_j_);
   }
