...
public class StatePropertiesPredicate {
   ...
   public <S extends StateHolder<?, S>> boolean func_227182_a_(StateContainer<?, S> p_227182_1_, S p_227182_2_) {
   ...
   public boolean func_227185_a_(FluidState p_227185_1_) {
   ...
   public static class Builder {
      ...
      public StatePropertiesPredicate.Builder func_227194_a_(Property<?> p_227194_1_, String p_227194_2_) {
         this.field_227190_a_.add(new StatePropertiesPredicate.ExactMatcher(p_227194_1_.getName(), p_227194_2_));
         return this;
      }

      public StatePropertiesPredicate.Builder func_227192_a_(Property<Integer> p_227192_1_, int p_227192_2_) {
         return this.func_227194_a_(p_227192_1_, Integer.toString(p_227192_2_));
      }

      public StatePropertiesPredicate.Builder func_227195_a_(Property<Boolean> p_227195_1_, boolean p_227195_2_) {
         return this.func_227194_a_(p_227195_1_, Boolean.toString(p_227195_2_));
      }

      public <T extends Comparable<T> & IStringSerializable> StatePropertiesPredicate.Builder func_227193_a_(Property<T> p_227193_1_, T p_227193_2_) {
         return this.func_227194_a_(p_227193_1_, p_227193_2_.getName());
      }
   ...
   abstract static class Matcher {
      ...
      public <S extends StateHolder<?, S>> boolean func_227199_a_(StateContainer<?, S> p_227199_1_, S p_227199_2_) {
         Property<?> property = p_227199_1_.getProperty(this.field_227198_a_);
      ...
      public void func_227200_a_(StateContainer<?, ?> p_227200_1_, Consumer<String> p_227200_2_) {
         Property<?> property = p_227200_1_.getProperty(this.field_227198_a_);
         if (property == null) {
