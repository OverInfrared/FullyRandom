...
public class LocationPredicate {
   ...
   public boolean func_193452_a(ServerWorld world, double x, double y, double z) {
      return this.func_193453_a(world, (float)x, (float)y, (float)z);
   }

   public boolean func_193453_a(ServerWorld world, float x, float y, float z) {
      if (!this.x.test(x)) {
         return false;
