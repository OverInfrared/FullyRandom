...
public class RightClickBlockWithItemTrigger extends AbstractCriterionTrigger<RightClickBlockWithItemTrigger.Instance> {
   ...
   public void func_226695_a_(ServerPlayerEntity p_226695_1_, BlockPos p_226695_2_, ItemStack p_226695_3_) {
      BlockState blockstate = p_226695_1_.func_71121_q().getBlockState(p_226695_2_);
      this.func_235959_a_(p_226695_1_, (p_226694_4_) -> {
         return p_226694_4_.func_226700_a_(blockstate, p_226695_1_.func_71121_q(), p_226695_2_, p_226695_3_);
      });
   }
   ...
   public static class Instance extends CriterionInstance {
      ...
      public boolean func_226700_a_(BlockState p_226700_1_, ServerWorld p_226700_2_, BlockPos p_226700_3_, ItemStack p_226700_4_) {
         return !this.field_234851_a_.func_193452_a(p_226700_2_, (double)p_226700_3_.getX() + 0.5D, (double)p_226700_3_.getY() + 0.5D, (double)p_226700_3_.getZ() + 0.5D) ? false : this.field_226698_c_.test(p_226700_4_);
      }
