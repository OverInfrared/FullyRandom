...
public class AdvancementRewards {
   ...
   public void apply(ServerPlayerEntity player) {
      ...
      LootContext lootcontext = (new LootContext.Builder(player.func_71121_q())).withParameter(LootParameters.THIS_ENTITY, player).withParameter(LootParameters.POSITION, player.func_233580_cy_()).withRandom(player.getRNG()).withLuck(player.getLuck()).build(LootParameterSets.ADVANCEMENT); // FORGE: luck to LootContext
      boolean flag = false;
