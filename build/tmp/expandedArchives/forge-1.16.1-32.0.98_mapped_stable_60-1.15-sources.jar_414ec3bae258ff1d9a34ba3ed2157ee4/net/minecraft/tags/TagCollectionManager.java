...
public class TagCollectionManager {
   private static volatile TagCollectionManager field_232918_a_ = new TagCollectionManager(BlockTags.getCollection(), ItemTags.getCollection(), FluidTags.func_226157_a_(), EntityTypeTags.getCollection());
