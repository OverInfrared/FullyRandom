...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   protected static LootTable.Builder droppingSlab(Block p_218513_0_) {
      return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(withExplosionDecay(p_218513_0_, ItemLootEntry.builder(p_218513_0_).acceptFunction(SetCount.builder(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(p_218513_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(SlabBlock.TYPE, SlabType.DOUBLE)))))));
   }
   ...
   protected static <T extends Comparable<T> & IStringSerializable> LootTable.Builder droppingWhen(Block p_218562_0_, Property<T> p_218562_1_, T p_218562_2_) {
      return LootTable.builder().addLootPool(withSurvivesExplosion(p_218562_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218562_0_).acceptCondition(BlockStateProperty.builder(p_218562_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(p_218562_1_, p_218562_2_))))));
   }
   ...
   private static LootTable.Builder func_229436_h_(Block p_229436_0_) {
      return LootTable.builder().addLootPool(LootPool.builder().acceptCondition(SILK_TOUCH).rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_229436_0_).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Bees", "BlockEntityTag.Bees")).acceptFunction(CopyBlockState.func_227545_a_(p_229436_0_).func_227552_a_(BeehiveBlock.field_226873_c_))));
   }

   private static LootTable.Builder func_229437_i_(Block p_229437_0_) {
      return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_229437_0_).acceptCondition(SILK_TOUCH).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Bees", "BlockEntityTag.Bees")).acceptFunction(CopyBlockState.func_227545_a_(p_229437_0_).func_227552_a_(BeehiveBlock.field_226873_c_)).alternatively(ItemLootEntry.builder(p_229437_0_))));
   }
   ...
   protected static LootTable.Builder droppingByAge(Block p_218475_0_, Item p_218475_1_) {
      return LootTable.builder().addLootPool(withExplosionDecay(p_218475_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218475_1_).acceptFunction(SetCount.builder(BinomialRange.of(3, 0.06666667F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 0)))).acceptFunction(SetCount.builder(BinomialRange.of(3, 0.13333334F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 1)))).acceptFunction(SetCount.builder(BinomialRange.of(3, 0.2F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 2)))).acceptFunction(SetCount.builder(BinomialRange.of(3, 0.26666668F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 3)))).acceptFunction(SetCount.builder(BinomialRange.of(3, 0.33333334F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 4)))).acceptFunction(SetCount.builder(BinomialRange.of(3, 0.4F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 5)))).acceptFunction(SetCount.builder(BinomialRange.of(3, 0.46666667F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 6)))).acceptFunction(SetCount.builder(BinomialRange.of(3, 0.53333336F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 7)))))));
   }
   ...
   private static LootTable.Builder func_241749_b_(Block p_241749_0_, Block p_241749_1_) {
      ...
      return LootTable.builder().addLootPool(LootPool.builder().addEntry(builder).acceptCondition(BlockStateProperty.builder(p_241749_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER))).acceptCondition(LocationCheck.func_241547_a_(LocationPredicate.Builder.func_226870_a_().func_235312_a_(BlockPredicate.Builder.func_226243_a_().func_233458_a_(p_241749_0_).func_233459_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(DoublePlantBlock.HALF, DoubleBlockHalf.UPPER).func_227196_b_()).func_226245_b_()), new BlockPos(0, 1, 0)))).addLootPool(LootPool.builder().addEntry(builder).acceptCondition(BlockStateProperty.builder(p_241749_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(DoublePlantBlock.HALF, DoubleBlockHalf.UPPER))).acceptCondition(LocationCheck.func_241547_a_(LocationPredicate.Builder.func_226870_a_().func_235312_a_(BlockPredicate.Builder.func_226243_a_().func_233458_a_(p_241749_0_).func_233459_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER).func_227196_b_()).func_226245_b_()), new BlockPos(0, -1, 0))));
   }
   ...
   protected void addTables() {
      ...
      this.registerDropSelfLootTable(Blocks.field_226907_mc_);
      this.registerDropSelfLootTable(Blocks.field_226908_md_);
      ...
      this.registerLootTable(Blocks.TNT, LootTable.builder().addLootPool(withSurvivesExplosion(Blocks.TNT, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(Blocks.TNT).acceptCondition(BlockStateProperty.builder(Blocks.TNT).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227195_a_(TNTBlock.UNSTABLE, false)))))));
      this.registerLootTable(Blocks.COCOA, (p_218516_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(withExplosionDecay(p_218516_0_, ItemLootEntry.builder(Items.COCOA_BEANS).acceptFunction(SetCount.builder(ConstantRange.of(3)).acceptCondition(BlockStateProperty.builder(p_218516_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(CocoaBlock.AGE, 2)))))));
      });
      this.registerLootTable(Blocks.SEA_PICKLE, (p_218478_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(withExplosionDecay(Blocks.SEA_PICKLE, ItemLootEntry.builder(p_218478_0_).acceptFunction(SetCount.builder(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(p_218478_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SeaPickleBlock.PICKLES, 2)))).acceptFunction(SetCount.builder(ConstantRange.of(3)).acceptCondition(BlockStateProperty.builder(p_218478_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SeaPickleBlock.PICKLES, 3)))).acceptFunction(SetCount.builder(ConstantRange.of(4)).acceptCondition(BlockStateProperty.builder(p_218478_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SeaPickleBlock.PICKLES, 4)))))));
      });
      this.registerLootTable(Blocks.COMPOSTER, (p_218551_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().addEntry(withExplosionDecay(p_218551_0_, ItemLootEntry.builder(Items.COMPOSTER)))).addLootPool(LootPool.builder().addEntry(ItemLootEntry.builder(Items.BONE_MEAL)).acceptCondition(BlockStateProperty.builder(p_218551_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(ComposterBlock.LEVEL, 8))));
      });
      ...
      this.registerLootTable(Blocks.PLAYER_HEAD, (p_218565_0_) -> {
         return LootTable.builder().addLootPool(withSurvivesExplosion(p_218565_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218565_0_).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("SkullOwner", "SkullOwner")))));
      });
      ...
      this.registerLootTable(Blocks.SWEET_BERRY_BUSH, (p_241171_0_) -> {
         return withExplosionDecay(p_241171_0_, LootTable.builder().addLootPool(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SweetBerryBushBlock.AGE, 3))).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.builder(RandomValueRange.of(2.0F, 3.0F))).acceptFunction(ApplyBonus.uniformBonusCount(Enchantments.FORTUNE))).addLootPool(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SweetBerryBushBlock.AGE, 2))).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.builder(RandomValueRange.of(1.0F, 2.0F))).acceptFunction(ApplyBonus.uniformBonusCount(Enchantments.FORTUNE))));
      });
      ...
      this.registerLootTable(Blocks.NETHER_WART, (p_218553_0_) -> {
         return LootTable.builder().addLootPool(withExplosionDecay(p_218553_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(Items.NETHER_WART).acceptFunction(SetCount.builder(RandomValueRange.of(2.0F, 4.0F)).acceptCondition(BlockStateProperty.builder(p_218553_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(NetherWartBlock.AGE, 3)))).acceptFunction(ApplyBonus.uniformBonusCount(Enchantments.FORTUNE).acceptCondition(BlockStateProperty.builder(p_218553_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(NetherWartBlock.AGE, 3)))))));
      });
      this.registerLootTable(Blocks.SNOW, (p_218485_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().acceptCondition(EntityHasProperty.builder(LootContext.EntityTarget.THIS)).addEntry(AlternativesLootEntry.builder(AlternativesLootEntry.builder(ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 1))), ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 2))).acceptFunction(SetCount.builder(ConstantRange.of(2))), ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 3))).acceptFunction(SetCount.builder(ConstantRange.of(3))), ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 4))).acceptFunction(SetCount.builder(ConstantRange.of(4))), ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 5))).acceptFunction(SetCount.builder(ConstantRange.of(5))), ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 6))).acceptFunction(SetCount.builder(ConstantRange.of(6))), ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 7))).acceptFunction(SetCount.builder(ConstantRange.of(7))), ItemLootEntry.builder(Items.SNOWBALL).acceptFunction(SetCount.builder(ConstantRange.of(8)))).acceptCondition(NO_SILK_TOUCH), AlternativesLootEntry.builder(ItemLootEntry.builder(Blocks.SNOW).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 1))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.builder(ConstantRange.of(2))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 2))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.builder(ConstantRange.of(3))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 3))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.builder(ConstantRange.of(4))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 4))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.builder(ConstantRange.of(5))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 5))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.builder(ConstantRange.of(6))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 6))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.builder(ConstantRange.of(7))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 7))), ItemLootEntry.builder(Blocks.SNOW_BLOCK)))));
      });
