...
public class BlockTagsProvider extends TagsProvider<Block> {
   ...
   protected void registerTags() {
      ...
      this.func_240522_a_(BlockTags.DRAGON_IMMUNE).func_240534_a_(Blocks.BARRIER, Blocks.BEDROCK, Blocks.END_PORTAL, Blocks.END_PORTAL_FRAME, Blocks.END_GATEWAY, Blocks.COMMAND_BLOCK, Blocks.REPEATING_COMMAND_BLOCK, Blocks.CHAIN_COMMAND_BLOCK, Blocks.STRUCTURE_BLOCK, Blocks.field_226904_lY_, Blocks.MOVING_PISTON, Blocks.OBSIDIAN, Blocks.field_235399_ni_, Blocks.END_STONE, Blocks.IRON_BARS, Blocks.field_235400_nj_);
      this.func_240522_a_(BlockTags.WITHER_IMMUNE).func_240534_a_(Blocks.BARRIER, Blocks.BEDROCK, Blocks.END_PORTAL, Blocks.END_PORTAL_FRAME, Blocks.END_GATEWAY, Blocks.COMMAND_BLOCK, Blocks.REPEATING_COMMAND_BLOCK, Blocks.CHAIN_COMMAND_BLOCK, Blocks.STRUCTURE_BLOCK, Blocks.field_226904_lY_, Blocks.MOVING_PISTON);
      this.func_240522_a_(BlockTags.field_232871_ah_).func_240534_a_(Blocks.SOUL_SAND, Blocks.field_235336_cN_);
      this.func_240522_a_(BlockTags.field_226148_H_).func_240534_a_(Blocks.SUNFLOWER, Blocks.LILAC, Blocks.PEONY, Blocks.ROSE_BUSH);
      this.func_240522_a_(BlockTags.field_226149_I_).func_240531_a_(BlockTags.SMALL_FLOWERS).func_240531_a_(BlockTags.field_226148_H_);
      this.func_240522_a_(BlockTags.field_226151_aa_).func_240534_a_(Blocks.field_226905_ma_, Blocks.field_226906_mb_);
      this.func_240522_a_(BlockTags.field_226152_ab_).func_240534_a_(Blocks.BEETROOTS, Blocks.CARROTS, Blocks.POTATOES, Blocks.WHEAT, Blocks.MELON_STEM, Blocks.PUMPKIN_STEM);
      this.func_240522_a_(BlockTags.field_226153_ac_).func_240531_a_(BlockTags.field_226152_ab_).func_240532_a_(Blocks.SWEET_BERRY_BUSH);
      this.func_240522_a_(BlockTags.field_226150_J_).func_240534_a_(Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX);
      this.func_240522_a_(BlockTags.field_226154_ad_).func_240534_a_(Blocks.NETHER_PORTAL, Blocks.END_PORTAL, Blocks.END_GATEWAY);
      ...
      this.func_240522_a_(BlockTags.field_232883_ay_).func_240534_a_(Blocks.GOLD_BLOCK, Blocks.BARREL, Blocks.CHEST, Blocks.ENDER_CHEST, Blocks.field_235387_nA_, Blocks.TRAPPED_CHEST).func_240531_a_(BlockTags.field_226150_J_).func_240531_a_(BlockTags.field_232866_P_);
