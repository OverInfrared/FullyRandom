...
public class Main {
   ...
   public static void main(String[] p_main_0_) {
      ...
      try {
         ...
         CompletableFuture<DataPackRegistries> completablefuture = DataPackRegistries.func_240961_a_(resourcepacklist.func_232623_f_(), Commands.EnvironmentType.DEDICATED, serverpropertiesprovider.getProperties().field_225395_K, Util.getServerExecutor(), Runnable::run);
