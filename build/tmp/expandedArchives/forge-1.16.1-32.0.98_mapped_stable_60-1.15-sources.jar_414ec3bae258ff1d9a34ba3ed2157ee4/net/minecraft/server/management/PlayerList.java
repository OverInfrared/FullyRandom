...
public abstract class PlayerList {
   ...
   public void initializeConnectionToPlayer(NetworkManager netManager, ServerPlayerEntity playerIn) {
      ...
      ServerWorld serverworld = this.server.func_71218_a(registrykey);
      ...
      this.sendScoreboard(serverworld1.func_96441_U(), playerIn);
      ...
      this.func_72354_b(playerIn, serverworld1);
   ...
   public ServerPlayerEntity func_232644_a_(ServerPlayerEntity p_232644_1_, boolean p_232644_2_) {
      ...
      ServerWorld serverworld = this.server.func_71218_a(p_232644_1_.func_241141_L_());
      ...
      serverplayerentity.connection.sendPacket(new SRespawnPacket(serverplayerentity.world.func_234922_V_(), serverplayerentity.world.func_234923_W_(), BiomeManager.func_235200_a_(serverplayerentity.func_71121_q().getSeed()), serverplayerentity.interactionManager.getGameType(), serverplayerentity.interactionManager.func_241815_c_(), serverplayerentity.func_71121_q().func_234925_Z_(), serverplayerentity.func_71121_q().func_241109_A_(), p_232644_2_));
   ...
   public boolean canSendCommands(GameProfile profile) {
      return this.ops.hasEntry(profile) || this.server.func_213199_b(profile) && this.server.func_240793_aU_().areCommandsAllowed() || this.commandsAllowedForAll;
   }
