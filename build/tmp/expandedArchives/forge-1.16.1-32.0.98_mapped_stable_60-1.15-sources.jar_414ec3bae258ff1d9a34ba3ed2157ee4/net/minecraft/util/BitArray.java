   ...
   public BitArray(int p_i47901_1_, int p_i47901_2_, @Nullable long[] p_i47901_3_) {
      ...
      if (p_i47901_3_ != null) {
         if (p_i47901_3_.length != j) {
            throw (RuntimeException)Util.func_229757_c_(new RuntimeException("Invalid length given for storage, got: " + p_i47901_3_.length + " but expected: " + j));
         }
   ...
   public void func_225421_a(IntConsumer p_225421_1_) {
      ...
      for(long j : this.longArray) {
         for(int k = 0; k < this.field_232982_f_; ++k) {
            p_225421_1_.accept((int)(j & this.maxEntryValue));
            j >>= this.bitsPerEntry;
            ++i;
            if (i >= this.arraySize) {
               return;
