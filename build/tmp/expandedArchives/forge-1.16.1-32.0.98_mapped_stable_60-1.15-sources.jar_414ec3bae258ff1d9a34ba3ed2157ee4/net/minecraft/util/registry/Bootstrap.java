...
public class Bootstrap {
   ...
   private static void func_240913_a_(final Set<String> p_240913_0_) {
      final LanguageMap languagemap = LanguageMap.func_74808_a();
      GameRules.func_223590_a(new GameRules.IRuleEntryVisitor() {
         public <T extends GameRules.RuleValue<T>> void func_223481_a(GameRules.RuleKey<T> p_223481_1_, GameRules.RuleType<T> p_223481_2_) {
            if (!languagemap.func_230506_b_(p_223481_1_.func_234911_b_())) {
               p_240913_0_.add(p_223481_1_.func_223576_a());
            }
