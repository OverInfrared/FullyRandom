...
public class EntitySelectionContext implements ISelectionContext {
   ...
   protected EntitySelectionContext(Entity entityIn) {
      this(entityIn, entityIn.func_226274_bn_(), entityIn.func_226278_cu_(), entityIn instanceof LivingEntity ? ((LivingEntity)entityIn).getHeldItemMainhand().getItem() : Items.AIR, entityIn instanceof LivingEntity ? ((LivingEntity)entityIn)::func_230285_a_ : (p_237494_0_) -> {
         return false;
      });
   }
