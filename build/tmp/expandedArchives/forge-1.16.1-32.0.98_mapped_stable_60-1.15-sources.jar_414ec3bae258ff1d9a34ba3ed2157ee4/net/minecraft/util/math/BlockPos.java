...
public class BlockPos extends Vector3i {
         ...
         return new AbstractIterator<BlockPos>() {
            ...
            protected BlockPos computeNext() {
               if (this.field_239591_b_ <= 0) {
                  ...
                  BlockPos blockpos = this.pos.func_181079_c(p_239585_2_ + p_239585_0_.nextInt(i), p_239585_3_ + p_239585_0_.nextInt(j), p_239585_4_ + p_239585_0_.nextInt(k));
   ...
   public static Stream<BlockPos> getAllInBox(BlockPos p_218281_0_, BlockPos p_218281_1_) {
      return StreamSupport.stream(getAllInBoxMutable(p_218281_0_, p_218281_1_).spliterator(), false);
   }
         ...
         return new AbstractIterator<BlockPos>() {
            ...
            protected BlockPos computeNext() {
               if (this.field_239617_h_ == l) {
                  ...
                  return this.field_239616_g_.func_181079_c(x1 + i1, y1 + k1, z1 + l1);
               }
            }
         };
      };
   ...
   public static class Mutable extends BlockPos {
      ...
      public BlockPos.Mutable func_189533_g(Vector3i vec) {
      ...
      public BlockPos.Mutable func_239622_a_(Vector3i p_239622_1_, Direction p_239622_2_) {
         return this.func_181079_c(p_239622_1_.getX() + p_239622_2_.getXOffset(), p_239622_1_.getY() + p_239622_2_.getYOffset(), p_239622_1_.getZ() + p_239622_2_.getZOffset());
      }

      public BlockPos.Mutable func_239621_a_(Vector3i p_239621_1_, int p_239621_2_, int p_239621_3_, int p_239621_4_) {
         return this.func_181079_c(p_239621_1_.getX() + p_239621_2_, p_239621_1_.getY() + p_239621_3_, p_239621_1_.getZ() + p_239621_4_);
      }
      ...
      public BlockPos.Mutable func_189534_c(Direction facing, int n) {
         return this.func_181079_c(this.getX() + facing.getXOffset() * n, this.getY() + facing.getYOffset() * n, this.getZ() + facing.getZOffset() * n);
      }

      public BlockPos.Mutable func_196234_d(int xIn, int yIn, int zIn) {
         return this.func_181079_c(this.getX() + xIn, this.getY() + yIn, this.getZ() + zIn);
      }

      public BlockPos.Mutable func_239620_a_(Direction.Axis p_239620_1_, int p_239620_2_, int p_239620_3_) {
         switch(p_239620_1_) {
         case X:
            return this.func_181079_c(MathHelper.clamp(this.getX(), p_239620_2_, p_239620_3_), this.getY(), this.getZ());
         case Y:
            return this.func_181079_c(this.getX(), MathHelper.clamp(this.getY(), p_239620_2_, p_239620_3_), this.getZ());
         case Z:
            return this.func_181079_c(this.getX(), this.getY(), MathHelper.clamp(this.getZ(), p_239620_2_, p_239620_3_));
         default:
