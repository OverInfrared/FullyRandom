...
public class CommonMethods {
    ...
    public static void log(Level level, String x, Object... args) {
        ...
        Fullyrandom.LOGGER.log(level, x, args);
    }
    ...
    public static File getOSVDir() {
        return new File(FMLLoader.getGamePath() + "/config/" + Fullyrandom.MODID);
    }
    ...
    public static ResourceLocation osvLocation(String name) {
        return new ResourceLocation(Fullyrandom.MODID, name);
    }
